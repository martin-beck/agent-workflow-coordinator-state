...
- Product remote main: `bd4ef239420ed0b09a6d0845e68f13bc1290f0cd`
- Local origin/main: `bd4ef239420ed0b09a6d0845e68f13bc1290f0cd`
...
| #978 | `ar0064-receipt-journal-equivalence@b927932f2e19` | `main` | UNSTABLE | IN_PROGRESS:, QUEUED: | test(formal): map selector execution evidence |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35896443571 | `b927932f2e19` | pull_request | Verify | queued:- |
...
| 35895509438 | `bd4ef239420e` | push | Verify | completed:success |
...
| 35894282460 | `bd94595cb7cc` | push | Verify | completed:success |
| 35894282458 | `bd94595cb7cc` | push | Formal | completed:success |
| 35894084691 | `20aa903da43c` | pull_request | Verify | completed:success |
