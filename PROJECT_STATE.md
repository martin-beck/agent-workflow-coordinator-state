...
| --- | --- | --- | --- | --- | --- |
| #1030 | `ar0064-authority-mutation-formal-refinement@156aedcd2dd0` | `main` | UNSTABLE | COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SKIPPED | docs(formal): reconcile authority refinement evidence |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35944847711 | `156aedcd2dd0` | pull_request | Verify | in_progress:- |
