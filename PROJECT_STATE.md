...
| #930 | `ar0064-authority-mutation-formal-refinement@76ffedf7c161` | `main` | UNSTABLE | QUEUED:, QUEUED: | feat(authority): durably fence external effect outcomes |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35838147219 | `76ffedf7c161` | pull_request | Verify | queued:- |
