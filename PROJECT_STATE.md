...
| --- | --- | --- | --- | --- | --- |
| #22 | `feature/tla-admission-safety@f8e8cbf245d5` | `main` | CLEAN | - | feat(formal): bound TLC admission and resources |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 34780676824 | `f8e8cbf245d5` | pull_request | Verify | pending:- |
| 34780661442 | `f12ece27ac1b` | pull_request | Verify | in_progress:- |
