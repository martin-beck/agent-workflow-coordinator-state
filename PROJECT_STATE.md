...
| --- | --- | --- | --- | --- | --- |
| #22 | `feature/tla-admission-safety@84461ecf363f` | `main` | UNSTABLE | COMPLETED:SUCCESS, IN_PROGRESS: | feat(formal): bound TLC admission and resources |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 34781770908 | `84461ecf363f` | pull_request | Verify | in_progress:- |
