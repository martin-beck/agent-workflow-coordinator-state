...
| #854 | `ar0031-session-contract@e7e8b6b6d69d` | `main` | UNSTABLE | COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SKIPPED | test(contract): specify durable session admission |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35419578013 | `e7e8b6b6d69d` | pull_request | Verify | in_progress:- |
