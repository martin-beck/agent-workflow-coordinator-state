...
| #728 | `ar0031-durable-binding@c794ac3ac140` | `main` | UNSTABLE | COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SKIPPED, IN_PROGRESS:, IN_PROGRESS: | feat(upgrade): add durable authority binding contract |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35374555795 | `c794ac3ac140` | pull_request | Verify | in_progress:- |
