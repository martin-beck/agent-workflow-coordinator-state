...
| --- | --- | --- | --- | --- | --- |
| #77 | `feature/ar0007-sqlite-sidecar-faults@36cd3ed24087` | `main` | UNSTABLE | COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SKIPPED, QUEUED: | test(journal): reject stale fence bindings |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 34881977614 | `36cd3ed24087` | pull_request | Verify | queued:- |
