...
| --- | --- | --- | --- | --- | --- |
| #1051 | `ar0064-git-exact-head@3f564eea7bd7` | `main` | CLEAN | COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SKIPPED | fix(git): require exact post-commit head identity |
