...
- Local origin/main: `ef3a90775731af4e91794ec2594f8d29608952d8`
- Primary worktree head: `6630dfa5bed47d6ffd36dfeb0159d2a205030e40`
...
| #610 | `ar0012-availability-theorem@70919dd660ae` | `main` | UNSTABLE | COMPLETED:SUCCESS, COMPLETED:SUCCESS, QUEUED:, COMPLETED:SKIPPED | test(formal): require availability theorem admission |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35241326451 | `14f27c440ba4` | push | Verify | pending:- |
| 35241264329 | `70919dd660ae` | pull_request | Verify | queued:- |
| 35241031869 | `e8d06c984b5b` | push | Verify | in_progress:- |
| 35240904696 | `6630dfa5bed4` | pull_request | Verify | completed:success |
| 35240588427 | `7f81c971a705` | pull_request | Verify | completed:success |
| 35240363920 | `b91a46f87366` | push | Verify | completed:success |
| 35240297145 | `8b7b3c401869` | pull_request | Verify | completed:failure |
