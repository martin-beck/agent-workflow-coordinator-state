...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-upgrade-engine-20260914 | Signed provisioning contract draft 71ec783 is published locally but independent review requires identity, TOCTOU, sidecar, atomic marker, pre-commit, privacy, and existing-authority amendments before implementation. | Amend CONTROL_STORE_PROVISIONING.md per exact review blockers, rerun independent review, then publish docs-only PR; keep apply/rollback rejection-only. |
