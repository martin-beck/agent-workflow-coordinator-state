...
| --- | --- | --- | --- | --- |
| P0 | [AR-0031](tasks/AR-0031.md): Executable upgrade mutation and rollback boundary | codex-awc-ar0031-contract-20260919f | PR #735 adds bounded, machine-checked formal correspondence scaffolding for SQLite snapshot/identity reread, read-close uncertainty, and permanent ambiguous fencing. It preserves the rejection-only mutation gate. | Await independent exact-head review and hosted gates for PR #853 at 4e7f1b1. This is contract/schema-only: no execution or dispatch is wired; mutation_enabled and dispatch_enabled remain false. Keep commit, rollback, apply, outcome publication, and Git dispatch fail-closed. |
