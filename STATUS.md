...
| [AR-0007](tasks/AR-0007.md) | [AR-0003](tasks/AR-0003.md), [AR-0004](tasks/AR-0004.md), [AR-0005](tasks/AR-0005.md), [AR-0006](tasks/AR-0006.md) | [AR-0009](tasks/AR-0009.md), [AR-0010](tasks/AR-0010.md), [AR-0012](tasks/AR-0012.md), [AR-0013](tasks/AR-0013.md), [AR-0031](tasks/AR-0031.md) |
| [AR-0008](tasks/AR-0008.md) | [AR-0003](tasks/AR-0003.md), [AR-0004](tasks/AR-0004.md), [AR-0005](tasks/AR-0005.md), [AR-0006](tasks/AR-0006.md) | [AR-0009](tasks/AR-0009.md), [AR-0010](tasks/AR-0010.md), [AR-0013](tasks/AR-0013.md), [AR-0031](tasks/AR-0031.md) |
...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-loop-20260918e | PR #735 adds bounded formal correspondence scaffolding for SQLite snapshot/safe-mode transitions; implementation remains read-only and fail-closed. | Await independent exact-head review and hosted gates for PR #738 at b450272. Preserve upgrade/replace/rollback/selector mutation, outcome publication, and Git dispatch fail-closed; this binds only the ambiguous-fence Acquire rejection. |
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-current-audit-20260918f | Exact main 95d27e9 focused baseline: 217 authority/engine/campaign tests passed and 231 runtime/admission/lock/control tests passed. No new safe mutation seam identified; preserve fail-closed upgrade and rollback mutation. | Audit exact main e4bacb2 for one non-overlapping SQLite barrier/fencing failure boundary; do not duplicate AR-0031 formal correspondence; preserve fail-closed mutation. |
| P0 | [AR-0031](tasks/AR-0031.md): Executable upgrade mutation and rollback boundary | codex-awc-ar0031-mutation-20260918e | PR #735 adds bounded, machine-checked formal correspondence scaffolding for SQLite snapshot/identity reread, read-close uncertainty, and permanent ambiguous fencing. It preserves the rejection-only mutation gate. | Implement the next bounded correspondence slice: machine-check that declared model states, barriers, and configured constants in the SQLite map match UpgradeRecovery.tla/cfg exactly. Keep mutation, outcome publication, Git dispatch, apply, and rollback fail-closed. |

### Open (1)

| Priority | AR | Owner | Summary | Next action |
| --- | --- | --- | --- | --- |
| P0 | [AR-0013](tasks/AR-0013.md): Selector-aware authenticated versioned runtime | Unclaimed | Exact main 95d27e9 focused baseline: 217 authority/engine/campaign tests passed and 231 runtime/admission/lock/control tests passed. No new safe selector/runtime seam identified; mutation and dispatch remain disabled. | Re-audit after the next relevant runtime merge; implement only a genuinely uncovered selector/versioned-runtime correctness slice. |
