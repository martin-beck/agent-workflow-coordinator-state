...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0007-next-slice-20260916 | Durably fence upgrade admission and every SQLite authority mutation under one project barrier. | Integrate trusted SQLiteBackendBinding into transaction/mutation scope with common-control-authority lock order; fence every write route and add fail-closed tests. |
