...
| P0 | [AR-0013](tasks/AR-0013.md): Selector-aware authenticated versioned runtime | codex-awc-ar0013-runtime-20260918 | PR #693 hostile runtime-parent replacement coverage merged as 71a7f665; final post-merge Verify 35343357797 passed. Upgrade and rollback mutation remain disabled. | Select the next bounded selector/runtime correctness slice from main 71a7f665; retain fail-closed upgrade and rollback dispatch. |
