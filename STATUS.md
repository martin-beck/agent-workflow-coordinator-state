...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-loop-20260918c | PR #717 adds hard-link rejection for release transition inputs; unsigned protected-tag policy and mutation-disabled boundaries remain intact. | Await independent review and hosted exact-head gates for PR #717; then continue the next dependency-safe AR-0009 correctness slice. |
