...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-barrier-20260918 | Authority-rotation regression PR #692 merged as 42b151f; combined main head 19d6b661 passed post-merge Verify 35342682956. Barrier implementation remains incomplete and mutation remains disabled. | Continue the next bounded barrier/fencing correctness slice from main 19d6b661; keep mutating upgrade commands disabled. |
