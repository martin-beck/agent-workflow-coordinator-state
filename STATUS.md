...
| P0 | [AR-0013](tasks/AR-0013.md): Selector-aware authenticated versioned runtime | Unclaimed | Descriptor25 PR #585 merged b4a045a; exact Verify 35226548172 and authoritative latest-main post-merge Verify 35226977082 succeeded on 069727c7 with formal tier and attestation. Descriptor26 claim active. | Inspect next distinct runtime admission/release integrity boundary; implement hostile fail-closed regression coverage without enabling execution or selector mutation. |
