...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-loop-20260918b | Release policy and unsigned protected tags are complete. v0.3.15, v0.3.16, v0.3.17, and now v0.3.18 are published from merged main; v0.3.18 tag/release points immutably to 45d8686. PR #686/#687 restored the &gt;=95&#37; quality baseline. Exact PR Verify and post-merge Verify 35335594812 for release PR #688 passed. Upgrade mutation remains disabled. | Reconcile v0.3.18 release evidence, then rebase and verify CAS PR #683 onto current main 45d8686; continue dependency-ready correctness work without rewriting protected tags. |
