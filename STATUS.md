...
| Next action | Run the release-bound v0.3.23/v0.3.26 fixture through stale-owner replacement, validation failure, reopen failure, and competing-owner cases using canonical vendored state; preserve fail-closed behavior and do not enable mutation dispatch until the complete exact-head matrix is recorded. |
...
| --- | --- | --- | --- | --- |
| P0 | [AR-0063](tasks/AR-0063.md): Rollback and first release integration campaign | codex-model-policy-20260925 | Published unsigned v0.3.26 at exact reviewed SHA 8008ae2324a152e3f2c4476da39d4b893a1ce53d after PR #1122 passed independent exact-head review, signed/DCO verification, hosted awq/scope/formal-portable/verify, and local 1461-test 95&#37; branch coverage. PR #1121 stale SQLite sidecar recovery repair remains merged at 299b816. Fresh public v0.3.26 clone and canonical vendor verify pass; canonical state ran 139 tests with jsonschema supplied, offline imports and doctor --live pass. Canonical state vendor publication 2a5801c and reconciliation 4735dec4 are signed/DCO and pushed. Mutation dispatch remains fail-closed. | Run the release-bound v0.3.23/v0.3.26 fixture through stale-owner replacement, validation failure, reopen failure, and competing-owner cases using canonical vendored state; preserve fail-closed behavior and do not enable mutation dispatch until the complete exact-head matrix is recorded. |
