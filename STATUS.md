...
| P0 | [AR-0064](tasks/AR-0064.md): Authority mutation implementation and formal refinement | Unclaimed | Concrete authority adapters intentionally reject commit/apply today; this child supplies the missing implementation and formal refinement without weakening fail-closed behavior. | Audit the next not-proven refinement obligation after SQLite route-fence evidence; prioritize functional availability or selector/execution binding without enabling mutation, rollback, or release. |
