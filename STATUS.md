...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0007-next-slice-20260916 | Durably fence upgrade admission and every SQLite authority mutation under one project barrier. | Implement adapter-owned observer factory capturing bound barrier identity; emit immutable lock/SQLite transaction events and test ordering/default compatibility. |
