...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | codex-awc-ar0008-next-20260914 | PR #90 exact head 8f0658f against e4b274e is test-only fresh-reopen stale-fence coverage. After repeated stale-writer attempts, a new SQLiteBarrierSessionStore/SQLiteRollbackControlStore reader snapshots the winning fenced session and asserts byte-for-byte state equality with the prior winner. Focused exact-head multiprocess stale-fence test passed 1/1. Commit has Signed-off-by: Martin Beck &lt;martin.beck2@gmx.de&gt;; no formal/model/mutation/production changes and refinement remains not-proven. | Recommend PR #90 for merge: AWQ/scope/smoke are green and Verify is correctly path-skipped. Require combined-main Verify/formal provenance after merge; keep AR-0008 diagnostic-only and continue AR-0012 production caller/cross-store correspondence work. |
