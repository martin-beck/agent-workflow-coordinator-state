...
| --- | --- | --- | --- | --- |
| P0 | [AR-0004](tasks/AR-0004.md): Quiescence and upgrade preflight | codex-awc-ar0004-quiescence-20260914 | Prevent upgrades from starting unless the coordination system can remain safe and functional. | PR #24 merged as cd4ec1c; post-merge main Verify run 34789037308 is in progress. Confirm terminal success before closing AR-0004. |
