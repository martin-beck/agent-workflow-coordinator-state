...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | Unclaimed | Next33 terminal attempt identity merged PR #571 6f7a5f66; replacement exact merge-head Verify 35219732715 succeeded on 6f7a5f66. | Release next33 and claim next34; inspect remaining formal/durability correspondence seam and implement one bounded fail-closed slice. |
