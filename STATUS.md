...
| --- | --- | --- | --- | --- |
| P0 | [AR-0064](tasks/AR-0064.md): Authority mutation implementation and formal refinement | codex-awc-ar0064-20260923p | Concrete authority adapters intentionally reject commit/apply today; this child supplies the missing implementation and formal refinement without weakening fail-closed behavior. | Implement the next bounded ordered lock/admission correspondence slice: map LockDomainScope hold/recheck, lock release after process death, and stale-owner rejection to exact hostile tests and formal obligations; keep mutation, rollback, and release gates denied. |
