...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | Unclaimed | Next34 release revision advancement merged PR #573 b7e5f92; post-merge Verify 35220535460 succeeded. | Release next34 and claim next35; inspect remaining formal/durability correspondence seam and implement one bounded fail-closed slice. |
