...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #186 merged 340bee0e; Verify 34925450606 succeeded (TLC 121472/90752 main, 110/94 small, artifact 10380151510). | Create and publish the next narrow rejection-only caller/session validation slice from 340bee0e; keep dispatch, mutation, upgrade, apply, and rollback unreachable. |
