...
| --- | --- | --- | --- | --- |
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-wal-faults-20260916 | Merged and post-merge-verified a bounded typed v10 barrier admission plus independent-process SQLite concurrency/SIGKILL slice in PR #453; full AR remains in progress. | Continue WAL/SHM fault injection, uncovered process-death and lifecycle ambiguity boundaries, and implementation-to-formal refinement on current main 14a9f7d76cf072898de35185c2a5b76f4997f0fe; preserve fail-closed admission and do not claim full AR completion. |
