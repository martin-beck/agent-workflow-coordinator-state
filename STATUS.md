...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260915 | PR #237 merged c9bcaf08; Verify 34937814518 succeeded, TLC 121472/90752 + 110/94, attestation 10383831948. Begin next rejection-only slice from exact merged head. | Start the next bounded rejection-only caller/session validation slice from c9bcaf08; keep production mutation, dispatch, upgrade, apply, and rollback unreachable. |
