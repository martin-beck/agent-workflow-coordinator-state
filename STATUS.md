...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0007-next-slice-20260916 | Durably fence upgrade admission and every SQLite authority mutation under one project barrier. | Substantively rework PR #452: adapter-owned trusted mutation scope with common-control-authority lock order and durable barrier admission; fence all real SQLite routes and add held/releasing/ambiguous, rollback, concurrency, and process-failure tests; include sqlite_storage.py in formal scope. |
