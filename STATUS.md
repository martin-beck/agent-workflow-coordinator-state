...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260915 | PR #202 merged cea887b1; Verify 34929584536 succeeded with TLC 121472/90752 main, 110/94 small, attestation 10380927110. | Create and publish the next narrow rejection-only caller/session validation slice from cea887b1; keep dispatch, mutation, upgrade, apply, and rollback unreachable. |
