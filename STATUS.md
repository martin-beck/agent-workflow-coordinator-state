...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | codex-awc-ar0008-next-20260914 | Monitoring the next AR-0007 process-handoff retry slice from merged 38411745. No subsequent exact-head PR is currently published; only unrelated PR #85 is open. Formal/refinement and AR-0012 dependency boundaries remain unchanged. | Review the next published AR-0007 exact head for process-handoff retry safety, stale-lease rejection, lock cleanup and route reachability. Preserve implementation_refinement=not-proven, mutation disabled, and do not promote AR-0012. |
