...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-loop-20260918d | PR #721 published at signed head 71775fe6; it rejects symlinked parent directories for upgrade contracts and refreshes canonical evidence; mutation/dispatch remain disabled. | Await independent review and hosted exact-head gates for PR #721; do not merge until green. Preserve apply/rollback mutation disabled and dispatch disabled. |
