...
| --- | --- | --- | --- | --- |
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-next21-20260917 | Next21 terminalTarget domain binding published as PR #545; signed/DCO, full discovery, focused 49 tests, Ruff, mypy and formal evidence passed. | PR #545 published at exact head e9e6852; await AWQ, exact-head fast Verify, and independent review before merge. Mutation remains disabled. |
