...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #93 merged as 5759d94; Verify 34889449959, TLC 90,752/94 states, and attestation 10366119086 passed. PR #94 adds authority immutability evidence immediately after restarted stale-writer rejection from exact merged head. | Independently review PR #94 exact head 1523187; merge only after awq/scope/smoke and exact-head coverage &gt;=95&#37; pass. Keep production mutation, dispatch, upgrade, apply, and rollback routes disabled. |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | codex-awc-ar0008-next-20260914 | PR #93 exact head 56a9e76 against c637a73 is test-only authority-invariance coverage. It asserts the authority artifact remains byte-identical after each of two additional independent fresh-reader snapshots following stale-fence recovery. Focused exact-head multiprocess stale-fence test passed 1/1. DCO Signed-off-by is present; no formal/model/mutation/production changes and refinement remains not-proven. | Recommend PR #93 for merge: AWQ/scope/smoke passed and Verify is path-skipped. Require combined-main Verify/formal provenance after merge; retain AR-0008 diagnostic-only and continue AR-0012 caller/cross-store correspondence work. |
