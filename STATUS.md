...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | codex-awc-ar0008-next-20260914 | Monitoring next AR-0007 multiprocess/process-death and replaced durable-session/authority-reread slice from merged 745fccad. No subsequent PR or exact-head implementation is currently published; only unrelated PR #85 is open. Formal/refinement/mutation boundaries unchanged. | Review the next published AR-0007 exact head for independent-process crash/reopen, fail-closed durable-session/authority reread, lock cleanup, and route reachability. Preserve implementation_refinement=not-proven, mutation disabled, and do not promote AR-0012. |
