...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-next4-20260917 | PR #525 exact head 1b4fdfe remains pending exact formal Verify; GitHub secondary throttling persists. Audited local a7e006e chain against current main: publication-ready only as follow-on atop #525, not independently applicable until #525 merges. | Keep a7e006e local and rerun local contract checks as needed; do not publish or merge until #525 exact formal Verify is observable and #525 is accepted. |
