...
| P0 | [AR-0013](tasks/AR-0013.md): Selector-aware authenticated versioned runtime | codex-awc-ar0013-next-descriptor11-20260917 | PR #556 merged 99b11267; exact Verify 35211820685 and authoritative post-merge Verify 35212018674 succeeded. | Implement descriptor11 bounded fail-closed admission boundary with hostile failure-path tests; preserve execution and selector mutation disabled. |
