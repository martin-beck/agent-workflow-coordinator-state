...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-next4-20260917 | PR #525 exact head 1b4fdfe remains pending exact formal Verify; GitHub workflow dispatch continues secondary-limit 403. Local prepared a7e006e remains unpublished and fully validated. | Retry #525 exact-head formal Verify only after sensible cooldown; until observable, retain a7e006e unpublished and do not merge. |
