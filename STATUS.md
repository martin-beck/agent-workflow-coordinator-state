...
| P0 | [AR-0013](tasks/AR-0013.md): Selector-aware authenticated versioned runtime | Unclaimed | Descriptor20 PR #576 merged ff8f6493; exact Verify 35221620483 and replacement authoritative post-merge Verify 35222021976 succeeded with TLC_TIER pr-fast and attestation. Descriptor21 claim active. | Inspect next distinct runtime admission/release integrity boundary; implement hostile fail-closed regression coverage without enabling execution or selector mutation. |
