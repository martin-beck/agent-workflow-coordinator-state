...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-next4-20260917 | PR #525 published at signed head 1b4fdfe: transition workspace root and lexical parent directories must be owner-controlled and non-writable by group/others; hostile nested-parent test added. | Obtain independent exact-head review for PR #525, then await PR and manual Verify gates; merge only after approval and all required checks pass. |
