...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-barrier-20260918 | PR #696 adds hostile SQLite restore-abort lock-release coverage; barrier and mutation remain fail-closed. | Review and run exact-head hosted gates for PR #696; preserve disabled upgrade/rollback mutation. |
