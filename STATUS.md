...
| P0 | [AR-0031](tasks/AR-0031.md): Executable upgrade mutation and rollback boundary | codex-awc-ar0031-mutation-20260918d | Approved implementation slice starts from product main 95d27e9: add authority-neutral durable binding/session interfaces and a SQLite compatibility adapter with contract, hostile, process-death, and concurrency tests. Git dispatch and broad mutation remain disabled. | Implement and test DurableAuthorityBinding/DurableUpgradeSession plus SQLite compatibility binding in fresh worktree agent-workflow-coordinator-ar0031-durable-binding at 95d27e9. Do not enable Git dispatch, UpgradeEngine.apply, replace/commit, rollback, or selector mutation. |
