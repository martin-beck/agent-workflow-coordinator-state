...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #84 merged as 873d0d7; Verify 34885522216 and TLC attestation 10364811181 passed. PR #86 adds fresh-reader/idempotent retry evidence for v9 ambiguous control reconciliation from exact merged head. | Independently review PR #86 exact head 1dfea47; merge only after awq/scope/smoke and exact-head coverage &gt;=95&#37; pass. Keep production mutation, dispatch, upgrade, apply, and rollback routes disabled. |
