...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #159 published from 964b50c5 at signed 2d33fcd: validated_hold now rejects bool/int caller-context equivalence before lock acquisition. | Independently review PR #159 exact head 2d33fcd; require full Verify/coverage before merge; keep all production mutation/dispatch/upgrade/apply/rollback routes unreachable. |
