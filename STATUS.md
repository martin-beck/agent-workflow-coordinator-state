...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #187 merged dd615f01; Verify 34925702977 succeeded (TLC 121472/90752 main, 110/94 small, artifact 10379811671). | Create and publish the next narrow rejection-only caller/session validation slice from dd615f01; keep dispatch, mutation, upgrade, apply, and rollback unreachable. |
