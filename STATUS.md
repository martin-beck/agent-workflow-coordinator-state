...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260915 | PR #210 merged 6ebabeaa; Verify 34931400967 succeeded with TLC 121472/90752 main, 110/94 small, attestation 10381782127. | Create and publish the next narrow rejection-only caller/session validation slice from 6ebabeaa; keep dispatch, mutation, upgrade, apply, and rollback unreachable. |
