...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | Unclaimed | Next40 PR #586 signed head a937160 merged 069727c7; exact Verify 35226724657 and authoritative postmerge Verify 35226977082 succeeded. | Release completed next40, then claim next41 and implement next bounded fail-closed durability seam. |
