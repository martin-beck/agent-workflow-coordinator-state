...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-loop-20260918d | PR #721 hosted gates pass but independent review found an lstat-to-open parent-symlink race; repair required before merge. Mutation/dispatch remain disabled. | Repair PR #721 race: replace lstat-then-open ancestor check with descriptor-relative or identity-rechecked protection; add hostile race coverage, republish, and rerun gates. Do not merge while blocked. |
