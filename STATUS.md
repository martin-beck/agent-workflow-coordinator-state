...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260915 | PR #201 merged fa4d4345; Verify 34929310574 succeeded with TLC 121472/90752 main, 110/94 small, attestation 10381360987. | Create and publish the next narrow rejection-only caller/session validation slice from fa4d4345; keep dispatch, mutation, upgrade, apply, and rollback unreachable. |
