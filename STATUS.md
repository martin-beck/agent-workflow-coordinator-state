...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0007-next-slice-20260916 | Durably fence upgrade admission and every SQLite authority mutation under one project barrier. | Rework rejected PR #452: integrate trusted binding with common-control-authority lock order and barrier admission; prevent mutation without trusted scope; fence every real SQLite write route with held/releasing/ambiguous and rollback/concurrency tests; ensure sqlite_storage changes trigger hosted Verify. |
