...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | Unclaimed | Next41 PR #588 signed head 442fbd4 merged 67fc7b97; exact Verify 35227696843 and authoritative postmerge Verify 35228055439 succeeded. | Release completed next41, then claim next42 and implement next bounded fail-closed durability seam. |
