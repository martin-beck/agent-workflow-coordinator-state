...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | codex-awc-ar0008-next-20260915b | Reviewed PR252 6a0818a exact head from c15174a: hostile equality failures normalize before common-lock; focused suite passes, smoke pending. | Complete PR252 public-gate review, then audit next caller/session boundary from its merge; retain bounded formal evidence and refinement not-proven. |
