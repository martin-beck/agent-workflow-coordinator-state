...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0007-next-slice-20260916 | Durably fence upgrade admission and every SQLite authority mutation under one project barrier. | Gate PR #452 exact head a6f6e096 with hosted pr-fast Verify and independent review; then implement full authority route harness with initialized schema, all mutations, replacement/failure rollback, concurrency, barrier-state and formal evidence. |
