...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-loop-20260918b | Release policy and unsigned protected tags are complete; v0.3.15, v0.3.16, and v0.3.17 are published from merged main, with v0.3.17 at fe68c243. Post-merge Verify is being monitored; a follow-up changelog repair is required because the release race merged before documentation landed. Upgrade mutation remains disabled. | Complete and verify the v0.3.17 changelog repair without moving the published tag, then advance the next dependency-ready AR-0012/AR-0013 correctness slice on current main. |
...
| P0 | [AR-0013](tasks/AR-0013.md): Selector-aware authenticated versioned runtime | codex-awc-ar0013-runtime-20260918 | Selector identity migration and TUI handoff/event-journal validation are merged in v0.3.17 main fe68c243; remaining selector-aware launcher, manifest authenticity, validation-to-exec, and formal correspondence work remains. Mutation stays disabled. | Implement and verify the final selector reread before runtime resolution returns, with hostile selector replacement coverage, on current fe68c243; preserve fail-closed upgrade apply and rollback. |
