...
| --- | --- | --- | --- | --- |
| P0 | [AR-0079](tasks/AR-0079.md): Checkpoint command for task state and artifacts | codex-awc-ar0079-20260924q | Add checkpoint capturing task state, artifact refs, and the signed source commit, with journal-before-mutation ordering and a bounded per-task checkpoint list. | Implement the checkpoint command and doctor verification, then open a review PR. |
