...
| --- | --- | --- | --- | --- |
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-next29-20260917 | Next28 BeginReopen model transition binding merged PR #562 7aa1236c; authoritative post-merge Verify 35214687729 succeeded on fa508f5b. | Release next28 and claim next29; inspect remaining formal/durability correspondence seam and implement one bounded fail-closed slice. |
