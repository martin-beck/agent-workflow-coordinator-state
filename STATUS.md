...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-next4-20260917 | PR #516 merged as 573b3a8 and PR #517 merged as b724a404; combined post-merge Verify 35186806762 failed in existing control-lock polling test (expected one sleep, observed 133). Diagnose timing/implementation contract without weakening deadline safety. | Inspect control-lock polling deadline implementation/test; add robust repair and regression coverage, publish signed PR, and rerun full gates. |
