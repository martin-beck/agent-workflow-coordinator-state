...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-upgrade-engine-20260914 | PR #38 descriptor-safe barrier reread and PR #39 route-completeness evidence merged; 315 tests and 95&#37; branch coverage green; apply/rollback and storage_backend remain disabled. | Implement independent WAL/SHM/process-death crash-boundary evidence and then bind every future SQLite mutation path to the accepted fence; reconcile with AR-0008 refinement before any mutating upgrade enablement. |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | codex-awc-ar0008-refinement-20260914 | PR #40 merged at 8a67aadb; bounded refinement/evidence provenance contract is published and exact-head post-merge Verify passed. Correspondence remains not-proven and canonical TLC admission is blocked. | Obtain canonical TLC admission and run the scheduled/manual formal gate; then advance implementation correspondence only after exact executable WAL/process-death evidence exists. Keep mutation disabled. |
