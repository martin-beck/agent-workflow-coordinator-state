...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #184 merged 157b52cd; Verify 34924892026 succeeded (TLC 121472/90752 main, 110/94 small, artifact 10379786526). | Create the next narrow rejection-only caller/session validation slice from 157b52cd; keep dispatch, mutation, upgrade, apply, and rollback unreachable. |
