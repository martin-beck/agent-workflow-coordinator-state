...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #70 merged at 6a223c9 from aa4c40d: SQLite WAL/SHM sidecar identity capture and fail-closed revalidation; independent exact-head review passed 396 tests, 95&#37; total coverage (SQLite adapter 95&#37;), Ruff, mypy, format, diff, and DCO. Post-merge main Verify 34877951881 passed on exact merge head, including event-appropriate formal tier. Mutation, dispatch, upgrade/apply/rollback remain disabled. | Implement the next executable transaction-boundary/process-death fault-harness slice at merged head 6a223c9, preserving ScopedBackendAdapter and full caller-context validation; then independently review, publish, and merge. AR-0008 remains diagnostic-only. |
