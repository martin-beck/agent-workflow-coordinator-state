...
| P0 | [AR-0011](tasks/AR-0011.md): Bounded TLA+ execution and admission safety | codex-awc-ar0011-independent-review-20260914 | Prevent unbounded coordinator TLA+ jobs from exhausting shared host memory. | Independently review exact head 59d72c6 and exact-head PR run 34809697468. Keep the full-exhaustive claim exclusive to a successful scheduled/manual six-model attestation; do not merge on stale or partial evidence. |
