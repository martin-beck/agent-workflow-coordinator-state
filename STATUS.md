...
| P0 | [AR-0031](tasks/AR-0031.md): Executable upgrade mutation and rollback boundary | codex-awc-ar0031-mutation-20260918d | PR #733 merged as ad425d4. PR #734 adds bounded journal descriptor read/close uncertainty fencing with explicit O_NOFOLLOW read-until-EOF; SQLite safe mode remains fail-closed and outcome/mutation publication disabled. | Await independent exact-head review and hosted gates for PR #734 at bad63f3. Keep Git dispatch, UpgradeEngine.apply, replace/commit, rollback, selector mutation, and outcome publication fail-closed. |
