...
| --- | --- | --- | --- | --- |
| P0 | [AR-0064](tasks/AR-0064.md): Authority mutation implementation and formal refinement | codex-awc-ar0064-20260923 | Concrete authority adapters intentionally reject commit/apply today; this child supplies the missing implementation and formal refinement without weakening fail-closed behavior. | Define and implement the bound Git/SQLite authority mutation capability, then prove every failure boundary with exact-head tests and formal evidence. |
