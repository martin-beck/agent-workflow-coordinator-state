...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-next4-20260917 | PR #525 exact head 1b4fdfe remains pending exact hosted formal Verify. Attempted cherry-pick of origin-main policy commits 138ac4f/28e76ae onto #525 chain; 138ac4f conflicts in verify.yml and test_formal_evidence.py due intermediate history. Cherry-pick aborted; local a7e006e unchanged. | Keep product unchanged. Resolve workflow-policy dependency only after exact #525 formal gate is observable; retain a7e006e local and do not publish/merge. |
