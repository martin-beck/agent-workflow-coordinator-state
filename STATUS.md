...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-next4-20260917 | PR #525 exact head 1b4fdfe still has AWQ/scope/smoke green but Verify skipped; no exact hosted formal evidence observable. Local a7e006e oversized-input slice remains signed, tested, and unpublished. | Continue local-only audit during cooldown; publish a7e006e only after #525 exact formal Verify becomes observable and #525 is accepted. |
