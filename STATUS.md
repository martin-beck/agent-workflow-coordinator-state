...
| --- | --- | --- | --- | --- |
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-next39-20260917 | Next39 PR #584 signed head 6bf2084 merged 6b4aa7bc; exact Verify 35225680308 and authoritative postmerge Verify 35226040906 succeeded. | Release completed next39, then claim next40 and implement next bounded fail-closed durability seam. |
