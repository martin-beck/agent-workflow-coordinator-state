...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-loop-20260918b | Release policy and unsigned protected tag publication are complete; v0.3.14 remains latest release. Main advanced through PR #653 selector invariant and PR #654/#655 SQLite parent/sidecar fencing slices to 9f40b86, with exact-head and post-merge Verify green. AR-0012 and AR-0013 remain active P0 prerequisites; production mutation and supported upgrade campaign remain disabled. | Consume the remaining AR-0012 durable barrier/write-route and AR-0013 authenticated selector/runtime slices from current main 9f40b86; then run the first supported v0.3.13-to-v0.3.14 upgrade campaign with forced failures and verified functional recovery before closing AR-0009. |
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-barrier-20260918 | Reopened P0 issue #27 work. PR #654 merged as 6125e55 with parent-directory identity fencing; PR #655 merged as 9f40b86 with owner-only 0600 sidecar mode fencing. PR #656 merged as 0b0beac from independently approved exact head 5afdd745; returned CAS identity fields are now strictly bound to the admission lease while legacy snapshots remain compatible. Exact-head hosted checks passed and post-merge Verify 35317455503 passed AWQ, scope, fast formal Verify, and smoke policy. Broader barrier/session and every write-route proof remain required. | Continue the next durable barrier/SQLite fencing slice on current main 0b0beac: cover process-death, control/WAL/SHM replacement, and every authority write route with exact-head tests and independent review; do not enable mutating upgrade commands yet. |
| P0 | [AR-0013](tasks/AR-0013.md): Selector-aware authenticated versioned runtime | codex-awc-ar0013-runtime-20260918 | Reopened P0 issue #28 work remains incomplete. Narrow selector correctness PR #653 merged as db63ef2 from independently approved head 112087ca; it rejects duplicate active/previous runtime identities on descriptor-backed reads, bound reads, and atomic publication. Post-merge Verify 35315286261 passed AWQ, scope, fast formal Verify, and smoke policy; mutation paths remain disabled. | Implement the authenticated selector identity/schema slice on current main 9f40b86, propagate selector binding through engine/runtime fixtures, add hostile selector and validation-to-exec tests, then refresh formal correspondence and run exact-head hosted gates with independent review. |
