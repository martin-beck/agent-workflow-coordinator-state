...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #92 merged as c637a73; Verify 34889087540, TLC 90,752/94 states, and attestation 10365987252 passed. Starting next correctness slice. | Create a fresh isolated worktree from origin/main c637a73 and implement one bounded control/journal crash-recovery or stale-fence correctness slice; keep production mutation, dispatch, upgrade, apply, and rollback routes disabled until independently reviewed. |
