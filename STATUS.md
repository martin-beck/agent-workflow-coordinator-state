...
| --- | --- | --- | --- | --- |
| P0 | [AR-0064](tasks/AR-0064.md): Authority mutation implementation and formal refinement | codex-awc-ar0064-20260923f | Concrete authority adapters intentionally reject commit/apply today; this child supplies the missing implementation and formal refinement without weakening fail-closed behavior. | Continue with stale-owner fencing and reopen/retry evidence for the real SQLite authority capability, then bind functional-availability and complete formal refinement; keep public mutation and release dispatch disabled. |
