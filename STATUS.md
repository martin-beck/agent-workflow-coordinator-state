...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-barrier-20260918 | PR #695 SQLite backup-abort hostile coverage merged as 4d01becc; final post-merge Verify 35344605608 passed. Barrier and mutation work remain fail-closed. | Select the next bounded barrier/fencing failure-path slice from main 4d01becc; keep mutating upgrade and rollback commands disabled. |
