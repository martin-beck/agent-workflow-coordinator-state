...
| --- | --- | --- | --- | --- |
| P0 | [AR-0026](tasks/AR-0026.md): Discussion TUI session and task-event binding | codex-ar0026-tui-session-20260917 | Bind the reusable discussion TUI session to Coordinator task state. | Define revision-bound discussion-session events for TUI entry, active point, document anchor, user response, and unresolved status. |
