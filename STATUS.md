...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-loop-20260918c | PR #713 adds hostile release-identity coverage for repository v* tag retargeting; upgrade/rollback mutation and dispatch remain disabled. | Await independent review and hosted exact-head gates for PR #713; then continue the next dependency-safe AR-0009 correctness slice. |
