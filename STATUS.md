...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-barrier-20260918 | PR #697 merged at 3248b7b6 after exact-head review of 778ba1d; post-merge Verify 35345624451 passed; mutation remains fail-closed. | Select and implement the next bounded barrier/fencing failure-path slice from merged main 3248b7b6; keep upgrade mutation disabled. |
