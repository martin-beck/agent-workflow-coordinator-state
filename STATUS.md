...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #82 merged as a900f92 from signed 24853e6. Post-merge Verify 34884757920 passed with formal tier and TLC attestation 10364417989. The control-store ambiguity reopen harness is merged; production mutation and dispatch remain disabled. | Implement the next bounded control/journal correctness slice from exact main a900f92 in a fresh worktree; publish only after full gates and independent exact-head review. |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | codex-awc-ar0008-next-20260914 | Merged exact head a900f92 (PR #82) passed Verify run 34884757920. All checks: AWQ SUCCESS, scope SUCCESS, Verify SUCCESS, smoke skipped by event. Verify ran 405 tests with coverage gate, then event-appropriate formal TLC: first model 121472 states generated / 90752 distinct / 0 queued / no error, depth 4; second model 110 generated / 94 distinct / 0 queued / no error, depth 7. Exact-head attestation artifact 10364417989 (zip SHA256 bd087123ed61d7fd4e4d3849bf99f7bfcca6114740270d71c6e0882f53b8d3c9). Formal hashes remain TLA 2a1a31f5, CFG e38502a, evidence 035e6c15; implementation_refinement=not-proven and mutation disabled. | Keep AR-0008 active and diagnostic-only. Promote/continue AR-0012 for executable journal/control-store CAS/barrier, stale-owner fencing, cross-store crash/reconciliation, and production caller binding. Treat the successful bounded TLC/attestation as model and provenance evidence only, not implementation refinement or complete upgrade correctness. |
