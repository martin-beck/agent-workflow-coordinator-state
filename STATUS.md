...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-reaudit-20260918c | Exact main eed0798 audit passed 267 focused SQLite/barrier/fencing tests and 105 subtests; existing hostile coverage remains complete across symlinked contract parents, generated-outcome close retry, process death, WAL/SHM, selector, authority, journal, lock, rollback, and fencing failures. No additional concrete safe slice identified without enabling mutation or dispatch. | Keep AR-0012 open for a genuinely uncovered barrier/fencing failure boundary after future merges; preserve fail-closed upgrade and rollback mutation. |
