...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | codex-awc-ar0008-next-20260914 | Post-merge head b435c4d0 (PR #112) Verify 34896475629 succeeded. It ran 405 tests at 95&#37; coverage and formal TLC completed without errors for the admitted models, including 90,752 and 94 distinct states. Exact-head attestation artifact 10368936678 finalized. Formal hashes unchanged; implementation_refinement=not-proven and mutation disabled. PR #112 remains test-only rollback-child isolation evidence. | Continue independent exact-head review of the next AR-0007 slice. Require concrete production-caller traces binding forward/rollback child identity, journal/control CAS, authority/fence revisions, stale retry, and crash recovery before any correspondence claim. Treat b435c4d0 TLC/attestation as model/provenance evidence only. |
