...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260916 | PR364 merged; postmerge Verify queued | Check postmerge pr-fast Verify, then select next Git lifecycle slice. |
