...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-loop-20260918e | PR #734 merged/post-gates green. Exact-main audit confirms SQLite durable safe-mode remains read-only and fail-closed; formal correspondence is not-proven and Git mutation adapter remains unavailable. | Prioritize a bounded formal trace-correspondence slice for existing SQLite snapshot/safe-mode transitions before any Git adapter. Preserve upgrade/replace/rollback/selector mutation, outcome publication, and Git dispatch fail-closed. |
