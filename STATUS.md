...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-loop-20260918d | PR #721 merged as fe70c08; exact post-merge Verify 35362771550 succeeded on main. Descriptor-relative O_NOFOLLOW traversal and hostile parent-swap coverage are merged. Release transition remains separate and mutation/dispatch stay disabled. | Reconcile exact main fe70c08 and continue release-transition readiness audit; do not enable upgrade mutation or dispatch. |
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-barrier-20260918b | Exact main 21eeffaa audit passed 293 focused SQLite/barrier/fencing tests and 109 subtests; existing hostile coverage includes generated-outcome close retry, process death, WAL/SHM, selector, authority, journal, lock, and rollback failure paths. No additional concrete safe slice identified without enabling mutation or dispatch. | Keep AR-0012 open; re-audit after the next barrier/fencing merge for a genuinely uncovered failure boundary; preserve fail-closed upgrade and rollback mutation. |
| P0 | [AR-0013](tasks/AR-0013.md): Selector-aware authenticated versioned runtime | codex-awc-ar0013-runtime-20260918b | Focused selector/runtime audit remains complete with no duplicate seam; current main advanced through PR #720 repair to 21eeffaa; continue runtime correctness without enabling mutation or dispatch. | Re-audit and implement the next genuinely uncovered selector/runtime correctness slice from merged main 21eeffaa; retain fail-closed upgrade and rollback dispatch. |
