...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260915b | PR #263 merged at 13caf521 from reviewed 1016ed2; Verify 34950419056 green with TLC 4352/2728, 146/81, 516/232, 121472/90752, 110/94 and attestation 10389181581. AR-0008 PASS efe36ac; continue lifecycle/backend-equivalence coverage with refinement not-proven. | Implement the next justified AR-0007 lifecycle/backend-equivalence slice after PR263: bind trusted durable session identity to the backend adapter and add stale/replaced descriptor, crash/cleanup, and zero-mutation rejection coverage; keep mutation and dispatch unreachable. |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | codex-awc-ar0008-next-20260915b | PR263 repaired exact head 1016ed2 narrow PASS: bind now invokes scope.assert_ordered and normalizes RuntimeError/TypeError/AttributeError before constructing binding; hostile test proves hold/store untouched. Exact base a8e8e148, signed DCO, mergeable, AWQ/scope/smoke green; focused admitted-control + lock-domain suite 22 passed/10 subtests. | Monitor PR263 merge and post-merge Verify/TLC. Then review next caller-owned session/recheck seam for immutable descriptor/recheck identity, authority revision, stale/process-death cleanup, zero mutation reachability, exact gates and bounded attestation; keep refinement not-proven and AR-0012 unpromoted. |
