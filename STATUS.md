...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #182 merged 993bb612; Verify 34924359855 succeeded (TLC 121472/90752 main, 110/94 small, artifact 10379286042). | Create the next narrow rejection-only caller/session validation slice from 993bb612; keep dispatch, mutation, upgrade, apply, and rollback unreachable. |
