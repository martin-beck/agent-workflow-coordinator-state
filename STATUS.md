...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-next3-20260917 | PR #512 merged as a2062c06 and PR #513 merged as e9e6ca3b; post-merge Verify 35185264155 passed. PR #514 at b8629e1 validates source-commit evidence is exactly one non-empty line matching GITHUB_SHA before upload; full local suite 760 passed. | Obtain independent exact-head review for PR #514 and exact-head Verify; merge only after approval and green gates, then record post-merge evidence. |
