...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-barrier-20260918 | PR #702 merged at e1fd032c after exact-head review of e91845bb; post-merge Verify 35348861458 passed; mutation remains fail-closed. | Select and implement the next bounded barrier/fencing failure-path slice from merged main e1fd032c; preserve fail-closed upgrade and rollback mutation. |
