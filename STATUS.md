...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-next4-20260917 | PR #516 merged as 573b3a8 and PR #517 merged as b724a404; post-merge Verify 35186806762 exposed flaky shared-time patch in existing polling test. PR #518 at db72211 isolates the test clock; rollback-control-store suite 79 passed; production deadline bound unchanged. | Obtain independent exact-head review and Verify for PR #518; merge only after approval and green gates, then rerun full discovery in a clean environment. |
