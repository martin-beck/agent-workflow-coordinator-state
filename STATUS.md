...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-barrier-20260918 | Reopened P0 barrier work remains incomplete after merged fencing slices #654-#657, #672, and #674. PR #676 merged process-death recovery regressions at 76bf8d1 and PR #678 merged WAL/SHM hostile sidecar replacement coverage at 485e8ae8; exact Verify 35331958222 passed. No mutating upgrade path is enabled; broader barrier/session, SQLite write-route, and formal proof obligations remain. | Continue the next bounded barrier/process-death or SQLite write-route fencing slice on current main 485e8ae8 with exact-head tests and independent review; do not enable mutating upgrade commands. |
