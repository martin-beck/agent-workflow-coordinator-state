...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #179 merged 8a010cd5; Verify 34923574505 succeeded (TLC 121472/90752 main, 110/94 small, artifact 10378853826). | Create the next narrow rejection-only caller/session validation slice from 8a010cd5; keep dispatch, mutation, upgrade, apply, and rollback unreachable. |
