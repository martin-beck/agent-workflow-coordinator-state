...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-barrier-20260918 | PR #704 merged at be3343c8 after exact-head review of baad0632; post-merge Verify 35349987086 passed; mutation remains fail-closed. | Select and implement the next bounded barrier/fencing failure-path slice from merged main be3343c8; preserve fail-closed upgrade and rollback mutation. |
