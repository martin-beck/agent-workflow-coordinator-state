...
| --- | --- | --- | --- | --- |
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-next48-20260917 | Next48 PR #603 merged at ef3a907; exact PR Verify 35236576604 SUCCESS on signed head 76258be. Authoritative post-merge Verify 35237013041 FAILED on an unrelated concurrent SQLite selector identity error-message regression: expected unknown release identity, got selector target identity changed. Next48 remains formally green; mutation disabled. | Hold next48 release and next49 claim pending coordinator repair of the concurrent SQLite selector identity regression; retain exact failure evidence from Verify 35237013041. |
