...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260915 | PR #200 merged 2e7b7392; post-merge evidence is green. PR #201 published at b09e52a from exact merged head. | Independently review PR #201 exact head b09e52a; merge only after awq/scope/smoke and full Verify pass, then record post-merge evidence. |
