...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | codex-awc-ar0008-next-20260914 | Monitoring the next AR-0007 fresh trusted-authority reread-after-first-rejection slice from merged 1d49aeb6. No subsequent exact-head PR is currently published; only unrelated PR #85 is open. Retry/stale-lease, lock cleanup, route reachability and formal limits remain pending exact evidence. | Review the next published AR-0007 exact head for fresh trusted reread, stale-lease fail-closed retry, lock cleanup and route reachability. Preserve implementation_refinement=not-proven, mutation disabled, and do not promote AR-0012. |
