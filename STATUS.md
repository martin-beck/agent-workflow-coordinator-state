...
| --- | --- | --- | --- | --- |
| P0 | [AR-0017](tasks/AR-0017.md): TLC resource-bound reliability | codex-awc-ar0017-tlc-capacity-20260915 | PR #318 exact signed head a25ea66 passed independent review, local gates, AWQ/scope; Verify 35015342502 is now actively running with the 4 GiB heap/6 GiB containment profile after PR #315 OOM failure. | Wait for terminal PR #318 Verify; independently inspect all checks, merge only if green, then require post-merge exact-head verification. |
