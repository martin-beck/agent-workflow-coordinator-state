...
| P0 | [AR-0031](tasks/AR-0031.md): Executable upgrade mutation and rollback boundary | codex-awc-ar0031-mutation-20260918d | PR #730 merged as 2fe28a5. Next read-only continuity slice validates stable concurrent readers and repeated snapshot identity across the ordered lock/control/journal boundary; all outcome and mutation dispatch remain disabled. | Add stable concurrent-reader and repeated identity continuity tests in fresh worktree agent-workflow-coordinator-ar0031-snapshot-continuity at 2fe28a5. Keep Git dispatch, UpgradeEngine.apply, replace/commit, rollback, selector mutation, and outcome publication fail-closed. |
