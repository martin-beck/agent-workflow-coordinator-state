...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | codex-awc-ar0008-formal-20260914 | Signed 2ac7c3e adds a bounded v10 barrier model and TLC pass, but independent review found invariant/action soundness and exact-head provenance gaps; publication held. | Correct or explicitly narrow the v10 model: non-tautological active-session/CAS/lock/write-drain/recheck/rollback invariants and actions, bind evidence to exact merged product head 257ac7c, rerun TLC, and obtain independent review before publication. |
