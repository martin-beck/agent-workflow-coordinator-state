...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260916 | PR422 published from exact 4d43475; hosted checks and independent review pending | Review and merge PR422 after exact-head PASS and all hosted checks green; then verify post-merge pr-fast |
