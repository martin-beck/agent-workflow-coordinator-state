...
| --- | --- | --- | --- | --- |
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-next44-20260917 | Next44 PR #594 published at signed head cc73ad9; validator requires THEOREM Spec =&gt; &#91;&#93;CasBounded. Focused 49-test and full 737-test 95&#37; gates pass. | Monitor PR #594 AWQ/scope and exact-head pr-fast Verify; independently review, guarded merge on green, then authoritative postmerge Verify and reconcile. |
