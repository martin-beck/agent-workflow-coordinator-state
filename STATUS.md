...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260915 | PR #209 merged dda0ccc5; Verify 34931177294 succeeded with TLC 121472/90752 main, 110/94 small, attestation 10381228537. | Create and publish the next narrow rejection-only caller/session validation slice from dda0ccc5; keep dispatch, mutation, upgrade, apply, and rollback unreachable. |
