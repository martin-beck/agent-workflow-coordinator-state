...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-loop-20260918c | PR #713 merged at 744a41d9 after exact-head independent review; post-merge Verify 35356406133 passed; release tags remain unsigned/lightweight and protected; mutation remains disabled. | Select and implement the next dependency-safe correctness slice from merged main 744a41d9; preserve fail-closed upgrade/rollback mutation and dispatch disabled. |
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-barrier-20260918 | PR #712 merged at be49166a after exact-head independent review; post-merge Verify 35355832306 passed; mutation remains fail-closed. | Select and implement the next bounded barrier/fencing failure-path slice from merged main be49166a; preserve fail-closed upgrade and rollback mutation. |
