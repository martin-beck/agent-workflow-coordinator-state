...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-loop-20260918b | Release policy and unsigned protected tags are complete; v0.3.15 is published from merged main 64b9842 with lightweight protected tag and post-merge Verify 35321455020 success. Upgrade mutation remains disabled while AR-0012 and AR-0013 correctness prerequisites continue. | Continue AR-0012 and AR-0013 prerequisite slices on v0.3.15 main; keep upgrade apply and rollback fail-closed until barrier, selector, authenticity, and formal correspondence evidence are complete. |
