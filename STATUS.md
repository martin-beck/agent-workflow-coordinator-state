...
| --- | --- | --- | --- | --- |
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-next42-20260917 | Next42 PR #590 signed head a838664 merged as 9db5d405; exact Verify 35228815810 succeeded. Authoritative postmerge Verify 35229075857 is in progress. | Monitor authoritative postmerge 35229075857 on 9db5d405 to terminal success; then release next42, claim next43, and implement next bounded seam. |
| P0 | [AR-0013](tasks/AR-0013.md): Selector-aware authenticated versioned runtime | codex-awc-ar0013-next-descriptor28-20260917 | Descriptor26 PR #587 merged fd4e6a1d; exact Verify 35227421572 and authoritative replacement post-merge Verify 35228055439 succeeded on latest main 67fc7b97 with formal tier and attestation. Descriptor27 claim active. | Inspect next distinct runtime admission/release integrity boundary; implement hostile fail-closed regression coverage without enabling execution or selector mutation. |
