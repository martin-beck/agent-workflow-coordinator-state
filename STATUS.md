...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | Unclaimed | Next36 PR #578 signed head 111fb6f merged as 08867cc4; exact Verify 35222618083 and authoritative postmerge Verify 35222870723 succeeded. | Release completed next36, then claim next37 and implement next bounded fail-closed durability seam. |
