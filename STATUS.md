...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #170 merged 87bb2180; Verify 34921044605 succeeded (TLC 121472/90752 main, 110/94 small, artifact 10378266839). | Create the next narrow rejection-only caller/session validation slice from 87bb2180; keep dispatch, mutation, upgrade, apply, and rollback unreachable. |
