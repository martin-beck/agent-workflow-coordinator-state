...
| P0 | [AR-0011](tasks/AR-0011.md): Bounded TLA+ execution and admission safety | codex-awc-ar0011-independent-review-20260914 | Prevent unbounded coordinator TLA+ jobs from exhausting shared host memory. | Independently review exact signed head 01b305b and exact-head PR run 34809949588. Require the pr-publication attestation for merge; reserve full-exhaustive claims for a successful scheduled/manual six-model attestation. |
