...
| --- | --- | --- | --- | --- |
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-next12-20260917 | Next12 terminal-outcome correspondence implemented locally: exact forward reopen/new and rollback release/old outcomes with fail-closed incomplete and wrong-target rejection; all local gates green. | Prepare signed PR from product commit 5c39b0a; obtain independent exact-head review and hosted pr-fast Verify. Mutation remains disabled. |
