...
| P0 | [AR-0031](tasks/AR-0031.md): Executable upgrade mutation and rollback boundary | codex-awc-ar0031-mutation-20260918d | PR #732 merged as cc1850d. Next read-only slice adds explicit in-memory ambiguous/safe-mode transitions after journal close/read or identity failures, with repeated fail-closed rejection; outcome and mutation dispatch remain disabled. | Implement and test SQLite compatibility-session safe-mode transitions in fresh worktree agent-workflow-coordinator-ar0031-snapshot-safe-mode at cc1850d. Keep Git dispatch, UpgradeEngine.apply, replace/commit, rollback, selector mutation, and outcome publication fail-closed. |
