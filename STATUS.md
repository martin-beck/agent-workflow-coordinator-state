...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-loop-20260918c | PR #716 merged at 9cb79ea3 after exact-head independent review; post-merge Verify 35357868840 passed; release tags remain unsigned/lightweight and protected; mutation remains disabled. | Select and implement the next dependency-safe correctness slice from merged main 9cb79ea3; preserve fail-closed upgrade/rollback mutation and dispatch disabled. |
