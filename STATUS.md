...
| P0 | [AR-0031](tasks/AR-0031.md): Executable upgrade mutation and rollback boundary | codex-awc-ar0031-mutation-20260918d | PR #727 adds hostile evidence for the existing bound Git backup primitive: injected backup failure leaves no partial artifact or temporary residue. A generated Git executor is not yet safe because the adapter lacks a durable journal/control-store/session executor binding; broad apply and unsupported mutation remain fail-closed. | Await independent exact-head review and hosted gates for PR #727 at 37bfb9e. Treat this as bounded Git backup failure evidence, not generated dispatch. A future GitLifecycleExecutor must first bind durable barrier/session/journal identity equivalent to SQLite; do not enable UpgradeEngine.apply, replace/commit/rollback, or selector dispatch. |
