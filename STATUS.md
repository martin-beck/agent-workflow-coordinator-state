...
| P0 | [AR-0013](tasks/AR-0013.md): Selector-aware authenticated versioned runtime | codex-awc-ar0013-runtime-20260918 | PR #693 adds hostile manifest-parent replacement coverage on main 19d6b661; mutation and dispatch remain disabled. | Review and run exact-head hosted gates for PR #693; retain fail-closed runtime admission. |
