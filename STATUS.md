...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #147 merged as 845640fa; post-merge Verify 34912399386 passed with TLC 121472/90752 main, 110/94 small, attestation 10374494786. Keep rejection-only routes. | Start the next bounded fresh-process repeated reread slice from 845640fa; keep production routes unreachable and do not promote AR-0012. |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | codex-awc-ar0008-next-20260914 | Monitoring the next AR-0007 recovery slice from merged 845640fa. No subsequent exact-head PR is currently published; only unrelated PR #85 is open. Fresh-process reread, stale-lease rejection, cleanup, mutation and formal limits remain pending exact evidence. | Review the next published AR-0007 exact head for fresh-process trusted reread, stale-lease rejection and lock cleanup. Preserve implementation_refinement=not-proven, mutation disabled, and do not promote AR-0012. |
