...
| P0 | [AR-0013](tasks/AR-0013.md): Selector-aware authenticated versioned runtime | codex-awc-ar0013-baseline-20260918e | Exact main 95d27e9 focused baseline: 217 authority/engine/campaign tests passed and 231 runtime/admission/lock/control tests passed. No new safe selector/runtime seam identified; mutation and dispatch remain disabled. | Re-audit after the next relevant runtime merge; implement only a genuinely uncovered selector/versioned-runtime correctness slice. |
