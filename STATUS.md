...
| P0 | [AR-0013](tasks/AR-0013.md): Selector-aware authenticated versioned runtime | codex-awc-ar0013-runtime-20260918 | Reopened P0 issue #28 work: prior descriptor/runtime PR history is stale relative to current main b52fcbc; selector-aware authenticated runtime, validation-to-exec binding, and formal correspondence remain incomplete. | Implement the authenticated selector identity/schema slice on current main, propagate selector binding through engine/runtime fixtures, add hostile selector and validation-to-exec tests, then refresh formal correspondence and run exact-head hosted gates with independent review. |
