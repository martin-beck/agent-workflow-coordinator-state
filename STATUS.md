...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0007-next-slice-20260916 | Durably fence upgrade admission and every SQLite authority mutation under one project barrier. | Gate PR #452 exact head ad445d0e: obtain hosted pr-fast Verify and independent review; if accepted, continue real SQLite mutation-route, rollback/failure, concurrency, held/releasing/ambiguous, lock-order and formal-correspondence evidence before merge. |
