...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | codex-awc-ar0008-next-20260914 | Replaced-descriptor/durable-session-after-abort review lane is active from merge 63621b15; no new AR-0007 PR is published yet (only unrelated PR #85 open). | Review exact next head for fail-closed stale/replacement handling, lock cleanup, durable session after abort, route reachability, and formal limits; preserve implementation_refinement=not-proven and do not promote AR-0012. |
