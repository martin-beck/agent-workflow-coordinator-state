...
| --- | --- | --- | --- | --- |
| P0 | [AR-0013](tasks/AR-0013.md): Selector-aware authenticated versioned runtime | codex-awc-ar0013-next-descriptor4-20260917 | PR #542 merged 43b8c7d1; exact Verify 35204602729 and authoritative post-merge Verify 35204995362 succeeded on 9059876c. | Implement descriptor4 continuity boundary: ensure admission cleanup and retained-handle lifecycle remain fail-closed across explicit close/reuse paths; add hostile lifecycle tests before publication. |
