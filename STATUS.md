...
| --- | --- | --- | --- | --- |
| P0 | [AR-0076](tasks/AR-0076.md): Durable work-session snapshot record | codex-awc-ar0076-20260924q | Add a session record type capturing agent context digest, step state, artifact refs, and next action, appended on update/run with bounded, content-minimized storage. | Implement the session record type and replay path, then open a review PR. |
