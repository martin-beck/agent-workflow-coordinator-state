...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-loop-20260918b | Release policy and unsigned protected tag publication are complete; v0.3.14 remains latest release. Main advanced through merged PRs #653, #654, #655, #656, and #657 to 05f06d7, with exact-head and post-merge Verify green. AR-0012 and AR-0013 remain active P0 prerequisites; production mutation and supported upgrade campaign remain disabled. | Consume remaining AR-0012 durable barrier/write-route and AR-0013 authenticated selector/runtime slices from current main 05f06d7; then run the first supported v0.3.13-to-v0.3.14 upgrade campaign with forced failures and verified functional recovery before closing AR-0009. |
