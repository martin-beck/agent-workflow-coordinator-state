...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-barrier-20260918 | PR #706 merged at 3daac3c6 after exact-head review of 0c3c86a2; post-merge Verify 35351408140 passed; mutation remains fail-closed. | Select and implement the next bounded barrier/fencing failure-path slice from merged main 3daac3c6; preserve fail-closed upgrade and rollback mutation. |
