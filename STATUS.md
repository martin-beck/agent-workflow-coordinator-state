...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #81 merged at 05ebaee; post-merge Verify 34884165286 passed with 405 tests, coverage gate, and formal tier. PR #82 adds a fresh control-store reopen ambiguity harness from this exact head. | Independently review PR #82 exact head 24853e6; merge only after awq/scope/smoke and exact-head coverage &gt;=95&#37; pass. Preserve production mutation/dispatch constraints. |
