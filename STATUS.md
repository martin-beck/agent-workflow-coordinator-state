...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-loop-20260918c | PR #719 merged at e9083e7b, but exact post-merge Verify 35360108170 failed only on stale formal evidence digest for tests/test_upgrade_commands.py; repair required before continuing. | Repair stale formal/upgrade/evidence.json digest for tests/test_upgrade_commands.py, republish from e9083e7b, then rerun exact-head and post-merge Verify; preserve mutation/dispatch disabled. |
