...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-barrier-20260918 | PR #707 merged at 749f0135 after exact-head review of bae6aeb3; post-merge Verify 35352012571 passed; mutation remains fail-closed. | Select and implement the next bounded barrier/fencing failure-path slice from merged main 749f0135; preserve fail-closed upgrade and rollback mutation. |
