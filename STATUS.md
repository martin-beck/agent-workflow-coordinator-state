...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-next3-20260917 | PR #512 merged as a2062c06; post-merge Verify 35184757153 passed. Next bounded slice validates source-commit evidence is exactly one non-empty line matching GITHUB_SHA before upload; upgrade mutation remains disabled. | Implement and publish source-commit attestation validation with focused tests; obtain independent exact-head review and Verify. |
