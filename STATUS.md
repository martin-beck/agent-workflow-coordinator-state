...
| --- | --- | --- | --- | --- |
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-next38-20260917 | Next38 PR #582 signed head e647397 merged b99e8546; exact Verify 35224742699 and authoritative postmerge 35225071511 succeeded. | Release completed next38, then claim next39 and implement next bounded fail-closed durability seam. |
