...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #109 merged as e52e43c; Verify 34895346257, TLC 90,752/94 states, and attestation 10368656133 passed. PR #110 adds lowercase recovered digest evidence from exact merged head. | Independently review PR #110 exact head e147175; merge only after awq/scope/smoke and exact-head coverage &gt;=95&#37; pass. Keep production mutation, dispatch, upgrade, apply, and rollback routes disabled. |
