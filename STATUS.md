...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-barrier-20260918 | PR #694 selector-visibility KeyboardInterrupt coverage merged as d3459f3; final post-merge Verify 35344098978 passed. Barrier and mutation work remain fail-closed. | Select the next bounded barrier/fencing failure-path slice from main d3459f382; keep mutating upgrade and rollback commands disabled. |
