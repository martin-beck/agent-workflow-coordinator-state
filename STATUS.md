...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-loop-20260918e | PR #735 adds bounded formal correspondence scaffolding for SQLite snapshot/safe-mode transitions; implementation remains read-only and fail-closed. | Await independent exact-head review and hosted gates for PR #735 at 8f2b9a5. Preserve upgrade/replace/rollback/selector mutation, outcome publication, and Git dispatch fail-closed; formal map does not claim refinement. |
