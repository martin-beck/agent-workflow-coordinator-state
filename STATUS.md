...
| P0 | [AR-0031](tasks/AR-0031.md): Executable upgrade mutation and rollback boundary | codex-awc-ar0031-mutation-20260918d | PR #729 merged as 0dcd2a3. Next read-only evidence slice covers process death, close/fsync ambiguity, and concurrent-reader continuity for SQLite durable snapshots; outcome publication and mutation remain disabled. | Add hostile/process-death/close/fsync and concurrent-reader tests around SQLiteDurableSnapshot in fresh worktree agent-workflow-coordinator-ar0031-snapshot-failure-evidence at 0dcd2a3. Keep Git dispatch, UpgradeEngine.apply, replace/commit, rollback, selector mutation, and outcome publication fail-closed. |
