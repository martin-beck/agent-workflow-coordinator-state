...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-barrier-20260918 | PR #696 SQLite restore-abort hostile coverage merged as d15d29dc; final post-merge Verify 35345036937 passed. Barrier and mutation work remain fail-closed. | Select the next bounded barrier/fencing failure-path slice from main d15d29dc; keep mutating upgrade and rollback commands disabled. |
