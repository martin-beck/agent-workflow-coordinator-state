...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-upgrade-engine-20260914 | PR #53 merged at 0545eb00b5adf9811ec0718d0a7a44379bff5876; post-merge Verify 34862545950 passed tests/coverage, formal tier, attestation, AWQ, scope, and DCO. Typed AdmissionLease/AdmissionRecheck plus ordered selector scope remain uncalled contracts. | Continue AR-0007 toward executable correspondence: bind the typed lease/recheck/scope to real control-store and selector callers with exact multiprocess/failure evidence, then formalize the refinement map. Keep runtime mutation and apply/rollback disabled; AR-0013 remains planned. |
