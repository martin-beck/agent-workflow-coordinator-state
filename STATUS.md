...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-loop-20260918b | Release policy and unsigned protected tags are complete; v0.3.15, v0.3.16, and v0.3.17 are published from merged main. PR #675 merged at 4f22adf and post-merge Verify 35330605515 passed. v0.3.17 remains immutable at fe68c243; upgrade mutation remains disabled. | Continue the next dependency-ready AR-0012/AR-0013 correctness slice on current main 4f22adf; preserve fail-closed upgrade apply and rollback and do not rewrite published tags. |
