...
| --- | --- | --- | --- | --- |
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-next16-20260917 | PR #532 merged as 4303e02d after independent APPROVE and exact Verify 35199458466 success; post-merge Verify 35199850429 is in progress. | Monitor post-merge Verify 35199850429 on merge head 4303e02d to terminal success; then record release and reclaim next dependency-safe slice. Mutation remains disabled. |
