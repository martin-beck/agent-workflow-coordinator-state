...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260915 | PR #219 merged 3b3b441; exact-head Verify 34933394558 green, TLC 121472/90752 + 110/94, attestation 10383035125. Test-only tuple authority_revision rejection; mutation/dispatch remain unreachable. | Create and publish the next narrow rejection-only caller/session validation slice from 3b3b441; keep dispatch, mutation, upgrade, apply, and rollback unreachable. |
