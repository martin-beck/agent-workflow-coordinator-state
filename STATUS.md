...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-next4-20260917 | PR #525 exact head 1b4fdfe remains pending exact formal Verify. Compared workflow-policy commits 138ac4f/28e76ae: both are already ancestors of the PR branch and workflow/test files are identical to current main; no conflict-resolution patch is needed. | Keep product unchanged and await exact #525 formal gate; do not publish/merge a no-op policy patch. Retain local a7e006e unpublished. |
