...
| --- | --- | --- | --- | --- |
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-next47-20260917 | Next47 PR #601 signed head 55286a6 merged as 0c6208dd; exact Verify 35234577972 succeeded. Authoritative postmerge Verify 35235059072 is queued. | Monitor authoritative postmerge 35235059072 on 0c6208dd to terminal success; then release next47, claim next48, and implement next bounded seam. |
