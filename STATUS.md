...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-loop-20260918c | PR #719 adds upgrade-command integration coverage rejecting hard-linked contract aliases; unsigned protected-tag policy and mutation-disabled boundaries remain intact. | Await independent review and hosted exact-head gates for PR #719; then continue the next dependency-safe AR-0009 correctness slice. |
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-barrier-20260918b | PR #715 merged at ee23c2ff and PR #717 merged at b6048246; exact post-merge Verifies 35357252233 and 35358513352 passed; mutation remains fail-closed. | Select and implement the next bounded barrier/fencing failure-path slice from merged main b6048246; preserve fail-closed upgrade and rollback mutation. |
| P0 | [AR-0013](tasks/AR-0013.md): Selector-aware authenticated versioned runtime | codex-awc-ar0013-runtime-20260918b | Recovered AR-0013 after read-only audit; current main b6048246 includes merged release-identity and barrier slices; continue runtime correctness without enabling mutation or dispatch. | Re-audit and implement the next genuinely uncovered selector/runtime correctness slice from merged main b6048246; retain fail-closed upgrade and rollback dispatch. |
