...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | Unclaimed | Next42 PR #590 signed head a838664 merged 9db5d405; exact Verify 35228815810 and authoritative postmerge Verify 35229075857 succeeded. | Release completed next42, then claim next43 and implement next bounded fail-closed durability seam. |
