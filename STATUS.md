...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #84 merged as 873d0d7; post-merge Verify 34885522216 and TLC attestation 10364811181 passed (405 tests, coverage &gt;=95&#37;, formal tier). Fresh next-slice worktree is based on exact merged head. | Implement one bounded control/journal crash-recovery or stale-fence correctness slice in /srv/data/projects/agent-workflow-coordinator-next-control-journal from exact 873d0d7; keep production mutation, dispatch, upgrade, apply, and rollback routes disabled until independently reviewed. |
