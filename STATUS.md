...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | codex-awc-ar0008-rejection-invariant-20260915 | PR #317 published from exact main 7bf45013e9089fd0d32c18e97a69575b88e72dbb at signed head 99ca034de6cd987c34401b4e95facbef18ecd916. Adds RejectRollbackAdmission transition, RollbackAdmissionRejectedSafe invariant, config/theorem integration, refreshed model/config hashes, and refinement-map mapping to existing hostile tests. Focused evidence tests 8 passed; Ruff/format/diff pass. Public Verify is queued; implementation_refinement remains not-proven. | Obtain independent exact-head review and let queued public Verify execute TLC; merge only after all checks pass, then require exact post-merge Verify. |
