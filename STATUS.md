...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-next4-20260917 | PR #522 published at signed head 7a72e93: release artifacts now require runner ownership and no group/other write bits; workflow contract tests cover both checks. | Obtain independent exact-head review for PR #522, then dispatch/await manual Verify and PR gates; merge only after approval and all required checks pass. |
