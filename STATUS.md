...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #108 merged as 82c0a3b; Verify 34894953464, TLC 90,752/94 states, and attestation 10367179868 passed. PR #109 adds non-uniform recovered digest evidence from exact merged head. | Independently review PR #109 exact head 6d89bd0; merge only after awq/scope/smoke and exact-head coverage &gt;=95&#37; pass. Keep production mutation, dispatch, upgrade, apply, and rollback routes disabled. |
