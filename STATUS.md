...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260915b | PR #264 merged at 0b18ad34 from reviewed 6458bb1; Verify 34950900732 green with TLC 4352/2728, 146/81, 516/232, 121472/90752, 110/94 and attestation 10389172637. AR-0008 narrow PASS; continue lifecycle/backend-equivalence coverage with refinement not-proven. | Implement the next AR-0007 lifecycle/backend-equivalence slice: bind trusted durable session identity to the backend adapter and add stale/replaced descriptor and authority-revision, crash/cleanup, and zero-mutation rejection coverage; keep mutation and dispatch unreachable. |
