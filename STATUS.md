...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-barrier-20260918 | PR #694 adds hostile selector-visibility process-abort coverage; mutation and rollback remain disabled. | Review and run exact-head hosted gates for PR #694; preserve fail-closed selector/barrier admission. |
