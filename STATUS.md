...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #113 merged as e48889ee; Verify 34896862527 succeeded, TLC 90,752/94 states, and attestation 10369158144 passed. Starting next bounded test-only slice. | Implement and independently review the next bounded recovered-session revision assertion from exact e48889ee; keep mutation/apply/rollback routes disabled. |
