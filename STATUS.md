...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-barrier-20260918 | PR #699 merged at d0996e7f after exact-head review of e1fbc750; post-merge Verify 35346561753 passed; mutation remains fail-closed. | Select and implement the next bounded barrier/fencing failure-path slice from merged main d0996e7f; preserve fail-closed upgrade and rollback mutation. |
