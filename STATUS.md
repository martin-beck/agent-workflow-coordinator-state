...
| P0 | [AR-0013](tasks/AR-0013.md): Selector-aware authenticated versioned runtime | codex-awc-ar0013-next-descriptor37-20260917 | Descriptor36 PR #609 published at 7f81c971; focused tests 51 passed, Ruff/mypy/diff clean. Hosted AWQ/scope green; Verify queued. Merge held pending AR-0012 authoritative baseline repair. | Hold merge until AR-0012 baseline is green; then obtain exact-head Verify for PR #609 and proceed through independent review/postmerge. |
