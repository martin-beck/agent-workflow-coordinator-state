...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #108 merged as 82c0a3b; Verify 34894953464, TLC 90,752/94 states, and attestation 10367179868 passed. Starting next correctness slice. | Create a fresh isolated worktree from origin/main 82c0a3b and implement one bounded control/journal crash-recovery or stale-fence correctness slice; keep production mutation, dispatch, upgrade, apply, and rollback routes disabled until independently reviewed. |
