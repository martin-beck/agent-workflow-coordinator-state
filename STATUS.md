...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | codex-awc-ar0008-next-20260914 | Post-merge head e48889ee (PR #113) Verify 34896862527 succeeded. It ran 405 tests at 95&#37; coverage and formal TLC completed without errors for admitted models, including 90,752 and 94 distinct states. Exact-head attestation artifact 10369158144 finalized. Formal hashes unchanged; implementation_refinement=not-proven and mutation disabled. PR #113 remains test-only held-session/child-isolation evidence. | Continue independent exact-head review of the next AR-0007 slice. Require executable production-caller traces binding session held state, child identities, journal/control CAS, authority/fence revisions, stale retry, and crash recovery before any correspondence claim. Treat e48889ee TLC/attestation as model/provenance evidence only. |
