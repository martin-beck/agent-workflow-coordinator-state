...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-next4-20260917 | PR #525 exact head 1b4fdfe remains pending exact formal Verify after repeated secondary-limit 403. Local a7e006e remains unpublished and revalidated clean. | Maintain cooldown; continue local audit only. Do not publish a7e006e or merge until #525 exact formal Verify is observable and accepted. |
