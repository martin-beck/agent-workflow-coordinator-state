...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-barrier-20260918 | PR #710 updated at 74ec02a: fdopen failure now closes the allocated journal descriptor and proves closure; mutation remains fail-closed. | Obtain fresh independent review and hosted exact-head gates for PR #710 at 74ec02a; do not merge until the descriptor-leak blocker is cleared. |
