...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #96 merged as 2536552; Verify 34890505134, TLC 90,752/94 states, and attestation 10366592397 passed. Starting next correctness slice. | Create a fresh isolated worktree from origin/main 2536552 and implement one bounded control/journal crash-recovery or stale-fence correctness slice; keep production mutation, dispatch, upgrade, apply, and rollback routes disabled until independently reviewed. |
