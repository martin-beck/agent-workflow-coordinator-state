...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | codex-awc-ar0008-next-20260915b | PR260 exact-head narrow PASS: base c3746e6, signed head 597c437, mergeable; admitted_cas now rejects non-dict backend CAS results as AdmissionLeaseError after scope release, with events order/hold/write/release. Focused admitted-control suite 5 passed, AWQ/scope/smoke green, signed DCO, diff-check clean. | Monitor PR260 merge and post-merge Verify/TLC. Require backend result schema/equivalence and lifecycle/fault mapping in subsequent slices; preserve exact identity/CAS/recheck/lock criteria, no mutation/refinement claim, AR-0012 unpromoted. |
