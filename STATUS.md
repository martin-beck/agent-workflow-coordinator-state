...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-atomic-20260917 | PR #458 fixture-only campaign published; real coordinator-shaped Git/SQLite backup, generated operation dispatch, fault recovery, WAL/SIGKILL reopen, and fail-closed apply evidence complete. Production upgrade execution remains disabled. | Repair post-merge coverage failure from PR #478: add targeted sqlite_authority_adapter reconciliation/descriptor branch tests until full branch coverage is &gt;=95, then publish and re-review exact head. |
