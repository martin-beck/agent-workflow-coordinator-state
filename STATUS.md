...
| P0 | [AR-0013](tasks/AR-0013.md): Selector-aware authenticated versioned runtime | Unclaimed | Descriptor11 PR #557 merged 5a17a6b; latest main PR #558 b5769600; post-merge Verify 35212687138 succeeded. Descriptor12 claim active. | Implement descriptor12 bounded fail-closed runtime admission boundary with hostile failure-path tests; preserve retained descriptor identity checks, execution and selector mutation disabled. |
