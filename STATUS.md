...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-next3-20260917 | PR #507 merged as 4dd4ce45; post-merge Verify 35182029762 passed all AWQ/scope/verify gates. Release evidence now binds GITHUB_SHA, checked-out HEAD, and strict artifact digests; upgrade mutation remains disabled. | Release this completed checkpoint, reclaim AR-0009, and select the next dependency-safe release-integration failure boundary. |
