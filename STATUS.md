...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260915 | PR #228 merged f535d6d; exact-head Verify 34935348853 green, TLC 121472/90752 + 110/94, attestation 10383227781. Test-only bytes fencing_owner rejection; mutation/dispatch remain unreachable. | Create and publish the next narrow rejection-only caller/session validation slice from f535d6d; keep dispatch, mutation, upgrade, apply, and rollback unreachable. |
