...
| P0 | [AR-0031](tasks/AR-0031.md): Executable upgrade mutation and rollback boundary | codex-awc-ar0031-mutation-20260918d | PR #732 merged as cc1850d. PR #733 adds explicit in-memory ambiguous safe-mode fencing for SQLite compatibility sessions after journal or authority uncertainty; repeated operations and outcome publication remain fail-closed. | Await independent exact-head review and hosted gates for PR #733 at 74ef3dc. Do not merge until checks pass. Keep Git dispatch, UpgradeEngine.apply, replace/commit, rollback, selector mutation, and outcome publication fail-closed. |
