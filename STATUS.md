...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | codex-awc-ar0008-rejection-invariant-20260915 | PR #317 repaired exact head 267efd9eb9ef8326ffbfae0154cabd2865cea30f from base 7bf4501. formal/upgrade/evidence.json and v10-refinement-contract.json now include RollbackAdmissionRejectedSafe and exact model/config hashes (742be024 and f78fbd0). Focused formal/evidence tests 8 passed; Ruff/format/diff pass; DCO signed. Independent exact-head review and public Verify are pending; no local TLC claim. | Obtain independent review of 267efd9, wait for exact-head Verify, then merge only after all checks and require post-merge Verify. |
