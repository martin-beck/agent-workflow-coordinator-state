...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #144 merged as 38411745; post-merge Verify pending. Exact PR head 392228b passed independent review and all PR checks; preserve rejection-only routes. | Record post-merge Verify for merge 38411745, then continue the next bounded process-handoff retry slice; keep production routes unreachable and do not promote AR-0012. |
