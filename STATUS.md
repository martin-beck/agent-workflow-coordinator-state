...
| --- | --- | --- | --- | --- |
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-next22-20260917 | Next22 terminalVerified prime transition binding published as PR #547; signed/DCO, full discovery, focused 49 tests, Ruff, mypy and formal evidence passed. | PR #547 published at exact head f2379bc; await AWQ, exact-head fast Verify, and independent review before merge. Mutation remains disabled. |
