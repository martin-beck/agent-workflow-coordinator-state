...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-loop-20260918c | PR #712 merged at be49166a with post-merge Verify 35355832306 passed; release tags remain unsigned/lightweight and protected; continue integration with mutation disabled. | Select and implement the next dependency-safe correctness slice from merged main be49166a; preserve fail-closed upgrade/rollback mutation and dispatch disabled. |
