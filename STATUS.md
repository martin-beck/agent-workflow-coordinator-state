...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260915b | PR #263 merged 13caf521; Verify 34950419056 green, attestation 10389181581. PR #264 rebased onto current main with signed head 6458bb1 for replaced fencing-evidence rejection; public gates restarted. | Await PR #264 independent review and public gates; merge through state-owned handoffctl, monitor exact-head Verify, then continue justified lifecycle/backend-equivalence coverage. |
