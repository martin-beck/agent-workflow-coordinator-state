...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-upgrade-engine-20260914 | Execute upgrades atomically and restore the known-good runtime on every failure path. | Implement release-fault reconciliation/postcondition reread and operation-scoped non-reentrant lock context with crash tests. Verify migrated journal schema and canonical digest exactness at fresh load; Git remains fail-closed. |
