...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #110 merged as 444f23c6; Verify 34895669729 passed. PR #111 adds test-only evidence that a newer recovered session does not inherit stale child bindings. | Independently review PR #111 exact head 18230aa; merge only after awq/scope/smoke and exact-head coverage &gt;=95&#37; pass. Keep mutation/apply/rollback routes disabled. |
