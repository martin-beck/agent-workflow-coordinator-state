...
| --- | --- | --- | --- | --- |
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-next53-20260917 | Next53 PR #615 published at signed head 497ea6d: UpgradeRecovery validator requires NoReplacementBeforeBackup theorem admission marker with hostile missing-theorem coverage. Focused 36 tests and Ruff pass; mutation disabled. | Await PR #615 exact-head AWQ/scope/pr-fast Verify; independently review and merge only on green, then verify authoritative postmerge before releasing next53. |
