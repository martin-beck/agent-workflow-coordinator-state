...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-barrier-20260918 | Reopened P0 barrier work remains incomplete after merged fencing slices #654-#657, #672, #674, and #678. PR #684 and #685 repaired pre-existing quality defects from #680; PR #685 merged at e4431b8 and PR #683 CAS bootstrap regression is awaiting final rebase onto this clean main. Mutation remains disabled. | Rebase PR #683 onto current main e4431b8, rerun exact Verify and independent review, then merge only with terminal green evidence; do not enable mutating upgrade commands. |
