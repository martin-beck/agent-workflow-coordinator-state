...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-next4-20260917 | PR #525 remains unpublished-to-Verify at signed head 1b4fdfe pending GitHub secondary-limit recovery. Prepared local signed commit a7e006e bounding transition input to 1 MiB with hostile oversized-file test; no PR publication. | Wait for observable exact-head formal Verify for PR #525; then publish local a7e006e slice only after that gate is observable, with fresh review and Verify. |
