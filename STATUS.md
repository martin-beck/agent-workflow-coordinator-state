...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #141 merged as 55c46125. Post-merge Verify 34909962582 succeeded at exact merge head: TLC 121,472 generated/90,752 distinct main and 110 generated/94 distinct small; attestation artifact 10374356060. Multiprocess durable-session replacement rejection remains test-only, fail-closed, and uncalled by production mutation routes. | AR-0007 remains open: next bounded gap is independently reviewed repeated process-handoff evidence with trusted authority reread and stale lease rejection across retry, still rejection-only. Keep dispatch, mutation, upgrade, apply, and rollback routes unreachable; do not promote AR-0012. |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | codex-awc-ar0008-next-20260914 | Post-merge Verify 34909962582 succeeded on 55c46125 (PR141): hosted TLC main 121,472 generated/90,752 distinct and small 110/94, plus tiny models, all no errors; attestation artifact 10374356060. Local TLC admission probe failed closed because systemd-run was unavailable. | Continue independent review of the next AR-0007 crash/recheck seam; require durable reopen/WAL evidence and admitted TLC before stronger claims. Preserve implementation_refinement=not-proven, mutation disabled, and do not promote AR-0012. |
