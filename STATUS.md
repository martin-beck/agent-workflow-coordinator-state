...
| --- | --- | --- | --- | --- |
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-next27-20260917 | Next26 explicit rollback terminal guard merged PR #558 b5769600; post-merge Verify 35212687138 succeeded. | Release next26 and claim next27; inspect remaining formal/durability correspondence seams and implement one bounded fail-closed slice. |
