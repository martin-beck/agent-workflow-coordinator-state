...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260916 | PR405 merged as bb3f8da; post-merge Verify queued | Confirm post-merge fast Verify for bb3f8da; then release next bounded AR-0007 slice. |
