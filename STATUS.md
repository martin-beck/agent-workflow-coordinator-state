...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260915 | PR #222 merged 6f41ce0; exact-head Verify 34934017738 green, TLC 121472/90752 + 110/94, attestation 10382461943. Test-only list fencing_token rejection; mutation/dispatch remain unreachable. | Create and publish the next narrow rejection-only caller/session validation slice from 6f41ce0; keep dispatch, mutation, upgrade, apply, and rollback unreachable. |
