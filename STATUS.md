...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-barrier-20260918 | Reopened P0 barrier work remains incomplete after merged fencing slices #654-#657, #672, #674, #678, and coverage repairs #686/#687. v0.3.18 release is now merged at 45d8686 with post-merge Verify 35335594812 passed. PR #683 CAS bootstrap regression must be rebased onto 45d8686 and reverified; mutation remains disabled. | Rebase PR #683 onto current main 45d8686, rerun exact Verify and independent review, then merge only with terminal green evidence; do not enable mutating upgrade commands. |
