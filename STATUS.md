...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-barrier-20260918 | PR #711 repaired and merged at a095480c after exact-head review of e88b2097; post-merge Verify 35354915098 passed; mutation remains fail-closed. | Select and implement the next bounded barrier/fencing failure-path slice from merged main a095480c; preserve fail-closed upgrade and rollback mutation. |
