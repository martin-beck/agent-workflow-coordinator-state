...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #101 merged as e980aa9; Verify 34892394652, TLC 90,752/94 states, and attestation 10367935626 passed. PR #102 adds recovered attempt-identity evidence from exact merged head. | Independently review PR #102 exact head 9a2b191; merge only after awq/scope/smoke and exact-head coverage &gt;=95&#37; pass. Keep production mutation, dispatch, upgrade, apply, and rollback routes disabled. |
