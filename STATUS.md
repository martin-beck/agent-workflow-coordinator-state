...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-barrier-20260918 | Reopened P0 barrier work remains incomplete after merged fencing slices #654-#657, #672, #674, and #678. PR #684 merged formatting/complexity repair at 4704b697, removing the C901 suppression that blocked Verify. PR #683 CAS bootstrap regression is being rebased onto repaired main; mutation remains disabled. | Rebase PR #683 onto current main 4704b697, rerun exact Verify and independent review, then merge only with terminal green evidence; do not enable mutating upgrade commands. |
