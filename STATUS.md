...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #112 merged as b435c4d0; Verify 34896475629 succeeded, TLC 90,752/94 states, and attestation 10368936678 passed. Starting next bounded test-only slice. | Create a fresh isolated worktree from origin/main b435c4d0 and implement one bounded stale-child/recovery correctness assertion; keep mutation/apply/rollback routes disabled. |
