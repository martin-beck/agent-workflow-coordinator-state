...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-barrier-20260918 | PR #703 adds hostile generated-backup publication-abort durability coverage; mutation remains fail-closed. | Review and run exact-head hosted gates for PR #703; preserve disabled upgrade/rollback mutation. |
