...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-loop-20260918b | Release policy and unsigned protected tags are complete; v0.3.15, v0.3.16, and v0.3.17 are published from merged main. v0.3.17 remains immutable at fe68c243; its changelog provenance was corrected on main at 170688c. Upgrade mutation remains disabled. | Continue the next dependency-ready AR-0012/AR-0013 correctness slice on current main aded61e; preserve fail-closed upgrade apply and rollback and do not rewrite published tags. |
