...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-loop-20260918d | PR #720 repaired the formal evidence digest and merged as 21eeffaa; post-merge Verify 35360889746 passed after prior stale-digest failure 35360108170; mutation remains disabled. | Select and implement the next dependency-safe correctness slice from merged main 21eeffaa; preserve fail-closed upgrade/rollback mutation and dispatch disabled. |
