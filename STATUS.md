...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #144 merged as 38411745. Post-merge Verify 34911167215 succeeded at exact merge head: TLC 121,472 generated/90,752 distinct main and 110 generated/94 distinct small; attestation artifact 10373829220. Fresh reread stale-lease rejection remains test-only, fail-closed, and uncalled by production mutation routes. | AR-0007 remains open: next bounded gap is independently reviewed process-handoff retry after fresh reread with explicit repeated stale-lease rejection and cleanup. Keep dispatch, mutation, upgrade, apply, and rollback routes unreachable; do not promote AR-0012. |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | codex-awc-ar0008-next-20260914 | Reviewed PR #144 exact signed head 392228b against 1d49aeb6. Test-only fresh trusted-session reread obtains authority-retry after first stale rejection; a fresh scope using the old lease is rejected again and ownership is cleared. Focused tests pass 10 tests and 2 subtests; AWQ/scope/smoke are green, Verify skipped. | Continue independent review of the next AR-0007 recovery seam; require durable reopen/WAL evidence and admitted TLC before stronger claims. Preserve implementation_refinement=not-proven, mutation disabled, and do not promote AR-0012. |
