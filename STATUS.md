...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-barrier-20260918 | PR #703 merged at 47afd68a after exact-head review of 08fe2540; post-merge Verify 35349425899 passed; mutation remains fail-closed. | Select and implement the next bounded barrier/fencing failure-path slice from merged main 47afd68a; preserve fail-closed upgrade and rollback mutation. |
| P0 | [AR-0013](tasks/AR-0013.md): Selector-aware authenticated versioned runtime | codex-awc-ar0013-runtime-20260918 | PR #701 merged at a73479c3 after repaired exact-head review of 8d5d0a9; post-merge Verify 35348414807 passed; dispatch and mutation remain disabled. | Re-audit for the next genuinely uncovered selector/runtime correctness slice after merged main a73479c3; retain fail-closed upgrade and rollback dispatch. |
