...
| --- | --- | --- | --- | --- |
| P0 | [AR-0017](tasks/AR-0017.md): TLC resource-bound reliability | codex-awc-ar0017-tlc-capacity-20260915 | PR #319 signed head 5a9ba29 includes e3ad0ed capacity/preflight, 499e3e1 timeout alignment, and README correction; checks are pending. | Run and independently review PR #319 full gates; require terminal formal attestation/DCO, then merge and verify post-merge main. |
