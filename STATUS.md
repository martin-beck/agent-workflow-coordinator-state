...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #121 merged as 7d9933a9. Post-merge Verify 34900639133 succeeded with TLC 90,752/94 and attestation artifact 10370094700. Starting next bounded test-only slice from exact merged head. | Implement and independently review the next narrow test-only correctness assertion from 7d9933a9; preserve production mutation, dispatch, upgrade, apply, and rollback routes as disabled. |
