...
| P0 | [AR-0013](tasks/AR-0013.md): Selector-aware authenticated versioned runtime | codex-awc-ar0013-runtime-20260918 | PR #701 exact head 8d5d0a9 identifies and asserts retained release-directory descriptor cleanup on verifier abort. | Obtain fresh exact-head review and hosted gates for PR #701; preserve fail-closed runtime admission. |
