...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | Unclaimed | Next47 PR #601 signed head 55286a6 merged 0c6208dd; exact Verify 35234577972 and authoritative postmerge Verify 35235059072 succeeded. | Release completed next47, then claim next48 and implement next bounded fail-closed durability seam. |
