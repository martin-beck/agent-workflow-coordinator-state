...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260916 | PR405 published from exact main be5b46a; regular-file parent rejection test | Obtain independent exact-head review and green hosted gates for PR405; merge then verify post-merge pr-fast. |
