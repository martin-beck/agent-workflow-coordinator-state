...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-barrier-20260918 | PR #709 merged at 2f354915 after exact-head review of d19dbe46; post-merge Verify 35353114256 passed; mutation remains fail-closed. | Select and implement the next bounded barrier/fencing failure-path slice from merged main 2f354915; preserve fail-closed upgrade and rollback mutation. |
