...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-loop-20260918c | PR #714 merged at 003bf5f6; its superseded post-merge run was cancelled by PR #715, and authoritative main Verify 35357252233 passed on ee23c2ff; release tags remain unsigned/lightweight and protected. | Select and implement the next dependency-safe correctness slice from merged main ee23c2ff; preserve fail-closed upgrade/rollback mutation and dispatch disabled. |
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-barrier-20260918 | PR #715 merged at ee23c2ff after exact-head independent review; post-merge Verify 35357252233 passed; mutation remains fail-closed. | Select and implement the next bounded barrier/fencing failure-path slice from merged main ee23c2ff; preserve fail-closed upgrade and rollback mutation. |
