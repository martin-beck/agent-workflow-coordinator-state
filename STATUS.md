...
| --- | --- | --- | --- | --- |
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-next44-20260917 | Next43 PR #592 signed head fe3a62f merged 91650195; exact Verify 35229804115 and authoritative postmerge Verify 35230164391 succeeded. | Release completed next43, then claim next44 and implement next bounded fail-closed durability seam. |
