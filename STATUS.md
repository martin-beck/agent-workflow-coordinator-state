...
| P0 | [AR-0031](tasks/AR-0031.md): Executable upgrade mutation and rollback boundary | codex-awc-ar0031-mutation-20260918d | Bounded backend.backup implementation is dependency-safe, but UpgradeEngine.apply still requires all eight phases and Git/SQLite execute remain fail-closed; no safe broad apply wiring exists yet. Exact product worktree is agent-workflow-coordinator-ar0031-executable-backup at eed0798. | Implement a bounded backend.backup campaign executor with real admission session/barrier/journal identity, beginning with SQLite generated-operation parity; keep Git mutation, replace/commit/rollback, and broad UpgradeEngine.apply fail-closed until separately reviewed. Baseline: 63 adapter/engine/scoped tests and 105 subtests pass; fresh worktree created. |
