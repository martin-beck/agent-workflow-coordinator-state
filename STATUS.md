...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-loop-20260918e | PR #735 adds bounded formal correspondence scaffolding for SQLite snapshot/safe-mode transitions; implementation remains read-only and fail-closed. | Await independent exact-head review and hosted gates for PR #737 at cd08f19. Preserve upgrade/replace/rollback/selector mutation, outcome publication, and Git dispatch fail-closed; this binds only the read/close uncertainty model action. |
| P0 | [AR-0031](tasks/AR-0031.md): Executable upgrade mutation and rollback boundary | codex-awc-ar0031-mutation-20260918d | PR #735 adds bounded, machine-checked formal correspondence scaffolding for SQLite snapshot/identity reread, read-close uncertainty, and permanent ambiguous fencing. It preserves the rejection-only mutation gate. | Await independent exact-head review and hosted gates for PR #737 at cd08f19. Keep mutation, outcome publication, Git dispatch, apply, and rollback fail-closed; this binds only the read/close uncertainty model action and does not claim full refinement. |
