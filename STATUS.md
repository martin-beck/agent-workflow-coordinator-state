...
| --- | --- | --- | --- | --- |
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-next36-20260917 | Next35 PR #575 signed head 93ccfd8 merged 0b91f065; exact Verify 35221451125 and authoritative latest-main postmerge 35222021976 succeeded. | Release completed next35, then claim next36 and publish signed 111fb6f; focused 49-test and full 737-test 95&#37; gates pass. |
