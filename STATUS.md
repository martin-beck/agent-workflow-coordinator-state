...
| P0 | [AR-0013](tasks/AR-0013.md): Selector-aware authenticated versioned runtime | codex-awc-ar0013-runtime-20260918 | Reopened P0 issue #28 work remains incomplete. Narrow selector correctness PR #653 merged as db63ef2; mutation paths remain disabled. A bounded identity migration attempt was cleanly reverted after focused validation exposed 77 synchronized PhaseContext/adapter/rollback fixture sites; no partial product changes were published. | Implement the authenticated selector identity/schema slice on current main 05f06d7: update upgrade_identity and PhaseContext/rollback identity fixtures coherently, add hostile missing/traversal/forged-selector tests, refresh formal correspondence, then run exact-head hosted gates with independent review; do not enable mutation. |
