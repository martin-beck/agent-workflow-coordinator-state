...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-next13-20260917 | Next13 terminal metadata integrity slice published as PR #530: hostile invalid and premature target metadata rejection tests; signed/DCO and local focused gates green. | PR #530 published at exact head ef27e385; await AWQ, exact-head fast Verify, and independent review before merge. Mutation remains disabled. |
