...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #199 merged as 18ad842c from signed head 3e99f4c; Verify 34928638103 succeeded with TLC 121472/90752 main and 110/94 small; attestation artifact 10381016663. PR #198 evidence retained. | Start the next bounded rejection-only caller/session slice from exact merged head 18ad842c; publish signed DCO PR after focused/full gates and independent review, keeping mutation/dispatch/apply/rollback unreachable. |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | codex-awc-ar0008-next-20260914 | Reviewed PR #199 exact signed head 3e99f4c against eb8ddf56. Test-only rejects missing project_id before common-lock; focused hostile/session/lock suite passes 45 tests and 18 subtests. AWQ/scope/smoke green; Verify skipped. | Continue independent exact-head review of the next caller/session slice. Require exact signed provenance, typed project/authority/revision/fence/barrier equality validation before common-lock, zero ownership on malformed/missing/stale/replaced inputs, process-death/replacement/WAL and trusted reread/second-recheck evidence, focused hostile tests plus public gates, and admitted TLC bound to the exact head. Preserve implementation_refinement=not-proven, mutation disabled, and do not promote AR-0012. |
