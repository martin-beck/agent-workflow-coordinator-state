...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-loop-20260918c | PR #716 adds hostile candidate-mode coverage rejecting a target source commit different from checked-out HEAD; mutation and dispatch remain disabled. | Await independent review and hosted exact-head gates for PR #716; then continue the next dependency-safe AR-0009 correctness slice. |
