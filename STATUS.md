...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260915b | PR #268 merged at 0f8495a from reviewed 969ab37; Verify 34953212032 green with TLC 4352/2728, 146/81, 516/232, 121472/90752, 110/94 and attestation 10390126584. AR-0008 narrow PASS; next is trusted-session lifecycle/recheck, with refinement and mutation still disabled. | Implement the next trusted-session lifecycle/recheck seam around the typed backend binding: validate full lease/context/descriptor identity and reread authority/session state immediately before backend use; add process-abort cleanup and zero-backend-call rejection coverage; keep commit/apply/rollback disabled. |
