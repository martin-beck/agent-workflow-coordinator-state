...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-upgrade-engine-20260914 | Execute upgrades atomically and restore the known-good runtime on every failure path. | Review 7934a60 independently; rebind/rerun AR-0008 formal evidence at this exact head; then implement user-facing handoffctl upgrade command/release-plan wiring or create explicit dependency AR. Keep Git fail-closed unless fully integrated. |
