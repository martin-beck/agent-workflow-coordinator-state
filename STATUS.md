...
| P0 | [AR-0013](tasks/AR-0013.md): Selector-aware authenticated versioned runtime | codex-awc-ar0013-runtime-20260918 | Selector identity migration is merged in v0.3.15 main 64b9842; PR #658 exact Verify and independent review passed, and the release PR #660 TUI bridge plus coverage completed with post-merge Verify 35321455020 success. Remaining selector-aware launcher, authenticity, validation-to-exec, and formal correspondence work remains; mutation stays disabled. | Continue selector-aware runtime/launcher, manifest authenticity, validation-to-exec, and formal correspondence slices on v0.3.15 main; preserve fail-closed upgrade apply and rollback. |
