...
| P0 | [AR-0013](tasks/AR-0013.md): Selector-aware authenticated versioned runtime | codex-awc-ar0013-current-audit-20260918g | Exact main 95d27e9 focused baseline: 217 authority/engine/campaign tests passed and 231 runtime/admission/lock/control tests passed. No new safe selector/runtime seam identified; mutation and dispatch remain disabled. | Audit exact main e4bacb2 for one non-overlapping selector/versioned-runtime correctness boundary; do not duplicate AR-0031 formal correspondence; preserve fail-closed mutation and dispatch. |
