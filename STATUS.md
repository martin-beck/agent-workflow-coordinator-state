...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-next4-20260917 | PR #525 exact head 1b4fdfe remains pending formal Verify due GitHub secondary throttling. Audited local signed a7e006e atop #525: bounds transition JSON input to 1 MiB with hostile oversized-file test; publication-ready but intentionally unpublished. | Wait for observable exact-head formal Verify for PR #525. After it is observable, publish the prepared a7e006e slice (rebased atop current main if needed), request independent review, and dispatch Verify. |
