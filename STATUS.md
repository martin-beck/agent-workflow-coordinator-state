...
| --- | --- | --- | --- | --- |
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-next36-20260917 | Next36 PR #578 published at signed head 111fb6f; lifecycle validator now requires THEOREM Spec =&gt; &#91;&#93;ReleaseEvidence. Focused 49-test and full 737-test 95&#37; gates pass. | Monitor PR #578 AWQ/scope and exact-head pr-fast Verify; independently review, guarded merge on green, then authoritative postmerge Verify and reconcile. |
