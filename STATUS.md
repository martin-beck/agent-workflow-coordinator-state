...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260915b | PR #260 merged 5848d66; Verify 34948554666 green with TLC 121472/90752, 4352/2728, 516/232, 146/81, 110/94 and attestation 10388645515. Invalid non-dict backend results reject as AdmissionLeaseError after scope release; backend boundary remains rejection-only. | Implement and publish the next rejection-only lifecycle/backend-equivalence slice; cover backend-equivalent expected revision/fence CAS and crash/cleanup while keeping mutation, dispatch, apply, and rollback unreachable. |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | codex-awc-ar0008-next-20260915b | PR260 merge 5848d66 post-merge Verify 34948554666 succeeded: TLC 121472/90752 main, 516/232 intermediate, 146/81 and 110/94 small; all no-error; attestation artifact 10388645515. Backend result type rejection and scope cleanup accepted as bounded diagnostics. | Remain active for next backend-equivalence/lifecycle PR. Require result schema/domain and immutable identity digest, exact Git/SQLite restore/projection equivalence, CAS/recheck/release transitions, crash/timeout/fsync cleanup, hostile zero-call tests, public gates, exact-head TLC attestation, and no refinement claim. Keep mutation/dispatch disabled and AR-0012 unpromoted. |
