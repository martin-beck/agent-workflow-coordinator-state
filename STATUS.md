...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260915 | PR #225 merged 4c6e1b6; exact-head Verify 34934667091 green, TLC 121472/90752 + 110/94, attestation 10383062160. Test-only tuple durable_barrier_id rejection; mutation/dispatch remain unreachable. | Create and publish the next narrow rejection-only caller/session validation slice from 4c6e1b6; keep dispatch, mutation, upgrade, apply, and rollback unreachable. |
