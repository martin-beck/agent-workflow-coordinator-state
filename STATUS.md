...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260915 | PR #206 merged dd851b10; Verify 34930549770 succeeded with TLC 121472/90752 main, 110/94 small, attestation 10381463079. | Create and publish the next narrow rejection-only caller/session validation slice from dd851b10; keep dispatch, mutation, upgrade, apply, and rollback unreachable. |
