...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260915 | PR #221 merged 2729925; exact-head Verify 34933803463 green, TLC 121472/90752 + 110/94, attestation 10382471697. Test-only tuple fencing_owner rejection; mutation/dispatch remain unreachable. | Create and publish the next narrow rejection-only caller/session validation slice from 2729925; keep dispatch, mutation, upgrade, apply, and rollback unreachable. |
