...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-loop-20260918b | Release policy and unsigned protected tag publication are complete; v0.3.14 remains latest release. Main advanced to db63ef2 via independently reviewed PR #653 with post-merge Verify 35315286261 green. AR-0012 and AR-0013 are correctly reopened P0 prerequisites; production Git/SQLite mutation remains fail-closed and no supported upgrade campaign has completed. | Consume the reopened AR-0012 durable barrier/SQLite fencing and AR-0013 selector identity/runtime slices in dependency order; then run the first supported v0.3.13-to-v0.3.14 upgrade campaign with forced failures and verified functional recovery before closing AR-0009. |
