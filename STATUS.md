...
| P0 | [AR-0005](tasks/AR-0005.md): Git-backend backup and restore | codex-awc-ar0005-git-backup-20260914 | Back up and restore complete Git-backed coordination state without losing task history. | AR-0005 complete; PR #25 merged and post-merge main verification green. AR-0006 PR #26 remains open pending independent review and exact-head checks. |
