...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-barrier-20260918 | Reopened P0 barrier work remains incomplete after merged fencing slices #654-#657, #672, and #674. Current main is 5c9ec30; no mutating upgrade path is enabled. Broader barrier/session, process-death, SQLite write-route, and formal proof obligations remain. | Select and implement the next bounded barrier/process-death or SQLite write-route fencing slice on current main 5c9ec30 with exact-head tests and independent review; do not enable mutating upgrade commands. |
