...
| --- | --- | --- | --- | --- |
| P0 | [AR-0071](tasks/AR-0071.md): Spec-gated done admission | codex-awc-ar0071-20260924q | Admission of status done requires a resolved task spec and a passed acceptance check, mirroring the superseded_by chain admission pattern. | Implement spec-gated done admission and negative fixtures, then open a review PR. |
