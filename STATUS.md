...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-barrier-20260918 | PR #711 repaired at e88b209 with explicit retry/cleanup semantics for generated journal directory close failure; mutation remains fail-closed. | Obtain fresh independent review and hosted exact-head gates for PR #711 at e88b209; do not merge until retry semantics are accepted. |
