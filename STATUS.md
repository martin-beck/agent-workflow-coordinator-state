...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #98 merged as ff3c5b2; Verify 34891193544, TLC 90,752/94 states, and attestation 10367355016 passed. Starting next correctness slice. | Create a fresh isolated worktree from origin/main ff3c5b2 and implement one bounded control/journal crash-recovery or stale-fence correctness slice; keep production mutation, dispatch, upgrade, apply, and rollback routes disabled until independently reviewed. |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | codex-awc-ar0008-next-20260914 | PR #98 exact head daec18f against 588640e is test-only recovered fencing-token coverage. It asserts the reopened winning session retains fencing_token=fence-2 after stale-writer/restart recovery, alongside state/authority revision and authority artifact immutability checks. Focused exact-head multiprocess stale-fence test passed 1/1. DCO Signed-off-by present; no formal/model/mutation/production changes and refinement remains not-proven. | Recommend PR #98 for merge: AWQ/scope/smoke passed and Verify is path-skipped. Require combined-main Verify/formal provenance after merge; retain AR-0008 diagnostic-only and continue AR-0012 caller/cross-store correspondence work. |
