...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #162 published from 72585a47 at signed 6387d39: non-text fencing token is rejected before common-lock acquisition. | Independently review PR #162 exact head 6387d39; require full Verify/coverage before merge; keep all production mutation/dispatch/upgrade/apply/rollback routes unreachable. |
