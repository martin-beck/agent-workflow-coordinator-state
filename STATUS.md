...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-barrier-20260918 | PR #700 merged at bf6e675b after exact-head review of 9ad7f1da; post-merge Verify 35347141163 passed; mutation remains fail-closed. | Select and implement the next bounded barrier/fencing failure-path slice from merged main bf6e675b; preserve fail-closed upgrade and rollback mutation. |
