...
| P0 | [AR-0031](tasks/AR-0031.md): Executable upgrade mutation and rollback boundary | codex-awc-ar0031-mutation-20260918d | PR #729 merged as 0dcd2a3. PR #730 adds read-only durable snapshot evidence for journal read/close uncertainty, process death before outcome publication, and concurrent journal replacement; outcome publication and mutation remain disabled. | Await independent exact-head review and hosted gates for PR #730 at c7f9cc5. Do not merge until checks pass. Keep Git dispatch, UpgradeEngine.apply, replace/commit, rollback, selector mutation, and outcome publication fail-closed. |
