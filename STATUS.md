...
| --- | --- | --- | --- | --- |
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-next32-20260917 | Next32 held authority preconditions merged PR #568 d8886cef; post-merge Verify 35218048325 succeeded. | Release next32 and claim next33; inspect remaining formal/durability correspondence seam and implement one bounded fail-closed slice. |
