...
| --- | --- | --- | --- | --- |
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-next36-20260917 | Next35 PR #575 signed head 93ccfd8 merged as 0b91f065; exact Verify 35221451125 succeeded. Authoritative latest-main postmerge Verify 35222021976 succeeded on ff8f6493. | Release completed next35, then claim next36 and implement next bounded fail-closed durability seam. |
