...
| P0 | [AR-0031](tasks/AR-0031.md): Executable upgrade mutation and rollback boundary | codex-awc-ar0031-mutation-20260918d | PR #730 merged as 2fe28a5. PR #732 adds read-only continuity evidence: repeated snapshots preserve authority/control/journal identity and concurrent readers observe one stable snapshot. Outcome and mutation dispatch remain disabled. | Await independent exact-head review and hosted gates for PR #732 at 3612ff8. Do not merge until checks pass. Keep Git dispatch, UpgradeEngine.apply, replace/commit, rollback, selector mutation, and outcome publication fail-closed. |
