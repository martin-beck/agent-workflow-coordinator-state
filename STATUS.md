...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | codex-awc-ar0008-next-20260914 | Post-merge head 2a168e3 (PR #111) Verify succeeded with TLC completing without errors for the admitted models: 90,752 and 94 distinct states. Exact-head attestation artifact 10369335580 was published. Formal hashes remain unchanged; implementation_refinement=not-proven and mutation disabled. PR #111 remains test-only stale-child-binding evidence. | Continue independent exact-head review of the next AR-0007 slice. Require executable production-caller binding for child identity, journal/control CAS, authority/fence revisions, stale retry and crash recovery before any correspondence claim. Treat the 2a168e3 TLC/attestation as model/provenance evidence only. |
