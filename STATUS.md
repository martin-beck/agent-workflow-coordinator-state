...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-loop-20260918b | Release policy and unsigned protected tags are complete; v0.3.14 remains latest release. Main advanced through merged PRs #653-#658 to faf002f. PR #658 exact-head Verify 35319812691 and independent review passed; post-merge Verify 35320013414 failed only unrelated pre-existing formatting in tests/test_tui_bridge.py. AR-0012 remains active for broader fencing, AR-0013 remains active for runtime/launcher work, and mutation is disabled. | Merge and verify the narrow tests/test_tui_bridge.py formatting repair, then consume remaining AR-0012 and AR-0013 prerequisite slices before running the first supported v0.3.13-to-v0.3.14 upgrade campaign. |
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-barrier-20260918 | Reopened P0 issue #27 work. PRs #654, #655, #656, and #657 are merged. PR #657 merged at 05f06d7 after exact-head Verify 35318401938, independent review, and CAS(0) bootstrap-rotation fencing coverage; post-merge Verify 35318582966 passed AWQ, scope, fast formal Verify, and smoke policy. Broader barrier/session and every write-route proof remain required. | Continue the next durable barrier/SQLite fencing slice on current main 05f06d7 covering process-death, control/WAL/SHM replacement, and every authority write route with exact-head tests and independent review; do not enable mutating upgrade commands yet. |
| P0 | [AR-0013](tasks/AR-0013.md): Selector-aware authenticated versioned runtime | codex-awc-ar0013-runtime-20260918 | Reopened P0 issue #28 remains incomplete. PR #658 merged at faf002f after exact-head Verify 35319812691 and independent review; it binds selector_ref through canonical identity, PhaseContext, Git/SQLite adapters, control-store SQL, and rejects legacy schemas before WAL/DDL with schema version 3. Post-merge Verify 35320013414 failed only on unrelated pre-existing formatting in tests/test_tui_bridge.py; selector gates passed. Mutation remains disabled. | Consume the narrow formatting repair for tests/test_tui_bridge.py and obtain green post-merge Verify; then continue the remaining selector-aware runtime/launcher, manifest authenticity, validation-to-exec, and formal correspondence slices on current main faf002f. |
