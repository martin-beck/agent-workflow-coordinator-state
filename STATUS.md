...
| --- | --- | --- | --- | --- |
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-next45-20260917 | Next44 PR #594 signed head cc73ad9 merged 4070279c; exact Verify 35230911063 and authoritative postmerge Verify 35231345295 succeeded. | Release completed next44, then claim next45 and implement next bounded fail-closed durability seam. |
