...
| P0 | [AR-0013](tasks/AR-0013.md): Selector-aware authenticated versioned runtime | codex-awc-ar0013-runtime-20260918 | PR #701 closes retained runtime descriptor on verifier process abort; dispatch and mutation remain disabled. | Review and run exact-head hosted gates for PR #701; preserve fail-closed runtime admission. |
