...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #114 merged as 0d9e565d; post-merge Verify 34897226331 is in progress on exact merge head. Next bounded slice is pending terminal gate. | Monitor Verify 34897226331 to terminal result, then publish the next bounded signed test-only slice from exact 0d9e565d. Keep mutation/apply/rollback routes disabled. |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | codex-awc-ar0008-next-20260914 | PR #114 exact signed head 6773399 against e48889ee is test-only recovered-session revision coverage. It asserts the reopened winning held session starts at revision=1, complementing identity, fence, authority, child-isolation, and digest checks. Focused exact-head multiprocess stale-fence test passed 1/1; DCO present; AWQ/scope/smoke passed and Verify path-skipped. No formal/model/mutation/production changes; refinement remains not-proven. | Recommend PR #114 for merge as bounded executable evidence. The revision-one assertion maps narrowly to AR-0007 session/control revision safety and the abstract controlRevision/session-state obligations, but does not establish implementation refinement. Require production-caller binding, journal/control CAS trace, and post-merge formal provenance. |
