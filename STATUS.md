...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-upgrade-engine-20260914 | Execute upgrades atomically and restore the known-good runtime on every failure path. | Review 685bad7 independently; keep apply/rollback rejection-only until broad protocol redesign resolves barrier order/target identity/launcher/fencing. Rebind formal evidence to this stable exact head only after review. |
