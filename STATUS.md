...
| Priority | AR | Owner | Summary | Next action |
| --- | --- | --- | --- | --- |
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | Unclaimed | PR #710 repaired and merged at 5b8e6aca after exact-head review of 74ec02a; post-merge Verify 35354040868 passed; mutation remains fail-closed. | Select and implement the next bounded barrier/fencing failure-path slice from merged main 5b8e6aca; preserve fail-closed upgrade and rollback mutation. |
