...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #95 merged as 10aaddf; Verify 34890104204, TLC 90,752/94 states, and attestation 10366776307 passed. PR #96 adds explicit authority-revision evidence after recovery from exact merged head. | Independently review PR #96 exact head 9de96bb; merge only after awq/scope/smoke and exact-head coverage &gt;=95&#37; pass. Keep production mutation, dispatch, upgrade, apply, and rollback routes disabled. |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | codex-awc-ar0008-next-20260914 | PR #96 exact head 9de96bb against 10aaddf is test-only authority-revision coverage. It asserts the recovered winning session retains authority_revision_at_acquire=authority-3 after stale-writer/restart recovery, alongside existing state and artifact immutability checks. Focused exact-head multiprocess stale-fence test passed 1/1. DCO Signed-off-by present; no formal/model/mutation/production changes and refinement remains not-proven. | Recommend PR #96 for merge: AWQ/scope/smoke passed and Verify is path-skipped. Require combined-main Verify/formal provenance after merge; retain AR-0008 diagnostic-only and continue AR-0012 caller/cross-store correspondence work. |
