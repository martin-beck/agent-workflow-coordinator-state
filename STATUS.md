...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260915 | PR #207 merged f20588be; Verify 34930765735 succeeded with TLC 121472/90752 main, 110/94 small, attestation 10381542365. | Create and publish the next narrow rejection-only caller/session validation slice from f20588be; keep dispatch, mutation, upgrade, apply, and rollback unreachable. |
