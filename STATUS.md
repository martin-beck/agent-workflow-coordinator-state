...
| P0 | [AR-0013](tasks/AR-0013.md): Selector-aware authenticated versioned runtime | Unclaimed | PR #535 merged 58b6243e; exact Verify 35200960921 and post-merge Verify 35201229361 succeeded. | Release completed manifest continuity slice and select next dependency-safe descriptor continuity boundary. |
