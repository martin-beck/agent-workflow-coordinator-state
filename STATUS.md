...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-next4-20260917 | Product main is 4ceda3a (PR #524 merged). PR #525 exact head 1b4fdfe has AWQ/scope/smoke green but Verify skipped; exact hosted formal gate remains unavailable. Local a7e006e remains signed/tested/unpublished. | Keep product unchanged and local-only audit; do not publish a7e006e or merge #525 until exact hosted formal Verify is observable and accepted. |
