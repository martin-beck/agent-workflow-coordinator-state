...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #146 published from exact merged head 287bda12 at signed DCO commit ed77f94. Test-only fresh-process trusted reread now rejects the old lease and confirms lock cleanup. | Independently review PR #146 exact head ed77f94; merge after focused/full tests, coverage &gt;=95&#37;, quality, and formal evidence. Keep production routes unreachable; do not promote AR-0012. |
