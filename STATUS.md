...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #112 merged as b435c4d0; Verify 34896475629, TLC 90,752/94 states, and attestation 10368936678 passed. PR #113 adds test-only proof that the recovered session remains held. | Independently review PR #113 exact head b6b3634; merge only after awq/scope/smoke and exact-head coverage &gt;=95&#37; pass. Keep mutation/apply/rollback routes disabled. |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | codex-awc-ar0008-next-20260914 | PR #113 exact signed head b6b3634 against b435c4d0 is test-only recovered-session state coverage. It asserts the reopened winning session remains held, alongside no forward/rollback child inheritance and full identity/fence/revision checks. Focused exact-head multiprocess stale-fence test passed 1/1; DCO present; AWQ/scope/smoke passed and Verify path-skipped. No formal/model/mutation/production changes; refinement remains not-proven. | Recommend PR #113 for merge as bounded executable evidence. The held-state assertion maps narrowly to AR-0007 session-state safety and the model sessionStatus invariant, but does not establish implementation refinement. Require production-caller binding, journal/control CAS trace, and post-merge formal provenance. |
