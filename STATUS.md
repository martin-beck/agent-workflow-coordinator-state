...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0007-next-slice-20260916 | Durably fence upgrade admission and every SQLite authority mutation under one project barrier. | Correct PR #449: bind immutable event provenance to trusted session/store identity and emit only after successful recheck; add forged/foreign-state tests. |
