...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-barrier-20260918 | PR #712 adds hostile coverage for generated-backup journal serialization failure; mutation remains fail-closed. | Await independent review and hosted exact-head gates for PR #712; then continue the next bounded barrier/fencing failure-path seam. |
