...
| --- | --- | --- | --- | --- |
| P0 | [AR-0064](tasks/AR-0064.md): Authority mutation implementation and formal refinement | codex-awc-ar0064-20260923d | Concrete authority adapters intentionally reject commit/apply today; this child supplies the missing implementation and formal refinement without weakening fail-closed behavior. | Implement and verify the next SQLite rollback/cleanup ambiguity boundary, then continue process-death, stale-owner, reopen, and retry evidence without enabling public mutation. |
