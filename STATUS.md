...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260915 | PR #230 merged e6ed245; exact-head Verify 34935812422 green, TLC 121472/90752 + 110/94, attestation 10383054035. Test-only frozenset durable_barrier_id rejection; mutation/dispatch remain unreachable. | Create and publish the next narrow rejection-only caller/session validation slice from e6ed245; keep dispatch, mutation, upgrade, apply, and rollback unreachable. |
