...
| P0 | [AR-0013](tasks/AR-0013.md): Selector-aware authenticated versioned runtime | Unclaimed | Descriptor17 PR #570 merged 8b125098; exact Verify 35218697561 and replacement authoritative post-merge Verify 35219732715 succeeded with TLC_TIER pr-fast and attestation. Descriptor18 claim active. | Inspect next distinct runtime admission/release integrity boundary; implement hostile fail-closed regression coverage without enabling execution or selector mutation. |
