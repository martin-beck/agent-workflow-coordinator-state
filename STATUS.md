...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-loop-20260918b | Release policy and unsigned protected tags are complete; v0.3.15, v0.3.16, and v0.3.17 are published from merged main. v0.3.17 release tag remains at fe68c243; its missing changelog provenance is now corrected on main at 170688c without moving the tag. Upgrade mutation remains disabled. | Continue the next dependency-ready AR-0012/AR-0013 correctness slice on current main; preserve fail-closed upgrade apply and rollback and do not rewrite published tags. |
...
| P0 | [AR-0013](tasks/AR-0013.md): Selector-aware authenticated versioned runtime | codex-awc-ar0013-runtime-20260918 | Selector identity migration, TUI event-journal validation, and final selector retention/recheck are merged on main through 0dae6bf; exact Verify 35324837584 and post-merge Verify 35325049294 passed. Remaining launcher, manifest authenticity, validation-to-exec, and formal correspondence obligations remain; mutation stays disabled. | Select the next bounded selector/runtime authenticity or validation-to-exec correctness slice on current main 170688c, with hostile regression coverage and formal evidence only when exact implementation binding exists. |
