...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-loop-20260918e | v0.3.20 tag/provenance and post-tag Verify/Formal remain green. PR #734 adds a bounded SQLite journal descriptor-close/read uncertainty fence under AR-0031; executable upgrade/rollback remains disabled. | Await independent exact-head review and hosted gates for PR #734 at bad63f3. Preserve all upgrade/replace/rollback/selector mutation and Git dispatch fail-closed until durable Git binding and the full injected campaign pass. |
| P0 | [AR-0031](tasks/AR-0031.md): Executable upgrade mutation and rollback boundary | codex-awc-ar0031-mutation-20260918d | PR #734 merged/post-gates green. Exact-main audit at 5c8d438 confirms SQLite durable binding and safe-mode are read-only, hostile-tested, and fail-closed; formal implementation correspondence remains explicitly not-proven and Git mutation adapter remains unavailable. | Before any Git adapter, define and test a bounded formal trace correspondence for the existing SQLite snapshot/safe-mode transitions (read, identity recheck, read/close uncertainty, permanent ambiguous fencing). Keep all mutation, outcome publication, and Git dispatch fail-closed. |
