...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260915b | PR #262 merged at a8e8e148 from reviewed 3138fc9; exact post-merge Verify 34949710523 succeeded with publication artifact 10388383772. Continue with the accepted caller-owned session/recheck integration seam; AR-0008 keeps refinement not-proven. | Implement and publish the next caller-owned common-to-control typed session/recheck seam: validate durable session identity, lease/recheck, descriptor binding, and authority revision immediately before adapter construction; keep mutation and dispatch unreachable. |
