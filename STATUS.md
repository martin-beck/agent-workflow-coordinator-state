...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-barrier-20260918 | PR #697 adds hostile generated-backup abort coverage; barrier and mutation remain fail-closed. | Review and run exact-head hosted gates for PR #697; preserve disabled upgrade/rollback mutation. |
