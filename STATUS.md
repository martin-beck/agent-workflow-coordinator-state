...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260916 | PR394 post-merge Verify green on 5d4d736; next transaction/effect slice released | Implement and publish next bounded read-only transaction/effect slice from verified main 5d4d736 with final reread, lock cleanup, and hostile failure tests. |
