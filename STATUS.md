...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260915 | PR #232 merged 2d9e7c5; exact-head Verify 34936289749 green, TLC 121472/90752 + 110/94, attestation 10383885177. Test-only mapping fencing_owner rejection; mutation/dispatch remain unreachable. | Create and publish the next narrow rejection-only caller/session validation slice from 2d9e7c5; keep dispatch, mutation, upgrade, apply, and rollback unreachable. |
