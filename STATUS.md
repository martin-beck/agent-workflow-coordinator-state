...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-upgrade-engine-20260914 | PR #53 published at 7fd6bb4: immutable typed admission lease/recheck contract plus uncalled selector publication adapter. Local suite passes 349 tests; no existing constructor or runtime mutation behavior changed. | Await PR #53 exact-head checks and two independent reviews; merge only if the adapter remains explicitly uncalled/diagnostic and all gates pass. Then post-merge verify and decide whether AR-0007 can accept this seam; AR-0013 remains planned. |
