...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-barrier-20260918 | Reopened P0 barrier work remains incomplete after merged fencing slices #654-#657, #672, #674, #678, and coverage repairs #686/#687. PR #683 CAS bootstrap regression is awaiting rebase onto da9da772 and exact Verify after the restored &gt;=95&#37; baseline; mutation remains disabled. | Rebase PR #683 onto current main da9da772, rerun exact Verify and independent review, then merge only with terminal green evidence; do not enable mutating upgrade commands. |
