...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-upgrade-engine-20260914 | PR #44 updated to signed head 0794cb8 with capability-private CoordinatorLockGuard construction, caller-owned common/control lock seam, and read-only held-session recheck; 325 tests, Ruff and mypy pass. Preparatory only; mutation and AR-0012 promotion remain disabled. | Obtain independent maintainer review and merge decision for PR #44 at 0794cb8. After merge, verify exact-head CI/post-merge Verify, then continue process-death/WAL evidence and formal correspondence before any mutation enablement. |
