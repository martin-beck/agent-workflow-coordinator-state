...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #198 merged eb8ddf56; Verify 34928358428 succeeded (TLC 121472/90752 main, 110/94 small, artifact 10381295062). | Create and publish the next narrow rejection-only caller/session validation slice from eb8ddf56; keep dispatch, mutation, upgrade, apply, and rollback unreachable. |
