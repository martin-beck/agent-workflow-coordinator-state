...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | codex-awc-ar0008-rejection-invariant-20260915 | PR #317 published at 99ca034de6cd987c34401b4e95facbef18ecd916 from exact main 7bf4501. Adds RejectRollbackAdmission transition/invariant and evidence mapping. Independent review found stale formal/upgrade/evidence.json and v10-refinement-contract.json metadata: new invariant and model/config hashes are missing. Repair is pending; public Verify is queued. | Repair both formal metadata artifacts, obtain independent review, then require exact-head Verify and post-merge Verify before closing AR-0008. |
