...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-loop-20260918d | Exact main fe70c08 and Verify 35362771550 are green. Release audit confirms no candidate transition JSON, no approved next version/changelog entry, and no published trust/vendor provenance for a safe next tag; mutation/dispatch remain disabled. | Obtain or create an approved version bump and complete transition provenance before any tag; do not create or push a release tag yet. |
