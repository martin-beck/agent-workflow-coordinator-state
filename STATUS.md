...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-barrier-20260918 | Reopened P0 issue #27 work. PRs #654, #655, and #656 merged with exact-head and post-merge evidence. PR #657 merged at 05f06d7 after exact-head Verify 35318401938, independent review, and CAS(0) bootstrap-rotation fencing coverage. Post-merge Verify 35318582966 is still running; broader barrier/session and every write-route proof remain required. | Await post-merge Verify 35318582966; then continue the next durable barrier/SQLite fencing slice on current main 05f06d7 covering process-death, control/WAL/SHM replacement, and every authority write route; do not enable mutating upgrade commands yet. |
