...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-upgrade-engine-20260914 | Execute upgrades atomically and restore the known-good runtime on every failure path. | Await independent signoff on normative BackupBoundary v2 in plans/AR-0007.md at state commit 893302b; only then implement and test the boundary contract. Product remains untouched. |
