...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #157 merged 794db11d. Verify 34916940596 succeeded: TLC 121472/90752 main, 110/94 small; artifact 10376937088. | Start next bounded canonical lock-domain/session caller boundary from 794db11d; keep all production mutation/dispatch/upgrade/apply/rollback routes unreachable and do not promote AR-0012. |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | codex-awc-ar0008-next-20260914 | Preparation checkpoint from merged 794db11d (PR157): pre-lock stale-context rejection is covered; no subsequent caller-boundary PR is open, only unrelated PR #85. Next slice must extend the hostile matrix without enabling production routes. | Review next exact caller-boundary PR for pre-lock context equality, canonical common-&gt;control-&gt;authority order, trusted reread and second recheck, replacement/WAL/SHM/process-death rejection, lock cleanup on all failures, and unreachable mutation/dispatch. Run focused hostile tests and admitted TLC when available; preserve implementation_refinement=not-proven, mutation disabled, AR-0012 unpromoted. |
