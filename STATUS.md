...
| P0 | [AR-0013](tasks/AR-0013.md): Selector-aware authenticated versioned runtime | codex-awc-ar0013-next-descriptor19-20260917 | Descriptor18 PR #572 merged ed2769d7; exact Verify 35220061241 succeeded. Latest-main postmerge sequence run 35220535460 is in progress after PR573 superseded prior run. Descriptor19 claim active. | Inspect next distinct runtime admission/release integrity boundary; implement hostile fail-closed regression coverage without enabling execution or selector mutation. |
