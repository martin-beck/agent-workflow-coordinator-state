...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #97 merged as 588640e; Verify 34890848910, TLC 90,752/94 states, and attestation 10366327458 passed. Starting next correctness slice. | Create a fresh isolated worktree from origin/main 588640e and implement one bounded control/journal crash-recovery or stale-fence correctness slice; keep production mutation, dispatch, upgrade, apply, and rollback routes disabled until independently reviewed. |
