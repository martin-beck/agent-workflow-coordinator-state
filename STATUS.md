...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-loop-20260918c | PR #714 adds hostile candidate-mode coverage rejecting an existing target v* tag; mutation and dispatch remain disabled. | Await independent review and hosted exact-head gates for PR #714; then continue the next dependency-safe AR-0009 correctness slice. |
