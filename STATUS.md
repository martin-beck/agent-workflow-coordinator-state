...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #113 merged as e48889ee; post-merge Verify 34896862527 is in progress on exact merge head. Next bounded slice is being prepared with mutation routes disabled. | Monitor Verify 34896862527 to terminal result, then publish the next bounded signed test-only slice from exact e48889ee. Keep mutation/apply/rollback routes disabled. |
