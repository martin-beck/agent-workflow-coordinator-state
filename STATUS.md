...
| P0 | [AR-0031](tasks/AR-0031.md): Executable upgrade mutation and rollback boundary | codex-awc-ar0031-mutation-20260918d | PR #728 adds authority-neutral DurableAuthorityBinding/DurableUpgradeSession contracts, filesystem identity capture/recheck for Git and SQLite, and a read-only SQLite compatibility session. Hostile replacement/symlink/foreign-session tests pass; all mutation and outcome publication remain disabled. | Await independent exact-head review and hosted gates for PR #728 at c794ac3. Do not merge until checks pass. After review, integrate only the accepted compatibility contract; keep Git generated dispatch, UpgradeEngine.apply, replace/commit, rollback, and selector mutation disabled. |
