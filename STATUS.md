...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #105 merged as e777608; Verify 34893936049, TLC 90,752/94 states, and attestation 10367903207 passed. PR #106 adds non-placeholder recovered identity-digest evidence from exact merged head. | Independently review PR #106 exact head c8a0784; merge only after awq/scope/smoke and exact-head coverage &gt;=95&#37; pass. Keep production mutation, dispatch, upgrade, apply, and rollback routes disabled. |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | codex-awc-ar0008-next-20260914 | PR #105 exact head b5f0e30 against e5517ea is test-only identity-digest stability coverage. It asserts the recovered session identity_digest is identical before and after a fresh SQLite reopen, alongside canonicality and full identity checks. Focused exact-head multiprocess stale-fence test passed 1/1. DCO Signed-off-by present; no formal/model/mutation/production changes and refinement remains not-proven. | Recommend PR #105 for merge: AWQ/scope/smoke passed and Verify is path-skipped. Require combined-main Verify/formal provenance after merge; retain AR-0008 diagnostic-only and continue AR-0012 caller/cross-store correspondence work. |
