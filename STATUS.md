...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #88 merged as 34424db; post-merge Verify 34887610614 passed, TLC explored 90,752/94 states, and attestation 10365088080 passed. Starting next correctness slice. | Create a fresh isolated worktree from origin/main 34424db and implement one bounded control/journal crash-recovery or stale-fence correctness slice; keep production mutation, dispatch, upgrade, apply, and rollback routes disabled until independently reviewed. |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | codex-awc-ar0008-next-20260914 | PR #88 exact head cc1ebad against ce7b6d8 is test-only stale-retry coverage: after reopening an ambiguous barrier, a rejected stale project-fence reconciliation is proven to leave status=ambiguous and revision=2 unchanged. Exact focused test passed 1/1. Commit carries Signed-off-by: Martin Beck &lt;martin.beck2@gmx.de&gt;; no formal/model/mutation/production changes and refinement remains not-proven. | Recommend PR #88 for merge as narrow executable evidence. Require combined-main Verify/formal provenance after merge. Continue AR-0012 correctness work for production-caller binding, journal/control CAS correspondence, and cross-store crash recovery; retain diagnostic-only and mutation-disabled boundaries. |
