...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #178 merged 0461a91b; Verify 34923315295 succeeded (TLC 121472/90752 main, 110/94 small, artifact 10378718743). | Create the next narrow rejection-only caller/session validation slice from 0461a91b; keep dispatch, mutation, upgrade, apply, and rollback unreachable. |
