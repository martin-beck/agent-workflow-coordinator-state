...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260915 | PR #226 merged 5b37635; exact-head Verify 34934874087 green, TLC 121472/90752 + 110/94, attestation 10382512929. Test-only bytes authority_revision rejection; mutation/dispatch remain unreachable. | Create and publish the next narrow rejection-only caller/session validation slice from 5b37635; keep dispatch, mutation, upgrade, apply, and rollback unreachable. |
