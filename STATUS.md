...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-loop-20260918b | Release policy and unsigned protected tags are complete; v0.3.15, v0.3.16, and v0.3.17 are published from merged main. PR #675/#676/#677/#679 have exact and post-merge evidence. PR #680 merged at b234dd6 and PR #681 merged at e0c558f2 with AWQ/scope/smoke green; post-merge Verify for e0c558f2 is pending. v0.3.17 remains immutable at fe68c243; upgrade mutation remains disabled. | Record post-merge Verify for e0c558f2, then continue the next dependency-ready AR-0012/AR-0013 correctness slice on current main e0c558f2; preserve fail-closed upgrade apply and rollback and do not rewrite published tags. |
