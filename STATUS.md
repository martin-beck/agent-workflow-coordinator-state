...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-next2-20260917 | PR #501 merged as 52695e39; post-merge Verify 35179905028 passed all AWQ/scope/verify gates. Release workflow now fails closed on invalid GITHUB_SHA before evidence publication; upgrade mutation remains disabled. | Select and implement the next dependency-safe release-integration failure boundary; retain fail-closed behavior and do not enable upgrade mutation without complete evidence. |
