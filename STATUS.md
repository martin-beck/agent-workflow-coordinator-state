...
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-barrier-20260918 | PR #708 merged at 685f9003 after exact-head review of f39916ef; post-merge Verify 35352589317 passed; mutation remains fail-closed. | Select and implement the next bounded barrier/fencing failure-path slice from merged main 685f9003; preserve fail-closed upgrade and rollback mutation. |
