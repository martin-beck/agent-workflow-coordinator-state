...
| --- | --- | --- | --- | --- |
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-next30-20260917 | Next29 authority recheck prerequisite merged PR #563 024c50c2; post-merge Verify 35215334868 succeeded. | Release next29 and claim next30; inspect remaining formal/durability correspondence seam and implement one bounded fail-closed slice. |
