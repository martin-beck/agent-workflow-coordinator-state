...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260915 | PR #231 merged fd42a25; exact-head Verify 34936059109 green, TLC 121472/90752 + 110/94, attestation 10383343604. Test-only mapping authority_revision rejection; mutation/dispatch remain unreachable. | Create and publish the next narrow rejection-only caller/session validation slice from fd42a25; keep dispatch, mutation, upgrade, apply, and rollback unreachable. |
