...
| P0 | [AR-0031](tasks/AR-0031.md): Executable upgrade mutation and rollback boundary | codex-awc-ar0031-mutation-20260918d | PR #728 merged as 9b21ef1. PR #729 adds read-only SQLite durable session snapshots: control-store, lock, journal, and authority identity are captured and reread; replacement/content drift is classified ambiguous, and outcome publication remains disabled. | Await independent exact-head review and hosted gates for PR #729 at df2d4c1. Do not merge until checks pass. Keep Git dispatch, UpgradeEngine.apply, replace/commit, rollback, selector mutation, and outcome publication fail-closed. |
