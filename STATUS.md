...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260915b | PR #270 merged 301cc043 from signed f8f83c5; post-merge Verify 34954212599 green with exact-head attestation 10390072836 and TLC 4352/2728, 146/81, 516/232, 121472/90752, 110/94. Lifecycle durable reread/process cleanup and refinement remain unproven. | Implement the next durable session reread/process-abort cleanup seam around binding.validate(): reread trusted authority/session and descriptor/ref/WAL-SHM identity immediately before backend use, test abort cleanup and zero backend calls; keep commit/apply/rollback disabled. |
