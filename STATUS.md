...
| --- | --- | --- | --- | --- |
| P0 | [AR-0017](tasks/AR-0017.md): TLC resource-bound reliability | codex-awc-ar0017-tlc-capacity-20260915 | PR #318 head e3ad0ed passed pre-formal gates, but Verify 35019766718 exceeded its declared 1200-second cap by about two hours and remained in_progress; cancellation requested, timeout enforcement is unproven. | Confirm cancellation terminal state; implement and test enforceable timeout/teardown for systemd-run formal execution before any exact-head rerun. |
