...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260915b | PR #260 merged 5848d66; Verify 34948554666 green with TLC tiers and attestation 10388645515. PR #261 rebased onto current main with signed head 37131d9 for stale/non-integer backend CAS revision rejection; public gates restarted. | Await PR #261 independent review and public gates; merge through state-owned handoffctl, monitor exact-head Verify, then continue justified lifecycle/crash/backend-equivalence coverage. |
