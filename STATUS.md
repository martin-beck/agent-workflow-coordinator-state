...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-next4-20260917 | PR #524 merged 4ceda3a8; postmerge Verify 35190156087 passed. Next slice binds every transition-path ancestor to owner-controlled, non-group/other-writable directories. | Publish and independently review transition ancestor-binding PR; dispatch exact-head Verify and merge only after approval and all required checks pass. |
