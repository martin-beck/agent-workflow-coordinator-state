...
| --- | --- | --- | --- | --- |
| P0 | [AR-0028](tasks/AR-0028.md): TUI safe exit and future-discussion persistence | codex-ar0028-safe-exit-20260917 | Ensure TUI sessions cannot lose decisions or future discussion requests. | Implement atomic safe-exit, resume, re-ask, and future-discussion AR mapping events for TUI sessions. |
