...
| --- | --- | --- | --- | --- |
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-next25-20260917 | Next24 rollback terminal target aligned with model; PR #553 merged df150f3a; post-merge Verify 35210536843 succeeded. | Release next24 and claim next25; inspect remaining formal/durability correspondence seams and implement one bounded fail-closed slice with hostile tests/evidence. |
