...
| --- | --- | --- | --- | --- |
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | codex-awc-ar0012-barrier-20260918 | PR #705 merged at 30305b9a after exact-head review of 6dde8379; post-merge Verify 35350754253 passed; mutation remains fail-closed. | Select and implement the next bounded barrier/fencing failure-path slice from merged main 30305b9a; preserve fail-closed upgrade and rollback mutation. |
