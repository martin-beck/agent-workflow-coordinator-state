...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260915 | PR #245 merged d88c218; post-merge Verify 34939963285 failed in five vendor tests because PR #244 v0.3.7 runtime alignment left tests hard-coded to v0.3.6. Corrective PR #246 published signed head 7a6fcbd; full pytest 432 passed, 370 subtests, coverage 95&#37;. | Obtain independent review and merge corrective PR #246 through state-owned handoffctl; monitor exact-head Verify and record green evidence before resuming caller-context slices. |
