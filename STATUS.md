...
| --- | --- | --- | --- | --- |
| P0 | [AR-0009](tasks/AR-0009.md): Release integration and first upgrade | codex-awc-ar0009-next4-20260917 | PR #526 published at signed head 83f44a65: bound release transition input to 1 MiB before parsing; hostile oversized-file test included. Relevant 55-test suite and static gates pass. | Obtain independent exact-head review for PR #526; await PR gates and manual pr-fast Verify, then merge only after approval and all gates pass. |
