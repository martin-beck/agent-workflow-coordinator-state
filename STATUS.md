...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #155 merged 99e37523. Verify 34915977074 succeeded: TLC 121472/90752 main, 110/94 small; artifact 10376885118. | Start next bounded canonical lock-domain/session caller boundary from 99e37523; keep all production mutation/dispatch/upgrade/apply/rollback routes unreachable and do not promote AR-0012. |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | codex-awc-ar0008-next-20260914 | Reviewed PR #155 exact signed head 2d5edc8 against 605a7584. Adds rejection-only LockDomainScope.validated_hold: exact lease context is checked before canonical lock acquisition, then hold enforces common-&gt;control-&gt;authority order and cleanup. Drift tests cover project, authority revision, fencing token/owner, barrier, and state revision. Focused hostile/session/lock suite passes 43 tests and 18 subtests; AWQ/scope/smoke green, Verify skipped. | Continue independent review of the next caller-boundary slice; require production-route reachability evidence, durable reopen/WAL behavior and admitted TLC before stronger claims. Preserve implementation_refinement=not-proven, mutation disabled, and do not promote AR-0012. |
