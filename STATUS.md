...
| --- | --- | --- | --- | --- |
| P0 | [AR-0064](tasks/AR-0064.md): Authority mutation implementation and formal refinement | codex-awc-ar0064-20260924q | Concrete authority adapters intentionally reject commit/apply today; this child supplies the missing implementation and formal refinement without weakening fail-closed behavior. | Continue the next direct Git/SQLite fsync/close, stale-owner, reopen/retry, and ambiguity boundary; keep public mutation/release/rollback/Dispatch disabled. |
