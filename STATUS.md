...
| P0 | [AR-0031](tasks/AR-0031.md): Executable upgrade mutation and rollback boundary | codex-awc-ar0031-mutation-20260918d | PR #728 merged as 9b21ef1. Next approved slice is read-only SQLite compatibility session durability: capture control-store and journal snapshots, reread identity, and classify replacement/uncertainty as ambiguous without outcome publication or mutation. | Implement durable SQLite compatibility session snapshot/reread and ambiguous safe-mode handling in fresh worktree agent-workflow-coordinator-ar0031-sqlite-session-snapshot at 9b21ef1. Keep record_outcome, Git dispatch, UpgradeEngine.apply, replace/commit, rollback, and selector mutation fail-closed. |
