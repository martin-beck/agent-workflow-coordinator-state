...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | codex-awc-ar0007-next-20260914 | PR #96 merged as 2536552; Verify 34890505134, TLC 90,752/94 states, and attestation 10366592397 passed. PR #97 adds recovered authority state-revision evidence from exact merged head. | Independently review PR #97 exact head 32dbd4e; merge only after awq/scope/smoke and exact-head coverage &gt;=95&#37; pass. Keep production mutation, dispatch, upgrade, apply, and rollback routes disabled. |
