...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #106 merged as f8f4387; Verify 34894272654, TLC 90,752/94 states, and attestation 10367794085 passed. PR #107 adds recovered digest-encoding evidence from exact merged head. | Independently review PR #107 exact head 765c212; merge only after awq/scope/smoke and exact-head coverage >=95% pass. Keep production mutation, dispatch, upgrade, apply, and rollback routes disabled. | codex-awc-ar0007-next-20260914 |
