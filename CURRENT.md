...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #143 merged as 1d49aeb6. Post-merge Verify 34910796283 succeeded at exact merge head: TLC 121,472 generated/90,752 distinct main and 110 generated/94 distinct small; attestation artifact 10374312730. Repeated stale retry cleanup remains test-only, fail-closed, and uncalled by production mutation routes. | AR-0007 remains open: next bounded gap is independently reviewed process-handoff retry with a fresh trusted authority reread after the first rejection, still rejection-only. Keep dispatch, mutation, upgrade, apply, and rollback routes unreachable; do not promote AR-0012. | codex-awc-ar0007-next-20260914 |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | Monitoring the next AR-0007 fresh trusted-authority reread-after-first-rejection slice from merged 1d49aeb6. No subsequent exact-head PR is currently published; only unrelated PR #85 is open. Retry/stale-lease, lock cleanup, route reachability and formal limits remain pending exact evidence. | Review the next published AR-0007 exact head for fresh trusted reread, stale-lease fail-closed retry, lock cleanup and route reachability. Preserve implementation_refinement=not-proven, mutation disabled, and do not promote AR-0012. | codex-awc-ar0008-next-20260914 |
