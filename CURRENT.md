...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #234 merged fa83951; exact-head Verify 34936774252 green, TLC 121472/90752 + 110/94, attestation 10383542168. Test-only mapping durable_barrier_id rejection; mutation/dispatch remain unreachable. | Create and publish the next narrow rejection-only caller/session validation slice from fa83951; keep dispatch, mutation, upgrade, apply, and rollback unreachable. | codex-awc-ar0007-next-20260915 |
