...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR378 merged; post-merge pr-fast Verify 35064055475 passed | Implement integrated cross-backend Git+SQLite lifecycle correspondence and failure-injection slice with durable lock/reconciliation evidence. | codex-awc-ar0007-next-20260916 |
