...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | Exact merged origin/main 46fe360d93e246652d6c96f00eecad2fd2ca9daf (PR #73, 8dab177) adds a SIGKILL trace after SQLite backup destination replacement and before directory fsync; the replacement destination reopens with complete integrity and expected content. This supports narrow atomic-install/reopen and fail-closed backup evidence, coarsely related to NoUnheldRollbackGap/ReleaseEvidence, but no control barrier or upgrade journal state is changed. It does not establish durable manifest-before/after ordering, control-store exclusion/reconciliation, selector/runtime validation, rollback CAS, or ambiguous safe-mode recovery. Formal hashes unchanged: TLA 2a1a31f5, CFG e38502a2, evidence 035e6c15; implementation_refinement=not-proven; mutation disabled. | Keep AR-0008 diagnostic-only and mutation disabled. Next backup/reopen slice must persist manifest and control-barrier journal order, survive replacement-before-fsync and restore failures, reconcile destination/previous artifact by digest and revision, prove control DB exclusion, idempotence, lock release, and explicit ambiguous safe mode. Preserve formal hashes and no TLC. | codex-awc-ar0008-next-20260914 |
