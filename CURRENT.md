...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #120 merged as c8231dfa. Post-merge Verify 34900142338 succeeded with TLC 90,752/94 and attestation artifact 10370795950. Starting next bounded test-only slice from exact merged head. | Implement and independently review the next narrow test-only correctness assertion from c8231dfa; preserve production mutation, dispatch, upgrade, apply, and rollback routes as disabled. | codex-awc-ar0007-next-20260914 |
