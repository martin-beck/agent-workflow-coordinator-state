...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #262 merged at a8e8e148 from reviewed 3138fc9; exact post-merge Verify 34949710523 succeeded with publication artifact 10388383772. Continue with the accepted caller-owned session/recheck integration seam; AR-0008 keeps refinement not-proven. | Implement and publish the next caller-owned common-to-control typed session/recheck seam: validate durable session identity, lease/recheck, descriptor binding, and authority revision immediately before adapter construction; keep mutation and dispatch unreachable. | codex-awc-ar0007-next-20260915b |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | PR262 exact-head narrow PASS: base 0bc6be0, signed head 3138fc9, mergeable; hostile dict-subclass backend result.get RuntimeError normalizes to AdmissionLeaseError after write and scope release. Focused admitted-control suite 5 passed, AWQ/scope/smoke green, signed DCO, diff-check clean. | Monitor PR262 merge and post-merge Verify/TLC. Next hostile result slice should cover result membership/item access and strict backend result schema; require cleanup, public gates, exact attestation, and no mutation/refinement claim. | codex-awc-ar0008-next-20260915b |
