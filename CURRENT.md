...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR399 post-merge Verify pr-fast green on c7e760f | Implement and publish next bounded AR-0007 transaction/effect slice from verified main c7e760f. | codex-awc-ar0007-next-20260916 |
