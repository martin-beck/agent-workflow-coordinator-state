...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #107 merged as 4790f58; Verify 34894615738, TLC 90,752/94 states, and attestation 10367269378 passed. PR #108 adds lowercase-hex recovered digest evidence from exact merged head. | Independently review PR #108 exact head 160be1b; merge only after awq/scope/smoke and exact-head coverage >=95% pass. Keep production mutation, dispatch, upgrade, apply, and rollback routes disabled. | codex-awc-ar0007-next-20260914 |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | PR #108 exact head 160be1b against 4790f58 is test-only recovered digest-encoding coverage. It asserts every recovered identity_digest character is lowercase hexadecimal, alongside length, non-placeholder, alphanumeric, and canonical recomputation checks. Focused exact-head multiprocess stale-fence test passed 1/1. DCO Signed-off-by present; no formal/model/mutation/production changes and refinement remains not-proven. | Recommend PR #108 for merge: AWQ/scope/smoke passed and Verify is path-skipped. Require combined-main Verify/formal provenance after merge; retain AR-0008 diagnostic-only and continue AR-0012 caller/cross-store correspondence work. | codex-awc-ar0008-next-20260914 |
