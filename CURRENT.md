...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR379 merged; exact-head Verify 35064434311 passed 95% and pr-fast TLC | Verify post-merge run 35064605481; then continue lifecycle fault-boundary and formal correspondence coverage. | codex-awc-ar0007-next-20260916 |
