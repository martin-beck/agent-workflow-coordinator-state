...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #264 merged 0b18ad34; Verify 34950900732 green with TLC tiers and attestation 10389172637. PR #265 published signed head 485684f for replaced authority-revision rejection before backend. | Obtain independent review and merge PR #265 through state-owned handoffctl; monitor exact-head Verify, then continue justified lifecycle/backend-equivalence coverage. | codex-awc-ar0007-next-20260915b |
