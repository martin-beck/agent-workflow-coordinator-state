...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | PR #99 exact head c04f835 against ff3c5b2 is test-only recovered fencing-owner coverage. It asserts the reopened winning session retains fencing_owner=owner-1 after stale-writer/restart recovery, alongside fencing token, state/authority revisions, and authority immutability checks. Focused exact-head multiprocess stale-fence test passed 1/1. DCO Signed-off-by present; no formal/model/mutation/production changes and refinement remains not-proven. | Recommend PR #99 for merge: AWQ/scope/smoke passed and Verify is path-skipped. Require combined-main Verify/formal provenance after merge; retain AR-0008 diagnostic-only and continue AR-0012 caller/cross-store correspondence work. | codex-awc-ar0008-next-20260914 |
