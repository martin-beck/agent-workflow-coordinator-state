...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #114 merged as 0d9e565d; Verify 34897226331, TLC 90,752/94 states, and attestation 10369198573 passed. PR #115 adds test-only recovered authority-revision identity evidence. | Independently review PR #115 exact head 9211553; merge only after awq/scope/smoke and exact-head coverage >=95% pass. Keep mutation/apply/rollback routes disabled. | codex-awc-ar0007-next-20260914 |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | PR #115 exact signed head 9211553 against 0d9e565d is test-only authority-revision identity coverage. It asserts the reopened held session preserves authority_revision_at_acquire=authority-3 after stale-writer/restart recovery. Focused exact-head multiprocess stale-fence test passed 1/1; DCO present; AWQ/scope/smoke passed and Verify path-skipped. No formal/model/mutation/production changes; refinement remains not-proven. | Recommend PR #115 for merge as bounded executable evidence. This maps narrowly to the abstract authorityRevision/recheck safety obligation, but does not establish implementation refinement or cross-store atomicity. Require production-caller binding, journal/control CAS trace, and post-merge formal provenance. | codex-awc-ar0008-next-20260914 |
