...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #223 merged 8a3cbf2; exact-head Verify 34934245370 green, TLC 121472/90752 + 110/94, attestation 10383345606. Test-only tuple fencing_token rejection; mutation/dispatch remain unreachable. | Create and publish the next narrow rejection-only caller/session validation slice from 8a3cbf2; keep dispatch, mutation, upgrade, apply, and rollback unreachable. | codex-awc-ar0007-next-20260915 |
