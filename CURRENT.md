...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | PR257 merge 3589ed4 post-merge Verify 34946828016 succeeded; TLC main 121472/90752, intermediate 516/232, small 146/81 and 110/94, all no-error; attestation artifact 10387123016. Stale recheck drift slice accepted as bounded lifecycle evidence. | Remain active for the next hostile direct-comparison normalization slice. Require arbitrary equality/type failures in recheck identity/revision/fence comparisons to become AdmissionLeaseError before scope/store with zero calls and ownership false, then public gates and exact-head TLC. Preserve no mutation/refinement claim and AR-0012 unpromoted. | codex-awc-ar0008-next-20260915b |
