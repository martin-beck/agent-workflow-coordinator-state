...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR369 merged; postmerge Verify queued | Check postmerge pr-fast Verify, then select next lifecycle slice. | codex-awc-ar0007-next-20260916 |
