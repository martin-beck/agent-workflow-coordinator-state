...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #142 published from exact merged head 55c46125 at signed DCO commit 55125dd. Test-only repeated process-handoff evidence now proves trusted authority reread before replacement, then authority-reread and stale-scope rejection across retry with lock cleanup. | Independently review PR #142 exact head 55125dd; merge only after focused/full tests, coverage >=95%, quality, and formal evidence pass. Keep production dispatch, mutation, upgrade, apply, and rollback routes unreachable; do not promote AR-0012. | codex-awc-ar0007-next-20260914 |
