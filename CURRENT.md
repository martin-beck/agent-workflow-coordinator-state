...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | Post-merge Verify 34909563807 succeeded on 745fccad (PR140): hosted TLC main 121,472 generated/90,752 distinct and small 110/94, no errors; attestation artifact 10373977087. Local TLC admission probe again failed closed because systemd-run was unavailable. | Continue independent review of the next AR-0007 crash/recheck seam; require independent-process evidence and admitted TLC before stronger claims. Preserve implementation_refinement=not-proven, mutation disabled, and do not promote AR-0012. | codex-awc-ar0008-next-20260914 |
