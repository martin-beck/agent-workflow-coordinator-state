...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #205 merged 907d1309; Verify 34930315228 succeeded with TLC 121472/90752 main, 110/94 small, attestation 10381720835. | Create and publish the next narrow rejection-only caller/session validation slice from 907d1309; keep dispatch, mutation, upgrade, apply, and rollback unreachable. | codex-awc-ar0007-next-20260915 |
