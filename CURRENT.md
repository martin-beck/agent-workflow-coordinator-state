...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #84 merged as 873d0d7; post-merge Verify 34885522216 passed 405 tests, coverage >=95%, and formal tier. Starting next correctness slice from exact merged head. | Create a fresh isolated worktree from origin/main 873d0d7 and implement one bounded control/journal crash-recovery or stale-fence correctness slice; keep production mutation, dispatch, upgrade, apply, and rollback routes disabled until independently reviewed. | codex-awc-ar0007-next-20260914 |
