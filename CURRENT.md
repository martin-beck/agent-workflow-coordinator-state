...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | PR #92 exact head 6e33daf against 9ce4202 is test-only authority-invariance coverage. It asserts the authority artifact remains byte-identical after stale-fence retries and repeated fresh readers. Focused exact-head multiprocess stale-fence test passed 1/1. DCO Signed-off-by is present; no formal/model/mutation/production changes and refinement remains not-proven. | Recommend PR #92 for merge: AWQ/scope/smoke passed and Verify is correctly path-skipped. Require combined-main Verify/formal provenance after merge; retain AR-0008 diagnostic-only and continue AR-0012 caller/cross-store correspondence work. | codex-awc-ar0008-next-20260914 |
