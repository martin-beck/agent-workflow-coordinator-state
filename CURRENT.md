...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR404 merged as be5b46a; post-merge Verify queued | Confirm post-merge fast Verify for be5b46a; then release next bounded AR-0007 slice. | codex-awc-ar0007-next-20260916 |
