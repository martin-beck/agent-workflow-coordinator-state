...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #126 merged as e6674512. Post-merge Verify 34902934701 succeeded with TLC 90,752/94 and attestation artifact 10371517159. Exact-head formal evidence recorded. | Start the next dependency-safe AR-0007 correctness slice from exact head e6674512; keep production mutation, dispatch, upgrade, apply, and rollback routes disabled. | codex-awc-ar0007-next-20260914 |
