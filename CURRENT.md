...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #102 merged as 5fd3109; Verify 34892768924, TLC 90,752/94 states, and attestation 10367547422 passed. Starting next correctness slice. | Create a fresh isolated worktree from origin/main 5fd3109 and implement one bounded control/journal crash-recovery or stale-fence correctness slice; keep production mutation, dispatch, upgrade, apply, and rollback routes disabled until independently reviewed. | codex-awc-ar0007-next-20260914 |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | PR #102 exact head 9a2b191 against e980aa9 is test-only recovered attempt-identity coverage. It asserts the reopened winning session retains attempt_id=attempt-2 after stale-writer/restart recovery, alongside durable barrier/project/fence owner/token and revision/authority immutability checks. Focused exact-head multiprocess stale-fence test passed 1/1. DCO Signed-off-by present; no formal/model/mutation/production changes and refinement remains not-proven. | Recommend PR #102 for merge: AWQ/scope/smoke passed and Verify is path-skipped. Require combined-main Verify/formal provenance after merge; retain AR-0008 diagnostic-only and continue AR-0012 caller/cross-store correspondence work. | codex-awc-ar0008-next-20260914 |
