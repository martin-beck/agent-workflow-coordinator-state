...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | PR #97 exact head 32dbd4e against 2536552 is test-only recovered authority state revision coverage. It asserts the winning reopened session retains state_revision=4 after stale-writer/restart recovery, alongside authority revision and artifact immutability checks. Focused exact-head multiprocess stale-fence test passed 1/1. DCO Signed-off-by present; no formal/model/mutation/production changes and refinement remains not-proven. | Recommend PR #97 for merge: AWQ/scope/smoke passed and Verify is path-skipped. Require combined-main Verify/formal provenance after merge; retain AR-0008 diagnostic-only and continue AR-0012 caller/cross-store correspondence work. | codex-awc-ar0008-next-20260914 |
