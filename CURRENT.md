...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #218 merged 6a88d5f; exact-head Verify 34933175870 green, TLC 121472/90752 + 110/94, attestation 10381819863. Test-only list authority_revision rejection; mutation/dispatch remain unreachable. | Create and publish the next narrow rejection-only caller/session validation slice from 6a88d5f; keep dispatch, mutation, upgrade, apply, and rollback unreachable. | codex-awc-ar0007-next-20260915 |
