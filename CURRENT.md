...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #127 merged as ed8a7574. Post-merge Verify 34903223080 succeeded with TLC 90,752/94 and attestation artifact 10371159429. Exact-head formal evidence recorded. | Start the next dependency-safe AR-0007 correctness slice from exact head ed8a7574; keep production mutation, dispatch, upgrade, apply, and rollback routes disabled. | codex-awc-ar0007-next-20260914 |
