...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #92 merged as c637a73; Verify 34889087540, TLC 90,752/94 states, and attestation 10365987252 passed. PR #93 adds authority immutability assertion after every independent fresh read from exact merged head. | Independently review PR #93 exact head 56a9e76; merge only after awq/scope/smoke and exact-head coverage >=95% pass. Keep production mutation, dispatch, upgrade, apply, and rollback routes disabled. | codex-awc-ar0007-next-20260914 |
