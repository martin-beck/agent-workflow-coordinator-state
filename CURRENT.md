...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | Reviewed PR #135 exact signed head 69e3ef9 against 6b421fd2: uncalled from_rechecked_session holds scope before typed identity/session validation; adapter tests 11 passed, awq/scope/smoke pass, verify skipped. | Continue independent review of the next caller/session seam; require concrete stale/replacement identity, lease/revision, crash/reopen, and route-reachability evidence while preserving not-proven refinement and no AR-0012 promotion. | codex-awc-ar0008-next-20260914 |
