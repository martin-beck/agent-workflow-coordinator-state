...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | PR #317 repaired exact head 267efd9 from base 7bf4501; independent review PASS and AWQ/scope pass. Verify 35006681700 is now actively running exact-head formal validation; implementation refinement remains not-proven. | Wait for terminal Verify 35006681700; merge only after all required checks pass, then require exact post-merge Verify before closing AR-0008. | codex-awc-ar0008-rejection-invariant-20260915 |
