...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #212 merged 0c3ae5a7; Verify 34931847358 succeeded with TLC 121472/90752 main, 110/94 small, attestation 10382141674. | Create and publish the next narrow rejection-only caller/session validation slice from 0c3ae5a7; keep dispatch, mutation, upgrade, apply, and rollback unreachable. | codex-awc-ar0007-next-20260915 |
