...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | PR #40 merged at 8a67aadb; bounded refinement/evidence provenance contract is published and exact-head post-merge Verify passed. Correspondence remains not-proven and canonical TLC admission is blocked. | Obtain canonical TLC admission and run the scheduled/manual formal gate; then advance implementation correspondence only after exact executable WAL/process-death evidence exists. Keep mutation disabled. | codex-awc-ar0008-refinement-20260914 |
