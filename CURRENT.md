...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | PR #49 now targets a4d651f: signed DCO-clean formal branch plus stronger session-intent model with post-publication crash recovery and a configured positive-fence invariant; exact TLC evidence is 56/27/depth7. | Await fresh PR #49 checks on exact head a4d651f, including canonical PR-tier TLC and DCO. Obtain two independent exact-head reviews and merge only if all required checks are green; preserve diagnostic-only boundaries. | codex-awc-ar0008-refinement-20260914 |
