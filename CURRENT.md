...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #100 merged as e9a7168; Verify 34891921807, TLC 90,752/94 states, and attestation 10367545872 passed. PR #101 adds recovered barrier project-identity evidence from exact merged head. | Independently review PR #101 exact head d865659; merge only after awq/scope/smoke and exact-head coverage >=95% pass. Keep production mutation, dispatch, upgrade, apply, and rollback routes disabled. | codex-awc-ar0007-next-20260914 |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | PR #100 exact head a1f089c against 40d6509 is test-only recovered barrier-identity coverage. It asserts the reopened winning session retains durable_barrier_id=barrier-2 after stale-writer/restart recovery, alongside fencing owner/token, state/authority revisions, and authority immutability checks. Focused exact-head multiprocess stale-fence test passed 1/1. DCO Signed-off-by present; no formal/model/mutation/production changes and refinement remains not-proven. | Recommend PR #100 for merge: AWQ/scope/smoke passed and Verify is path-skipped. Require combined-main Verify/formal provenance after merge; retain AR-0008 diagnostic-only and continue AR-0012 caller/cross-store correspondence work. | codex-awc-ar0008-next-20260914 |
