...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #98 merged as ff3c5b2; Verify 34891193544, TLC 90,752/94 states, and attestation 10367355016 passed. PR #99 adds recovered fencing-owner evidence from exact merged head. | Independently review PR #99 exact head c04f835; merge only after awq/scope/smoke and exact-head coverage >=95% pass. Keep production mutation, dispatch, upgrade, apply, and rollback routes disabled. | codex-awc-ar0007-next-20260914 |
