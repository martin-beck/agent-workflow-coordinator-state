...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #86 merged as a957bed; post-merge Verify 34886366200 passed. Shared state doctor is green after AR-0016 metadata repair. Starting next correctness slice from exact merged head. | Create a fresh isolated worktree from origin/main a957bed and implement one bounded control/journal crash-recovery or stale-fence correctness slice; keep production mutation, dispatch, upgrade, apply, and rollback routes disabled until independently reviewed. | codex-awc-ar0007-next-20260914 |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | Merged exact head a957bed (PR #86) passed Verify run 34886366200. 405 tests passed at 95% branch coverage; AWQ, scope, and formal tier succeeded (smoke skipped by event). TLC reported no errors across all models, including 90752 distinct states for the main barrier and 94 for recovery. Attestation artifact 10365405372 finalized. Formal hashes remain TLA 2a1a31f5, CFG e38502a, evidence 035e6c15; implementation_refinement=not-proven and mutation disabled. | Keep AR-0008 active and diagnostic-only. Next AR-0007/AR-0012 slice must bind journal/control CAS and ambiguous retry/reconciliation to production caller traces, exact authority/fence revisions, and cross-store crash recovery. Require independent tests, exact-head CI/formal attestation, and explicit correspondence mapping before changing any model/refinement or mutation boundary. | codex-awc-ar0008-next-20260914 |
