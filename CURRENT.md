...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #60 merged at 1f22acc0f52757b90b81a9f46c73dd7c03b46600. Added uncalled LockDomainScope with common-control-authority acquisition, descriptor revalidation, durable-session reread, lease/revision checks, and failure release. Exact-head PR gates and post-merge Verify 34871427051 passed; mutation callers remain unbound. | Continue toward a real caller trace only after exact multiprocess/crash/recheck evidence; bind CAS/selector routes only when the concrete scope is proven in production context. Keep upgrade/apply/rollback mutation disabled; AR-0008 remains diagnostic-only. | codex-awc-ar0007-next-20260914 |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | Exact origin/main 1f22acc0f52757b90b81a9f46c73dd7c03b46600 includes merged PR #60 (ff4c0fa). Formal hashes unchanged: TLA 2a1a31f5, CFG e38502a2, evidence 035e6c15; implementation_refinement=not-proven and mutation remains disabled. Small-model rerun was attempted with isolated admission lock but failed before TLC: canonical runner queue/lock was inaccessible, and private bounded launches failed JVM initialization with pthread_create(EAGAIN) host thread exhaustion. No TLC result claimed. | Keep AR-0008 diagnostic-only and mutation disabled. Treat this rerun as infrastructure-inconclusive; schedule a serialized resource-admitted canonical run after host thread pressure is cleared. Do not alter formal claims or evidence hashes, and do not claim correspondence without executable caller/refinement traces. | codex-awc-ar0008-next-20260914 |
