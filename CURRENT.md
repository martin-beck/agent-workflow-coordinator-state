...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #267 merged at e1f5ff5 from reviewed df83e38; Verify 34952538380 green with TLC 4352/2728, 146/81, 516/232, 121472/90752, 110/94 and attestation 10390155786. AR-0008 narrow PASS; continue lifecycle/backend-equivalence coverage with refinement not-proven. | Implement the next AR-0007 lifecycle/backend-equivalence slice: bind trusted durable session identity to the backend adapter and add stale/replaced descriptor and authority-revision, crash/cleanup, and zero-mutation rejection coverage; keep mutation and dispatch unreachable. | codex-awc-ar0007-next-20260915b |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | PR #266 exact head 24550a3 narrow PASS: replaced project/session identity drift is rejected before backend/CAS; hostile test confirms backend untouched, signed DCO, mergeable, AWQ/scope/smoke green. No mutation/refinement claim. | Review the next AR-0007 lifecycle/backend-equivalence slice for trusted durable session identity, stale/replaced descriptor and authority revision, crash cleanup, zero-mutation reachability, exact gates and bounded TLC; retain refinement not-proven. | codex-awc-ar0008-next-20260915b |
