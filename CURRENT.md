...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #259 merged c3746e6; Verify 34947964927 green with TLC 121472/90752, 4352/2728, 516/232, 146/81, 110/94 and attestation 10386934822. Lock-order capability failures normalize fail-closed before hold/store while store errors propagate. | Implement and publish the next rejection-only lifecycle/backend-equivalence slice; cover backend-equivalent expected revision/fence CAS and lock-order/recheck behavior while keeping mutation, dispatch, apply, and rollback unreachable. | codex-awc-ar0007-next-20260915b |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | PR259 merge c3746e6 post-merge Verify 34947964927 succeeded: TLC 121472/90752 main, 516/232 intermediate, 146/81 and 110/94 small; all no-error; attestation artifact 10386934822. Lock-order failure normalization and store-error propagation remain accepted bounded lifecycle evidence. | Remain active for next backend-equivalence/lifecycle PR. Require exact identity/envelope and allowed mutable schema, CAS expected revision/fence, common-control-authority order, pre/post reread, held/releasing/released/ambiguous transitions, Git/SQLite equivalence, crash/fsync/timeout cleanup, hostile zero-call tests, public gates, admitted TLC, and no refinement claim. | codex-awc-ar0008-next-20260915b |
