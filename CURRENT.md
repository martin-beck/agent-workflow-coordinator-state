...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #241 merged a75c3a4; Verify 34939118692 succeeded, TLC 9/4, 4352/2728, 146/81, 516/232, 121472/90752 + 110/94, attestation 10384701668. Test-only memoryview fencing_owner rejection; mutation/dispatch remain unreachable. | Start next bounded rejection-only caller/session validation slice from exact merge a75c3a4; address non-Mapping malformed context fail-closed behavior and exact-schema handling without production mutation or dispatch. | codex-awc-ar0007-next-20260915 |
