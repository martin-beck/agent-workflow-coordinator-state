...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #177 merged 9fb176d6; Verify 34923028824 succeeded (TLC 121472/90752 main, 110/94 small, artifact 10378678468). | Create the next narrow rejection-only caller/session validation slice from 9fb176d6; keep dispatch, mutation, upgrade, apply, and rollback unreachable. | codex-awc-ar0007-next-20260914 |
