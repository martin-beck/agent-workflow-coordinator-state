...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #102 merged as 5fd3109; Verify 34892768924, TLC 90,752/94 states, and attestation 10367547422 passed. PR #103 adds recovered identity-digest evidence from exact merged head. | Independently review PR #103 exact head 3fb8d51; merge only after awq/scope/smoke and exact-head coverage >=95% pass. Keep production mutation, dispatch, upgrade, apply, and rollback routes disabled. | codex-awc-ar0007-next-20260914 |
