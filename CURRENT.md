...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | Formal acceptance checkpoint for the next manifest/control reconciliation slice at product 46fe360: no formal files changed; hashes remain TLA 2a1a31f5, CFG e38502a2, evidence 035e6c15. Acceptance requires one exact trace binding backup manifest digest and authority identity to a durable control/journal record, fsync/order evidence before and after replacement, explicit control-store exclusion, crash reconciliation to verified/releasing/ambiguous state, digest/revision checks for destination and previous artifact, idempotent retry without duplicate restore, and independent lock release. Current PR #73 only proves artifact reopen after replacement-before-fsync; it does not satisfy control reconciliation or upgrade rollback correspondence. | Keep AR-0008 diagnostic-only and mutation disabled. Await exact executable manifest/control trace and independent review before any formal extension or correspondence claim; preserve hashes and no TLC. | codex-awc-ar0008-next-20260914 |
