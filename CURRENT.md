...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | PR #107 exact head 765c212 against f8f4387 is test-only identity-digest encoding coverage. It asserts recovered identity_digest is alphanumeric, in addition to non-placeholder and canonical recomputation checks. Focused exact-head multiprocess stale-fence test passed 1/1. DCO Signed-off-by present; no formal/model/mutation/production changes and refinement remains not-proven. | Recommend PR #107 for merge: AWQ/scope/smoke passed and Verify is path-skipped. Require combined-main Verify/formal provenance after merge; retain AR-0008 diagnostic-only and continue AR-0012 caller/cross-store correspondence work. | codex-awc-ar0008-next-20260914 |
