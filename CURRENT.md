...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #94 merged as f2be6c1; Verify 34889778674, TLC 90,752/94 states, and attestation 10366750825 passed. PR #95 adds a final repeated fresh-reader stale-fence assertion from exact merged head. | Independently review PR #95 exact head 2c12a3d; merge only after awq/scope/smoke and exact-head coverage >=95% pass. Keep production mutation, dispatch, upgrade, apply, and rollback routes disabled. | codex-awc-ar0007-next-20260914 |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | PR #95 exact head 2c12a3d against f2be6c1 is test-only repeated final-reader coverage. It repeats the final reader snapshot after all stale-fence checks and confirms the winning session state remains unchanged. Focused exact-head multiprocess stale-fence test passed 1/1. DCO Signed-off-by present; no formal/model/mutation/production changes and refinement remains not-proven. | Recommend PR #95 for merge: AWQ/scope/smoke passed and Verify is path-skipped. Require combined-main Verify/formal provenance after merge; retain AR-0008 diagnostic-only and continue AR-0012 caller/cross-store correspondence work. | codex-awc-ar0008-next-20260914 |
