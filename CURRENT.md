...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #199 merged 18ad842c; Verify 34928638103 succeeded (TLC 121472/90752 main, 110/94 small, artifact 10381016663). | Create and publish the next narrow rejection-only caller/session validation slice from 18ad842c; keep dispatch, mutation, upgrade, apply, and rollback unreachable. | codex-awc-ar0007-next-20260914 |
