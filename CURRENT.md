...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #140 merged as 745fccad. Post-merge Verify 34909563807 succeeded at exact merge head: TLC 121,472 generated/90,752 distinct main and 110 generated/94 distinct small; attestation artifact 10373977087. Durable-session replacement rejection remains test-only, fail-closed, and uncalled by production mutation routes. | AR-0007 remains open: next bounded gap is independently reviewed crash/recheck evidence for a replaced durable session plus authority reread or multiprocess handoff after process death. Keep dispatch, mutation, upgrade, apply, and rollback routes unreachable; do not promote AR-0012. | codex-awc-ar0007-next-20260914 |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | Reviewed PR #140 exact signed head c9817f5 against cc578ec5. Test-only addition updates barrier_session authority_revision_at_acquire, state_revision, identity_digest, and revision after in-process SystemExit; subsequent LockDomainScope.hold rejects the old lease fail-closed and releases ownership. Focused test file passes 8 tests and 2 subtests; AWQ/scope/smoke are green, verify skipped. | Continue independent review of the next AR-0007 crash/recheck seam; require independent-process evidence and admitted TLC before stronger claims. Preserve implementation_refinement=not-proven, mutation disabled, and do not promote AR-0012. | codex-awc-ar0008-next-20260914 |
