...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #64 merged at e4921fa0c06c31c1fe86dec9fc7c0c384af1aeda. Made the uncalled ScopedBackendAdapter runtime-checkable against the complete snapshot/rollback-verification/execute surface; incomplete adapters fail before engine binding. Dispatch and all upgrade/apply/rollback mutation paths remain disabled. Exact-head gates and post-merge Verify 34873752050 passed. | Continue toward production authority-adapter binding only after formal caller traces and exact failure evidence; keep the adapter uncalled and all upgrade/apply/rollback mutation disabled. AR-0008 remains diagnostic-only. | codex-awc-ar0007-next-20260914 |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | Exact origin/main 4a76344e688ee8a35b6c79f6e270bef5f8e94f04 includes merged PR #63 (8846030), with scoped rollback-verification adapter changes only; no formal files changed. Formal hashes remain TLA 2a1a31f5, CFG e38502a2, evidence 035e6c15; implementation_refinement=not-proven and mutation remains disabled. No TLC process is active. Canonical /tmp admission lock/queue remain gha-workflow-coordinator-owned and inaccessible; /run/tla-queue.lock belongs to the separate host wrapper. No canonical serialized admission change detected; no TLC launched. | Keep AR-0008 diagnostic-only and mutation disabled. Do not launch TLC until canonical runner is routed through authorized serialized wrapper admission with resource evidence; preserve formal hashes and not-proven boundary. | codex-awc-ar0008-next-20260914 |
