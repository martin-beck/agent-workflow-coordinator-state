...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #243 merged a3eb0d7; Verify 34939520642 succeeded, TLC 9/4, 4352/2728, 146/81, 516/232, 121472/90752 + 110/94, attestation 10385090395. Typed non-Mapping caller context rejection before common-lock; mutation/dispatch remain unreachable. | Start next bounded rejection-only caller/session validation slice from exact merge a3eb0d7; make exact-schema unknown-key behavior explicit without production mutation or dispatch. | codex-awc-ar0007-next-20260915 |
