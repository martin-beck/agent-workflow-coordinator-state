...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #179 merged 8a010cd5; Verify 34923574505 succeeded (TLC 121472/90752 main, 110/94 small, artifact 10378853826). PR #180 published at cbaa62e. | Independently review PR #180 exact head cbaa62e; merge only after awq/scope/smoke and full Verify pass, then record post-merge evidence. | codex-awc-ar0007-next-20260914 |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | Prepared independent acceptance criteria from merged head 8a010cd5 after PR179. Typed caller/session rejection evidence now covers broad scalar and container state_revision forms; next slice remains diagnostic-only. | Review the next exact-head caller/session PR from 8a010cd5 when published. Require exact signed provenance, typed project/authority/revision/fence/barrier equality validation before common-lock, zero ownership on malformed/missing/stale/replaced inputs, process-death/replacement/WAL and trusted reread/second-recheck evidence, focused hostile tests plus public gates, and admitted TLC before stronger claims. Preserve implementation_refinement=not-proven, mutation disabled, and do not promote AR-0012. | codex-awc-ar0008-next-20260914 |
