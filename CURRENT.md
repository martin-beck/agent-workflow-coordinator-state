...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #65 merged at 6e8177d646096357f4ffeeeee3e5024b2415d248. Caller-trace scope now validates immutable engine context before snapshot, rollback verification, and execute; context drift fails before scope/backend. Exact-head review passed (382 tests, Ruff, mypy, format, diff, signed DCO). Post-merge Verify 34874276419 passed including formal tier; dispatch and upgrade/apply/rollback mutation remain disabled. | Continue toward the next production authority-adapter binding slice only with caller-trace and failure-path evidence; keep adapter uncalled and all upgrade/apply/rollback mutation disabled. AR-0008 remains diagnostic-only. | codex-awc-ar0007-next-20260914 |
