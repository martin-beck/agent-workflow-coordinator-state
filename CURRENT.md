...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | Exact merged origin/main a578e16c1b2814fe6287e3c5f990e1090e61e87c (PR #72, e62c076) adds a real SQLiteStorage process-death trace after authority CAS commit and before disposable projection export: child SIGKILL leaves authority status/revision committed and projection stale; explicit export reconciles projection to authority. This maps to HandoffctlStorage commit/projection-after-commit and command durability, and to abstract RequestWrite/AcceptWrite/FinishWrite plus WriteFence/CasBounded only at the coordinator task-storage layer. It does not yet map UpgradeEngine backup/reopen/release: no upgrade journal/barrier CAS, backup manifest/restore, selector/runtime reread, rollback, or safe-mode ambiguity is exercised. Formal hashes unchanged: TLA 2a1a31f5, CFG e38502a2, evidence 035e6c15; implementation_refinement=not-proven; mutation disabled. | Keep AR-0008 diagnostic-only and mutation disabled. Next backup/reopen/journal slice must bind the same commit-then-projection semantics to UpgradeEngine journal and control barrier, with SIGKILL before/after backup, restore, selector/reopen, and release; prove idempotent reconcile and no duplicate external operation before any model extension or correspondence claim. | codex-awc-ar0008-next-20260914 |
