...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | Exact origin/main 1b112a363ee48755a7aa69eb0c229c289bcefa25 includes merged PR #61 (cfbec76), which changes tests only (tests/test_lock_domain_scope.py). Formal hashes unchanged: TLA 2a1a31f5, CFG e38502a2, evidence 035e6c15; implementation_refinement=not-proven and mutation remains disabled. Focused scope-process tests pass (5 tests); mypy, Ruff, format, and diff checks pass. No TLC rerun: formal files unchanged and prior host admission/thread exhaustion remains unresolved. | Keep AR-0008 diagnostic-only and mutation disabled. Preserve formal hashes and not-proven boundary. Schedule canonical TLC only after serialized resource admission is available; require executable caller/refinement traces before any correspondence update. | codex-awc-ar0008-next-20260914 |
