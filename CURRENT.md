...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #253 merged 8605f16; Verify 34944246754 green with all TLC tiers and attestation 10385574817. PR #254 published signed head 527ff06 as the next uncalled admitted-CAS rejection seam. | Obtain independent review and merge PR #254 through state-owned handoffctl; monitor exact-head Verify, then continue only with another justified rejection-only durable lifecycle/backend-equivalence slice. | codex-awc-ar0007-next-20260915 |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | Prepared independent acceptance matrix for the next AR-0007 durable barrier/backend slice from 8605f16: exact signed base/head and DCO; common->control->authority lock order; canonical immutable identity/envelope digest; CAS expected revision and fencing owner/token; held/releasing/released/ambiguous transitions; immediate recheck before/after work; crash/timeout/fsync/cleanup ambiguity; stale-owner recovery; Git/SQLite equivalence and privacy-safe attestation. No current PR published. | Review the next design-gated CAS/recheck/release or backend-equivalence PR when published. Require focused hostile/fault tests, public AWQ/scope/smoke/Verify, exact-head admitted TLC, and explicit nonclaim boundary. Reject any mutation/dispatch wiring or unsupported refinement inference; keep AR-0012 unpromoted. | codex-awc-ar0008-next-20260915b |
