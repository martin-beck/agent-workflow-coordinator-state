...
| P0 | [AR-0005](tasks/AR-0005.md): Git-backend backup and restore | Back up and restore complete Git-backed coordination state without losing task history. | PR #25 open at bf634d6; await independent exact-head review and hosted checks before publication. | codex-awc-ar0005-git-backup-20260914 |
