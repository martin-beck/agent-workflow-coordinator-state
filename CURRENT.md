...
| --- | --- | --- | --- | --- |
| P0 | [AR-0012](tasks/AR-0012.md): Durable upgrade barrier and SQLite write fencing | Next44 PR #594 signed head cc73ad9 merged as 4070279c; exact Verify 35230911063 succeeded. Authoritative postmerge Verify 35231345295 is queued. | Monitor authoritative postmerge 35231345295 on 4070279c to terminal success; then release next44, claim next45, and implement next bounded seam. | codex-awc-ar0012-next44-20260917 |
