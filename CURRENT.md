...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | Exact origin/main 29eea5fc39967c4a55ad7e305e5ca2af83d38d02 includes merged PR #59 (1d4a6bd). Formal artifacts unchanged (TLA 2a1a31f5, CFG e38502a2, evidence 035e6c15); implementation_refinement=not-proven and mutation remains disabled. Canonical portable-smoke ran four small models cleanly, then Handoffctl.tla reached 2,428,036 generated / 2,428,035 distinct states with 1,905,214 queued before the 90s bound; no complete portable-smoke result claimed. | Keep AR-0008 diagnostic-only and mutation disabled. Retain bounded TLC timeout as inconclusive infrastructure/runtime evidence; do not update correspondence until concrete durable caller binding and exact refinement traces exist. Schedule/route a serialized, resource-admitted formal run for complete Handoffctl coverage. | codex-awc-ar0008-next-20260914 |
