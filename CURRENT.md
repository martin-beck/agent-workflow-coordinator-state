...
| --- | --- | --- | --- | --- |
| P0 | [AR-0017](tasks/AR-0017.md): TLC resource-bound reliability | PR #318 Verify 35019766718 correctly hit 1200-second TLC cap with no model result; independent review found release-sensitive PRs receive 120-minute job envelope but only 1200-second TLC timeout. | Repair timeout selection so release-sensitive PR TLC uses 6000 seconds (forks 600 seconds), add regression coverage, then rerun exact-head Verify. | codex-awc-ar0017-tlc-capacity-20260915 |
