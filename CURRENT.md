...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #174 merged 3ced05e3; Verify 34922163826 succeeded (TLC 121472/90752 main, 110/94 small, artifact 10378134415). | Create the next narrow rejection-only caller/session validation slice from 3ced05e3; keep dispatch, mutation, upgrade, apply, and rollback unreachable. | codex-awc-ar0007-next-20260914 |
