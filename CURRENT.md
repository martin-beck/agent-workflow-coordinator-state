...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | Postmerge Verify failed coverage 94% | Repair coverage gate before next feature slice. | codex-awc-ar0007-next-20260916 |
