...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #89 merged as e4b274e; Verify 34888024141, TLC 90,752/94 states, and attestation 10365806434 passed. Starting next correctness slice. | Create a fresh isolated worktree from origin/main e4b274e and implement one bounded control/journal crash-recovery or stale-fence correctness slice; keep production mutation, dispatch, upgrade, apply, and rollback routes disabled until independently reviewed. | codex-awc-ar0007-next-20260914 |
