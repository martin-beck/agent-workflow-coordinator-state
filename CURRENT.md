...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | Current merged product head remains 857ff047 after PR249; Mapping key enumeration is guarded, lookup/get failures remain the next bounded gap. | Review corrective hostile Mapping lookup/get rejection PR when published; require LockDomainError before common-lock, zero ownership, focused/public gates, and preserve mutation disabled/refinement not-proven. | codex-awc-ar0008-next-20260915b |
