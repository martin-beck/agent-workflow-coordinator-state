...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #254 merged c1f12944; Verify 34945056962 green with TLC 9/4, 4352/2728, 146/81, 516/232, 121472/90752, 110/94 and attestation 10386499653. | Select and publish the next justified rejection-only lifecycle/backend-equivalence slice; preserve mutation, dispatch, upgrade, apply, and rollback unreachable. | codex-awc-ar0007-next-20260915 |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | Prepared strict admitted_cas barrier-record review criteria from 838c767: exact allowed schema must distinguish immutable identity (project, authority revision, fencing token/owner, durable barrier, operation/state revision and identity/envelope digest) from mutable lifecycle fields (status/timestamps/outcome); reject unknown/missing/duplicate or malformed fields before scope/store; snapshot once; prove CAS expected revision and fencing ownership under canonical lock order. | Review the next strict admitted_cas schema PR when published. Require exact signed base/head and DCO, fail-closed hostile Mapping/schema tests with zero scope/store calls, focused/public gates, exact-head post-merge TLC attestation, and explicit design-only/non-refinement boundary. Keep mutation/dispatch disabled and AR-0012 unpromoted. | codex-awc-ar0008-next-20260915b |
