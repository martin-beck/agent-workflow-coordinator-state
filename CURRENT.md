...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #44 capability seam and PR #45 typing repair merged; PR #46 test-only coverage repair merged at c9fe1ba. Post-merge Verify run 34851996043 passed all required jobs. AR-0007 remains preparatory-only pending process-death/WAL/SHM evidence and formal correspondence. | Implement the next isolated AR-0007 process-death/WAL/SHM evidence slice from exact main c9fe1ba, with no runtime mutation wiring. Add failure-fencing/recheck tests and applicable formal correspondence; publish only after full coverage and exact-head gates. | codex-awc-ar0007-upgrade-engine-20260914 |
