...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | Execute upgrades atomically and restore the known-good runtime on every failure path. | Harden runtime selector publication against symlink/ancestor races, then wire fail-closed SQLite user-facing handoffctl upgrade check/plan/apply/rollback and release-plan validation. Keep Git unavailable until fully integrated. | codex-awc-ar0007-upgrade-engine-20260914 |
