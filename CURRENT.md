...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #113 merged as e48889ee; Verify 34896862527, TLC 90,752/94 states, and attestation 10369158144 passed. PR #114 adds test-only proof that recovered sessions restart at revision one. | Independently review PR #114 exact head 6773399; merge only after awq/scope/smoke and exact-head coverage >=95% pass. Keep mutation/apply/rollback routes disabled. | codex-awc-ar0007-next-20260914 |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | PR #114 exact signed head 6773399 against e48889ee is test-only recovered-session revision coverage. It asserts the reopened winning held session starts at revision=1, complementing identity, fence, authority, child-isolation, and digest checks. Focused exact-head multiprocess stale-fence test passed 1/1; DCO present; AWQ/scope/smoke passed and Verify path-skipped. No formal/model/mutation/production changes; refinement remains not-proven. | Recommend PR #114 for merge as bounded executable evidence. The revision-one assertion maps narrowly to AR-0007 session/control revision safety and the abstract controlRevision/session-state obligations, but does not establish implementation refinement. Require production-caller binding, journal/control CAS trace, and post-merge formal provenance. | codex-awc-ar0008-next-20260914 |
