...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | PR #86 exact head 1dfea47 against merged 873d0d7 is test-only retry/ambiguous reconciliation coverage. It uses a fresh SQLite reader to confirm the original ambiguous barrier remains ambiguous, rejects replaying the already-installed replacement with a CAS conflict, and confirms the recovered op-2 record is unchanged. Focused exact-head test passed 1/1. No formal/model/mutation/production changes; refinement remains not-proven. | Recommend PR #86 for merge as narrow executable evidence. After merge, require combined-main Verify/formal provenance. Continue AR-0012 correctness work: bind journal/control CAS and ambiguous retry behavior to actual production caller traces, cross-store crash recovery, and exact authority/fence revisions. Keep AR-0008 diagnostic-only and mutation disabled. | codex-awc-ar0008-next-20260914 |
