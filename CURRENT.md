...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #215 merged 1f6641b4; Verify 34932487177 succeeded with TLC 121472/90752 main, 110/94 small, attestation 10382117943. | Create and publish the next narrow rejection-only caller/session validation slice from 1f6641b4; keep dispatch, mutation, upgrade, apply, and rollback unreachable. | codex-awc-ar0007-next-20260915 |
