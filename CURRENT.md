...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #271 merged a7ca83a from signed d1d6cec; post-merge Verify 34954872842 green with attestation 10390743339 and TLC 4352/2728, 146/81, 516/232, 121472/90752, 110/94. validated_scope() is preparatory only; durable reread/process-abort semantics remain unproven. | Implement and independently review process-abort/fresh-worker reread coverage around validated_scope(): exercise child os._exit() while held, verify lock release and stale/replaced authority/barrier/descriptor rejection, and prove zero CAS/backend calls; keep mutation/dispatch/apply/rollback disabled. | codex-awc-ar0007-next-20260915b |
