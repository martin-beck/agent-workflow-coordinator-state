...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #235 merged f8a642d; exact-head Verify 34937026073 green, TLC 121472/90752 + 110/94, attestation 10383458953. Test-only bytearray project_id rejection; mutation/dispatch remain unreachable. | Create and publish the next narrow rejection-only caller/session validation slice from f8a642d; keep dispatch, mutation, upgrade, apply, and rollback unreachable. | codex-awc-ar0007-next-20260915 |
