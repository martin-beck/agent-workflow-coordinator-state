...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #270 published signed f8f83c5 for backend-free binding.validate() recheck identity and lock order; independent review narrow PASS with 42 tests/12 subtests, AWQ/scope/smoke green, Verify skipped; durable reread, descriptor/WAL-SHM equivalence, process-death cleanup, and refinement remain unproven. | Obtain review and merge PR #270 through state-owned handoffctl; then implement the next durable session reread/process-abort cleanup seam while keeping commit/apply/rollback disabled. | codex-awc-ar0007-next-20260915b |
