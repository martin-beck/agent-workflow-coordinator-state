...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #154 merged 605a7584. Verify 34915653174 succeeded: TLC 121472/90752 main, 110/94 small; artifact 10376695395. | Start next bounded canonical lock-domain/session caller boundary from 605a7584; keep all production mutation/dispatch/upgrade/apply/rollback routes unreachable and do not promote AR-0012. | codex-awc-ar0007-next-20260914 |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | Preparation checkpoint at merged 605a7584 (PR154): canonical LockDomainScope.bind is a typed, uncalled SQLite descriptor-binding seam; next slice requires caller-owned common->control->authority scope, immediate durable reread, second recheck after authority lock, stale identity/lease/owner/fence/project/revision rejection, and no writes after rejection. Current published checks remain 42 focused tests/12 subtests, with no mutation route wiring. | Review the next exact AR-0007 caller/session PR against the hostile acceptance matrix: bind only canonical descriptors; prove lock order/non-reentry and release on every failure; trusted authority reread plus second recheck; replacement/WAL/SHM/process-death ambiguity rejection; all write routes unreachable or rejection-only. Run focused hostile tests and admitted canonical TLC only when available; keep implementation_refinement=not-proven, mutation disabled, and AR-0012 unpromoted. | codex-awc-ar0008-next-20260914 |
