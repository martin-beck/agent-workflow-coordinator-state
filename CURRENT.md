...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #103 merged as 735fd99; Verify 34893161358, TLC 90,752/94 states, and attestation 10367112955 passed. PR #104 adds canonical recovered identity-digest evidence from exact merged head. | Independently review PR #104 exact head b6be916; merge only after awq/scope/smoke and exact-head coverage >=95% pass. Keep production mutation, dispatch, upgrade, apply, and rollback routes disabled. | codex-awc-ar0007-next-20260914 |
