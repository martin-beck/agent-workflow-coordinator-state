...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #237 merged c9bcaf08; Verify 34937814518 succeeded with TLC 121472/90752 + 110/94, attestation 10383831948. PR #238 independently reviewed PASS, awq/scope/smoke green, head f3c0e3e. | Merge PR #238 through state-owned handoffctl; monitor exact-head Verify and record TLC/attestation, then start the next bounded rejection-only slice. | codex-awc-ar0007-next-20260915 |
