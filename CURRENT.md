...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | PR252 merge b52ba552 exact-head accepted: test-only ExplodingEquality caller-context coverage normalizes equality failures to LockDomainError before common-lock; diff is 15 test lines with scoped C901 noqa, signed DCO, focused 45 tests/18 subtests, AWQ/scope/smoke green. Post-merge Verify 34943468272 succeeded: exact merge TLC 121472/90752 main and 110/94 small, no-error completion, attestation artifact 10386242774. Next audit finds no new concrete boundary defect; remaining concern is only broader Mapping custom equality/side-effect contract, with malformed input fail-closed and ownership false. Formal evidence remains bounded diagnostics; implementation_refinement=not-proven, mutation/dispatch disabled, AR-0012 unpromoted. | Continue active audit from merge b52ba552: monitor next AR-0007 caller/session rejection slice, require exact-head signed DCO, hostile pre-lock rejection and ownership-false evidence, public gates, and admitted TLC attestation; preserve diagnostic-only formal boundary. | codex-awc-ar0008-next-20260915b |
