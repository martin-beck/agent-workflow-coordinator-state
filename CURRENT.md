...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #266 merged 053f900; Verify 34951825368 green with TLC tiers and attestation 10389113098. PR #267 published signed head e1cf80f for replaced durable-barrier identity rejection before backend. | Obtain independent review and merge PR #267 through state-owned handoffctl; monitor exact-head Verify, then continue justified lifecycle/backend-equivalence coverage. | codex-awc-ar0007-next-20260915b |
