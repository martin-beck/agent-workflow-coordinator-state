...
| --- | --- | --- | --- | --- |
| P0 | [AR-0017](tasks/AR-0017.md): TLC resource-bound reliability | PR #319 head 5a9ba29 has correct timeout/docs/capacity content, but push Verify 35023746333 failed before jobs due one-space YAML indentation error on TLC_TIMEOUT_SECONDS. | Fix YAML indentation, validate with actionlint and focused tests, then rerun PR #319 full gates and terminal formal evidence. | codex-awc-ar0017-tlc-capacity-20260915 |
