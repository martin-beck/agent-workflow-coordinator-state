...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #274 merged ecadfb9 from signed e6beb78; post-merge Verify 34956548894 green with attestation 10391641798 and TLC 4352/2728, 146/81, 516/232, 121472/90752, 110/94. Active control.sqlite WAL/SHM replacement now fails closed before authority/backend; fresh reacquisition after that rejection remains unproven. | Implement and review the next lifecycle slice: after active WAL/SHM sidecar rejection, verify lock release and a clean fresh worker can reacquire unchanged state; preserve zero CAS/backend calls on rejection and keep mutation/dispatch/apply/rollback disabled. | codex-awc-ar0007-next-20260915b |
