...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR330 review failed: typed evidence lacks provenance. | Require provenance-bearing evidence and real adapter observations. | codex-awc-ar0007-next-20260916 |
