...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #97 merged as 588640e; Verify 34890848910, TLC 90,752/94 states, and attestation 10366327458 passed. PR #98 adds recovered fencing-token evidence from exact merged head. | Independently review PR #98 exact head daec18f; merge only after awq/scope/smoke and exact-head coverage >=95% pass. Keep production mutation, dispatch, upgrade, apply, and rollback routes disabled. | codex-awc-ar0007-next-20260914 |
