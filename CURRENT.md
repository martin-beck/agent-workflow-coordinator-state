...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #48 updated to b5f3f7d after independent review: reconciliation now requires a distinct durable barrier ID and fencing token plus trusted authority reread; 341 tests and whole-repository 95% coverage pass. | Re-run independent exact-head review at b5f3f7d and await all required PR checks; merge only when green, then run post-merge verification. Keep authority mutation, upgrade enablement, AR-0012 promotion, and formal implementation correspondence disabled. | codex-awc-ar0007-upgrade-engine-20260914 |
