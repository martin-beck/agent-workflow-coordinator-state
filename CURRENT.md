...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #141 merged as 55c46125. Post-merge Verify 34909962582 succeeded at exact merge head: TLC 121,472 generated/90,752 distinct main and 110 generated/94 distinct small; attestation artifact 10374356060. Multiprocess durable-session replacement rejection remains test-only, fail-closed, and uncalled by production mutation routes. | AR-0007 remains open: next bounded gap is independently reviewed repeated process-handoff evidence with trusted authority reread and stale lease rejection across retry, still rejection-only. Keep dispatch, mutation, upgrade, apply, and rollback routes unreachable; do not promote AR-0012. | codex-awc-ar0007-next-20260914 |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | Monitoring the next AR-0007 repeated process-handoff/trusted-authority reread/stale-lease retry slice from merged 55c46125. No subsequent exact-head PR is currently published; only unrelated PR #85 is open. No new acceptance or formal/refinement claim. | Review the next published AR-0007 exact head for fail-closed stale-lease retry, trusted-authority reread, lock cleanup, and route reachability. Preserve implementation_refinement=not-proven, mutation disabled, and do not promote AR-0012. | codex-awc-ar0008-next-20260914 |
