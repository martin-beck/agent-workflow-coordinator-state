...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #233 merged 1e651dc; exact-head Verify 34936531458 green, TLC 121472/90752 + 110/94, attestation 10383810287. Test-only mapping fencing_token rejection; mutation/dispatch remain unreachable. | Create and publish the next narrow rejection-only caller/session validation slice from 1e651dc; keep dispatch, mutation, upgrade, apply, and rollback unreachable. | codex-awc-ar0007-next-20260915 |
