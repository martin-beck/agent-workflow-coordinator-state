...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #111 merged as 2a168e3; post-merge Verify 34896113685 is in progress on exact merge head. Next slice is prepared from the merged head; production routes remain disabled. | Monitor Verify 34896113685 to terminal success/failure, then independently review the next bounded test-only slice from exact 2a168e3. Keep mutation/apply/rollback routes disabled. | codex-awc-ar0007-next-20260914 |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | PR #111 exact signed head 18230aa against 444f23c6 is test-only stale-child-binding coverage. After stale-writer/restart recovery, it asserts the newer winner has no forward_child binding. This maps narrowly to the model reset of forwardChild on fence acquisition/recovery and the AR-0007 stale-owner isolation obligation, but does not establish full implementation refinement or cross-store atomicity. Focused exact-head multiprocess stale-fence test passed 1/1; DCO present; AWQ/scope/smoke passed, Verify path-skipped. | Recommend PR #111 for merge as bounded executable evidence. Keep AR-0008 diagnostic-only, implementation_refinement=not-proven, and mutation disabled. Next correctness slice must bind child identity and journal/control CAS to the production caller and exact authority/fence trace, with independent post-merge formal provenance. | codex-awc-ar0008-next-20260914 |
