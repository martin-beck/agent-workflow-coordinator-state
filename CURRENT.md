...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #48 at 67e671c adds durable session intent, SIGKILL post-commit recovery to ambiguous, strict status/authority rereads, and newer-fence reconciliation; 341 tests and whole-repository 95% coverage pass. | Obtain independent exact-head review and all required PR checks for #48; merge only when green, then run post-merge verification. Keep authority mutation, upgrade enablement, AR-0012 promotion, and formal implementation correspondence disabled. | codex-awc-ar0007-upgrade-engine-20260914 |
