...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | Execute upgrades atomically and restore the known-good runtime on every failure path. | Review d05b613; then implement fail-closed SQLite user-facing handoffctl upgrade command and release-plan wiring, with explicit Git refusal and end-to-end selector/rereader invocation tests. | codex-awc-ar0007-upgrade-engine-20260914 |
