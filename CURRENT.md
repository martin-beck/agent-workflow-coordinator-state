...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #253 merged 8605f16; Verify 34944246754 green with all TLC tiers and attestation 10385574817. Hostile Mapping caller matrix is now broad and fail-closed. | Define the next non-redundant design-gated rejection-only seam toward durable barrier CAS/recheck/release lifecycle or backend equivalence; do not implement AR-0012 mutation/fencing or wire production dispatch/apply/rollback. | codex-awc-ar0007-next-20260915 |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | Independent post-PR253 audit from merge 8605f16: exact-schema Mapping validation now covers dict and non-dict adapters, unknown-key enumeration, lookup/get failures, and equality failures before common-lock with ownership false. The next substantive AR-0007 correctness requirements are durable barrier CAS/recheck/release lifecycle, crash/fault boundaries, backend equivalence, and production route integration; these remain intentionally uncalled/design-gated and must not be inferred from caller rejection or TLC. | Remain active for the next AR-0007 PR. Require exact signed head/base, hostile pre-lock rejection and ownership-false evidence for any caller/session slice; if implementation advances to barrier/backend lifecycle, require explicit CAS/recheck/release and crash/fault mapping, public gates, and exact-head admitted TLC. Preserve implementation_refinement=not-proven, mutation/dispatch disabled, AR-0012 unpromoted. | codex-awc-ar0008-next-20260915b |
