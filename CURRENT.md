...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | PR #109 exact head 6d89bd0 against 82c0a3b is test-only non-uniform identity-digest coverage. It asserts recovered identity_digest contains more than one distinct character, alongside length, non-placeholder, hexadecimal, canonicality, and reopen-stability checks. Focused exact-head multiprocess stale-fence test passed 1/1. DCO Signed-off-by present; no formal/model/mutation/production changes and refinement remains not-proven. | Recommend PR #109 for merge: AWQ/scope/smoke passed and Verify is path-skipped. Require combined-main Verify/formal provenance after merge; retain AR-0008 diagnostic-only and continue AR-0012 caller/cross-store correspondence work. | codex-awc-ar0008-next-20260914 |
