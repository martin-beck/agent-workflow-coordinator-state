...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | Exact origin/main 6e8177d646096357f4ffeeeee3e5024b2415d248 includes merged PR #65 (150cf29), extending uncalled caller-context/lease checks only; no formal files changed. Formal hashes remain TLA 2a1a31f5, CFG e38502a2, evidence 035e6c15; evidence claim boundary explicitly keeps implementation_refinement=not-proven and excludes coordinator authority mutation routes. No TLC process is active. Canonical /tmp admission lock/queue remain gha-workflow-coordinator-owned and inaccessible; /run/tla-queue.lock is separate host-wrapper infrastructure. User slice is about 105 GiB with historical oom_kill=817 and 2,527 pids; no safe canonical admission change. | Keep AR-0008 diagnostic-only and mutation disabled. Do not launch TLC until canonical runner is routed through authorized serialized wrapper admission with resource evidence; preserve formal hashes and not-proven boundary. | codex-awc-ar0008-next-20260914 |
