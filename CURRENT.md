...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #140 published from exact merged head cc578ec5 at signed DCO commit c9817f5. Test-only hostile crash/recheck evidence replaces the durable session authority/state revision after abort; immediate scope recheck rejects the prior lease and releases ownership. | Independently review PR #140 exact head c9817f5; merge only after focused/full tests, coverage >=95%, quality, and formal evidence pass. Keep production dispatch, mutation, upgrade, apply, and rollback routes unreachable; do not promote AR-0012. | codex-awc-ar0007-next-20260914 |
