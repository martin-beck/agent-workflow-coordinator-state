...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #211 merged 0174245d; Verify 34931603103 succeeded with TLC 121472/90752 main, 110/94 small, attestation 10381318750. | Create and publish the next narrow rejection-only caller/session validation slice from 0174245d; keep dispatch, mutation, upgrade, apply, and rollback unreachable. | codex-awc-ar0007-next-20260915 |
