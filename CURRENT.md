...
| --- | --- | --- | --- | --- |
| P0 | [AR-0017](tasks/AR-0017.md): TLC resource-bound reliability | PR #318 head e3ad0ed passed AWQ/scope/DCO/signature, but Verify 35019766718 is stale in_progress after local TLC child disappeared; cancellation requested, no formal result. | Confirm cancellation terminal state, safely recover/restart the existing runner if needed, then rerun exact-head Verify with evidence that the child remains observable through completion. | codex-awc-ar0017-tlc-capacity-20260915 |
