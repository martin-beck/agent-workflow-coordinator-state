...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | AR-0008 remains active after exact-main audit at 769187186b25f3bc44bcf18db31db7307f0f5385. Existing formal evidence and hostile tests remain diagnostic-only with implementation_refinement=not-proven. Highest-value next slice is an explicit evidence-to-executable-test seam for trusted rollback admission; no safe new delta was published because current concrete capability checks are already merged. | Define and implement a bounded AR-0008 formal evidence/test mapping for trusted rollback admission only after identifying a genuinely missing executable obligation; preserve no-mutation reachability and not-proven refinement, then independently review and run exact TLC/public gates. | codex-awc-ar0008-recovery-20260915 |
