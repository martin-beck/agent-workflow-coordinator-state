...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | Post-merge head 0d9e565d (PR #114) Verify 34897226331 succeeded. It ran 405 tests at 95% coverage and formal TLC completed without errors for admitted models, including 90,752 and 94 distinct states. Exact-head attestation artifact 10369198573 finalized. Formal hashes unchanged; implementation_refinement=not-proven and mutation disabled. PR #114 remains test-only recovered-session revision evidence. | Continue independent exact-head review of the next AR-0007 slice. Require executable production-caller traces binding session revision, child identities, journal/control CAS, authority/fence revisions, stale retry, and crash recovery before any correspondence claim. Treat 0d9e565d TLC/attestation as model/provenance evidence only. | codex-awc-ar0008-next-20260914 |
