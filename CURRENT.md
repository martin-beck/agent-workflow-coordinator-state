...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | PR #317 repaired exact head 267efd9eb9ef8326ffbfae0154cabd2865cea30f from base 7bf4501. Both formal/upgrade/evidence.json and v10-refinement-contract.json now include RollbackAdmissionRejectedSafe and exact model/config hashes 742be024/f78fbd0. Independent exact-head review PASS; AWQ/scope pass; Verify 35006681700 is queued. implementation_refinement remains not-proven. | Wait for exact-head Verify 35006681700; merge only after all required checks pass, then require exact post-merge Verify before closing AR-0008. | codex-awc-ar0008-rejection-invariant-20260915 |
| P1 | [AR-0016](tasks/AR-0016-release-validation-dispatch.md): Release validation dispatch gate | PR #314 merged as a5f9105; initial post-merge Verify 35000601242 failed on large TLC model due 1200-second timeout. Repair PR #315 exact head 067ba1c passed independent review; run 35003972069 was orphaned on the runner, then failed when the runner was safely restarted and has been rerun. AR-0007 Verify 35005629097 is now executing after runner recovery. | Require rerun 35003972069 full-exhaustive success; merge PR #315 only after all gates, then require exact post-merge Verify before closing AR-0016. | codex-awc-ar0016-release-gate-20260915 |
