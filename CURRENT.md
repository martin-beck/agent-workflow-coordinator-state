...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | PR #87 exact head 8512031 against a957bed is test-only stale-fence coverage. It reopens the persisted ambiguous control store and rejects the same stale project-fence replacement after restart. Exact focused public-guards test passed 1/1. Diff is three test additions only; no production, formal/model, mutation, or refinement changes. | Recommend PR #87 for merge as narrow executable evidence. Require combined-main Verify/formal provenance after merge. Continue AR-0012 correctness work to bind stale-fence rejection and ambiguous retry to production caller traces and cross-store recovery; keep AR-0008 diagnostic-only and implementation_refinement=not-proven. | codex-awc-ar0008-next-20260914 |
