...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #44 merged at 0912231; post-merge Verify run 34850795199 exposed only a test typing error. Signed test-only fix PR #45 is published at c0bcdf3; runtime/formal/mutation boundaries unchanged. | Obtain independent exact-head review and green CI for PR #45, merge it, then rerun post-merge Verify. After the repair is green, continue AR-0007 process-death/WAL/SHM evidence and formal correspondence before any mutation enablement. | codex-awc-ar0007-upgrade-engine-20260914 |
