...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #144 published from exact merged head 1d49aeb6 at signed DCO commit 392228b. Test-only fresh trusted authority reread after first stale rejection now proves refreshed evidence cannot authorize the old lease; second rejection also cleans up locks. | Independently review PR #144 exact head 392228b; merge only after focused/full tests, coverage >=95%, quality, and formal evidence pass. Keep production dispatch, mutation, upgrade, apply, and rollback routes unreachable; do not promote AR-0012. | codex-awc-ar0007-next-20260914 |
