...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | Reviewed PR #141 exact signed head d48a62b against 745fccad. Test-only forked child calls LockDomainScope.hold then exits 17 via os._exit; parent replaces durable authority/state revision and canonical digest, then fresh handoff rejects old lease fail-closed and releases ownership. Focused tests pass 9 tests and 2 subtests; AWQ/scope/smoke are green, Verify skipped. | Continue independent review of the next AR-0007 crash/recheck seam; require actual durable reopen/WAL evidence and admitted TLC before stronger claims. Preserve implementation_refinement=not-proven, mutation disabled, and do not promote AR-0012. | codex-awc-ar0008-next-20260914 |
