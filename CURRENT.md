...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | Reviewed PR #144 exact signed head 392228b against 1d49aeb6. Test-only fresh trusted-session reread obtains authority-retry after first stale rejection; a fresh scope using the old lease is rejected again and ownership is cleared. Focused tests pass 10 tests and 2 subtests; AWQ/scope/smoke are green, Verify skipped. | Continue independent review of the next AR-0007 recovery seam; require durable reopen/WAL evidence and admitted TLC before stronger claims. Preserve implementation_refinement=not-proven, mutation disabled, and do not promote AR-0012. | codex-awc-ar0008-next-20260914 |
