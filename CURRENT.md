...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | Real initialized Git/SQLite adapters are now exercised through UpgradeEngine.rollback(); stale/replaced scope and backend identity reject before journal/backend/handler and journal bytes remain unchanged. Signed head b2278265e7d4973cf1403720a03ba4bf8f38af33; focused 38/38 and full 513/513 tests, Ruff/format/mypy/diff pass. Publication and independent review pending. | Publish the signed exact-head test slice, obtain independent review and public gates, then merge only after green checks and post-merge Verify. | codex-awc-ar0007-real-integration-20260915 |
