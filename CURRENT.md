...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | Execute upgrades atomically and restore the known-good runtime on every failure path. | Review 4fd8ac1 independently; add meaningful non-AR coverage for upgrade_identity/admission/storage/backup or justify remaining defensive branches only through documented policy (no threshold/exclusion weakening), then rerun all gates. | codex-awc-ar0007-upgrade-engine-20260914 |
