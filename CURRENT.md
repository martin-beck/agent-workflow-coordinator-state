...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #262 merged a8e8e148; Verify 34949710523 green, artifact 10388383772. PR #263 published signed head 06c6aa3 for typed caller-owned admitted-control binding before adapter construction. | Obtain independent review and merge PR #263 through state-owned handoffctl; monitor exact-head Verify, then continue justified lifecycle/backend-equivalence coverage. | codex-awc-ar0007-next-20260915b |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | PR263 exact-head review BLOCK/concern: base a8e8e148, signed head 06c6aa3, mergeable, AWQ/scope/smoke green; focused admitted-control + lock-domain suite 22 passed/10 subtests. Typed AdmittedControlBinding.bind validates lease/recheck/scope type but does not invoke scope.assert_ordered before constructing the binding, despite the stated ordered-scope requirement; order is deferred to cas(). | Require PR263 repair or explicit contract clarification: bind must validate lock order before adapter construction, and hostile scope/store capability failures must remain fail-closed with no CAS/mutation. Re-review exact signed head, public gates, and post-merge TLC before acceptance. | codex-awc-ar0008-next-20260915b |
