...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #115 merged as 1be118de; Verify 34897622382 succeeded, TLC 90,752/94 states, and attestation 10369486731 passed. Starting next bounded test-only slice. | Implement and independently review the next bounded recovered-session state-revision assertion from exact 1be118de; keep mutation/apply/rollback routes disabled. | codex-awc-ar0007-next-20260914 |
