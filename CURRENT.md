...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #256 merged a79aa4d; Verify 34946216338 green, TLC 110/94, attestation 10387591927. Next stale identity/revision/fence rejection slice pending. | Implement and publish the next small rejection-only barrier CAS/recheck slice for stale identity, revision, or fence evidence; preserve mutation/dispatch/apply/rollback unreachable. | codex-awc-ar0007-next-20260915 |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | Prepared stale identity/revision/fence acceptance matrix from merge a79aa4d: reject wrong project, authority revision, fencing token, fencing owner, durable barrier, and expected state revision before common-lock/CAS; require hostile equality/type failures normalized, zero scope/store calls, no ownership on rejection, then under lock re-read durable state and reject stale/replaced records with cleanup. | Review next AR-0007 stale identity/revision/fence PR exact signed base/head. Require focused hostile CAS/recheck tests, lock-order and cleanup evidence, AWQ/scope/smoke plus post-merge Verify/TLC attestation, and no mutation/refinement claim. Keep AR-0012 unpromoted. | codex-awc-ar0008-next-20260915b |
