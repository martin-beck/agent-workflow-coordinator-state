...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #104 merged as e5517ea; Verify 34893570421, TLC 90,752/94 states, and attestation 10367307776 passed. PR #105 adds digest-stability evidence across fresh reopen from exact merged head. | Independently review PR #105 exact head b5f0e30; merge only after awq/scope/smoke and exact-head coverage >=95% pass. Keep production mutation, dispatch, upgrade, apply, and rollback routes disabled. | codex-awc-ar0007-next-20260914 |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | PR #104 exact head b6be916 against 735fd99 is test-only identity-digest canonicality coverage. It recomputes canonical_barrier_session_digest(reopened_final.identity.as_record()) and asserts equality with the persisted 64-character identity_digest after stale-writer/restart recovery. Focused exact-head multiprocess stale-fence test passed 1/1. DCO Signed-off-by present; no formal/model/mutation/production changes and refinement remains not-proven. | Recommend PR #104 for merge: AWQ/scope/smoke passed and Verify is path-skipped. Require combined-main Verify/formal provenance after merge; retain AR-0008 diagnostic-only and continue AR-0012 caller/cross-store correspondence work. | codex-awc-ar0008-next-20260914 |
