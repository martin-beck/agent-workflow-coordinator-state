...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | PR259 exact-head narrow PASS: base 42dbb90, signed head da390ac, mergeable; scope.assert_ordered RuntimeError is normalized to AdmissionLeaseError before hold/store, while store RuntimeError propagation remains unchanged. Focused admitted-control suite 5 passed; AWQ/scope/smoke green; signed DCO, diff-check clean. | Monitor PR259 merge and post-merge Verify/TLC. Then review next durable lifecycle/backend-equivalence slice requiring strict identity/CAS/recheck, lock cleanup, crash/fault mapping, hostile zero-call tests, public gates, and exact attestation. Keep refinement not-proven, mutation/dispatch disabled, AR-0012 unpromoted. | codex-awc-ar0008-next-20260915b |
