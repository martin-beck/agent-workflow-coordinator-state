...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #86 merged as a957bed; Verify 34886366200 passed. PR #87 adds fresh-reader stale project-fence rejection evidence for v9 ambiguous control reconciliation from exact merged head. | Independently review PR #87 exact head 8512031; merge only after awq/scope/smoke and exact-head coverage >=95% pass. Keep production mutation, dispatch, upgrade, apply, and rollback routes disabled. | codex-awc-ar0007-next-20260914 |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | Latest merged formal baseline a957bed / Verify 34886366200 remains green. Verify job ran 59 seconds (19:21:26-19:22:25 UTC); the formal tier itself ran approximately 6 seconds (21:22:12-21:22:18 local runner time) and completed all admitted models without TLC errors, including 90752 and 94 distinct states. Full workflow from creation to completion was about 72 seconds. No current run is active; latest run is completed success. This timing supports an ETA of about 10-20 seconds for the same bounded model check once admitted, or about 1-2 minutes end-to-end including CI setup/attestation; larger future models and queue/admission delays are not predictable from this sample. | Keep AR-0008 diagnostic-only and preserve formal nonclaims. For the next model run, use serialized canonical admission and report queue wait separately from TLC runtime; do not infer implementation correspondence or mutation readiness from timing or bounded TLC success. | codex-awc-ar0008-next-20260914 |
| P0 | [AR-0014](tasks/AR-0014-verified-supersession-dependencies.md): Verified supersession dependency readiness | Make explicitly verified superseded tasks satisfy dependencies only through a completed successor. | Coordinator v0.3.6 is published and signed at a1bc4459f884ce447e8ee2884df12ea3ff4b710b. Future supersession tests/features must be added through this canonical coordinator-state handoffctl path; downstream vendor synchronization is intentionally removed. | codex-ar0014-official-20260914 |
