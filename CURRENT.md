...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #261 merged 0bc6be0; Verify 34949130944 green with TLC 121472/90752, 4352/2728, 516/232, 146/81, 110/94 and attestation 10388441542. Stale/non-integer backend revisions reject after scope release. | Implement and publish the next rejection-only backend result access/normalization or lifecycle-equivalence slice; preserve mutation, dispatch, apply, and rollback unreachable. | codex-awc-ar0007-next-20260915b |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | PR261 merge 0bc6be0 post-merge Verify 34949130944 succeeded: TLC 121472/90752 main, 516/232 intermediate, 146/81 and 110/94 small; all no-error; attestation artifact 10388441542. Stale/non-integer result revision rejection accepted as bounded lifecycle evidence. | Remain active for next backend-result access normalization PR. Require result Mapping/get/item exceptions normalize to AdmissionLeaseError after scope cleanup, strict result schema/revision/fence/identity domains, zero-call pre-lock tests where applicable, public gates, exact-head TLC attestation, and no mutation/refinement claim. | codex-awc-ar0008-next-20260915b |
