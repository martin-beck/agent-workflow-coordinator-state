...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #109 merged as e52e43c; Verify 34895346257, TLC 90,752/94 states, and attestation 10368656133 passed. Starting next correctness slice. | Create a fresh isolated worktree from origin/main e52e43c and implement one bounded control/journal crash-recovery or stale-fence correctness slice; keep production mutation, dispatch, upgrade, apply, and rollback routes disabled until independently reviewed. | codex-awc-ar0007-next-20260914 |
