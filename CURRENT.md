...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | Post-merge Verify 34900639133 succeeded on 7d9933a9 (PR121): TLC no errors, 90,752/94 distinct states, attestation artifact 10370094700. No next AR-0007 PR is open. | Monitor publication of the next AR-0007 exact-head slice; preserve implementation_refinement=not-proven and mutation disabled. | codex-awc-ar0008-next-20260914 |
