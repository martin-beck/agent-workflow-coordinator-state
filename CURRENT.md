...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | PR254 exact-head PASS: base 8605f16, signed head 527ff06. Production admitted_cas now converts hostile required-record equality failures into AdmissionLeaseError before scope/store; hostile test proves neither scope nor CAS is touched. Focused admitted-control, lock-domain, and mutation-fence suite: 50 passed, 18 subtests. AWQ/scope/smoke green; Verify skipped. Identity/ownership checks remain fail-closed; wrapper explicitly uncalled. | Monitor PR254 merge and exact post-merge Verify/TLC. Then review the next durable barrier/CAS/recheck/release or backend-equivalence slice against lock order, canonical identity, CAS revision/fence, lifecycle transitions, crash/fault mapping, and no mutation/refinement claim. Keep AR-0012 unpromoted. | codex-awc-ar0008-next-20260915b |
