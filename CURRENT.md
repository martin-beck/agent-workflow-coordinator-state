...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #99 merged as 40d6509; Verify 34891552068, TLC 90,752/94 states, and attestation 10367285634 passed. PR #100 adds recovered durable-barrier identity evidence from exact merged head. | Independently review PR #100 exact head a1f089c; merge only after awq/scope/smoke and exact-head coverage >=95% pass. Keep production mutation, dispatch, upgrade, apply, and rollback routes disabled. | codex-awc-ar0007-next-20260914 |
