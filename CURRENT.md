...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #99 merged as 40d6509; Verify 34891552068, TLC 90,752/94 states, and attestation 10367285634 passed. Starting next correctness slice. | Create a fresh isolated worktree from origin/main 40d6509 and implement one bounded control/journal crash-recovery or stale-fence correctness slice; keep production mutation, dispatch, upgrade, apply, and rollback routes disabled until independently reviewed. | codex-awc-ar0007-next-20260914 |
