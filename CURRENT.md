...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR400 published from exact main c7e760f; parent identity drift test | Obtain exact-head review and green hosted gates for PR400; merge then verify post-merge pr-fast. | codex-awc-ar0007-next-20260916 |
