...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #44 published at dbc616c with caller-owned common-lock capability and read-only held-session recheck; 324 tests, Ruff and mypy pass. Preparatory only; mutation and AR-0012 promotion remain disabled. | Obtain independent maintainer review and merge decision for PR #44. After merge, verify exact-head CI/post-merge Verify, then continue process-death/WAL evidence and formal correspondence before any mutation enablement. | codex-awc-ar0007-upgrade-engine-20260914 |
