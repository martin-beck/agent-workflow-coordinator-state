...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #87 merged as ce7b6d8; post-merge Verify 34887132256 passed. Starting next correctness slice from exact merged head. | Create a fresh isolated worktree from origin/main ce7b6d8 and implement one bounded control/journal crash-recovery or stale-fence correctness slice; keep production mutation, dispatch, upgrade, apply, and rollback routes disabled until independently reviewed. | codex-awc-ar0007-next-20260914 |
