...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #145 merged as 287bda12. Post-merge Verify 34911552880 succeeded at exact merge head: TLC 121,472 generated/90,752 distinct main and 110 generated/94 distinct small; attestation artifact 10373849655. Repeated fresh-reread stale-lease rejection remains test-only, fail-closed, and uncalled by production mutation routes. | AR-0007 remains open: next bounded gap is independently reviewed process-handoff evidence with trusted reread across a fresh process and durable retry, still rejection-only. Keep dispatch, mutation, upgrade, apply, and rollback routes unreachable; do not promote AR-0012. | codex-awc-ar0007-next-20260914 |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | Monitoring the next AR-0007 fresh-process trusted-reread/durable-retry slice from merged 287bda12. No subsequent exact-head PR is currently published; only unrelated PR #85 is open. Stale-lease, lock cleanup, mutation and formal boundaries remain pending exact evidence. | Review the next published AR-0007 exact head for fresh-process trusted reread, fail-closed stale lease, lock cleanup and route reachability. Preserve implementation_refinement=not-proven, mutation disabled, and do not promote AR-0012. | codex-awc-ar0008-next-20260914 |
