...
| P1 | [AR-0015](tasks/AR-0015-vendor-formal-runtime-closure.md): Complete formal runtime vendor closure | PR #307 merged at 7b487aa50f20d70cba8b860a66d006c2389fd58f; post-merge Verify 34996220200 green (512 tests, 95%, all formal tiers no-error, artifact 10407827035). Existing signed immutable tag v0.3.7 targets unrelated 550c014c and has no GitHub release, so publication provenance is invalid for this merge. Remediate with a new signed v0.3.8 release; do not move v0.3.7. | Create and independently review a minimal v0.3.8 metadata bump from exact merge 7b487aa; merge it, run exact post-merge Verify, publish signed immutable v0.3.8 targeting that merge, and verify the GitHub release. | codex-awc-ar0015-v037-20260915 |
