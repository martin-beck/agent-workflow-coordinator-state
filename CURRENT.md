...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | Execute upgrades atomically and restore the known-good runtime on every failure path. | Implement concrete read-only Git/SQLite authority probes, backup/restore destination equivalence, selector identity and durable barrier/fence lifecycle. Publication remains blocked. | codex-awc-ar0007-upgrade-engine-20260914 |
