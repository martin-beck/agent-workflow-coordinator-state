...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | AR-0007 PR284 published as signed head 55c0b35: GitAuthorityAdapter.snapshot_bound composes with concrete LockDomainScope and matching AdmissionRecheck, validating trusted session identity before read-only Git observation and rejecting stale/replaced/ambiguous sessions without backend calls. | Obtain independent exact-head review and public PR284 gates; merge only through handoffctl after review. Keep mutation/dispatch/execute/apply/rollback unreachable. | codex-awc-ar0007-coverage-20260915c |
