...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR402 merged as 1f199ac; post-merge Verify queued | Confirm post-merge fast Verify for 1f199ac; then release next bounded AR-0007 slice. | codex-awc-ar0007-next-20260916 |
