...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #87 merged as ce7b6d8; Verify 34887132256 and TLC attestation 10365500859 passed. PR #88 adds persisted ambiguous-state preservation evidence after stale retry from exact merged head. | Independently review PR #88 exact head cc1ebad; merge only after awq/scope/smoke and exact-head coverage >=95% pass. Keep production mutation, dispatch, upgrade, apply, and rollback routes disabled. | codex-awc-ar0007-next-20260914 |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | Post-merge Verify 34887132256 for PR #87 completed successfully at merged head ce7b6d851424471d94d9215550e2f4ee7ad4af82. It ran 405 tests with 95% total branch coverage; AWQ/scope passed, smoke skipped by event, and formal tier passed all admitted TLC models with no errors: 90752 distinct states for the main model and 94 for recovery (also 4, 2728, 81, and 232-state submodels). Exact-head attestation artifact 10365500859 was finalized. Formal hashes/nonclaims remain unchanged; implementation_refinement=not-proven and mutation disabled. | Remain active for the next AR-0007 PR. Review exact head independently for stale-fence, retry/reconcile, and production-caller scope; require exact-head CI/formal attestation and keep correspondence/mutation claims disabled until executable mapping exists. | codex-awc-ar0008-next-20260914 |
