...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | PR256 exact-head inspection: test-only store-failure path proves context-manager release ordering (order, hold, write, release); focused admitted-control suite 5 passed. However PR is BLOCKED for publication review: GitHub reports mergeable=CONFLICTING, no AWQ/scope/smoke/Verify checks, and PR base is merge 8194b0d while head cb56558 is not yet cleanly integrated. | Wait for PR256 rebase/mergeability repair and require signed exact head, AWQ/scope/smoke plus post-merge Verify/TLC attestation before acceptance. Recheck release semantics and preserve rejection-only/no-mutation boundary; implementation_refinement=not-proven, AR-0012 unpromoted. | codex-awc-ar0008-next-20260915b |
