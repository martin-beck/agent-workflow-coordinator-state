...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #47 caller-owned pre-commit process-death/WAL/SHM evidence is merged and post-merge Verify 34852545351 passed. Independent audits now confirm the remaining gap is post-commit unknown-outcome recovery, not a missing pre-commit test. | Specify and implement the accepted post-commit unknown-outcome contract: durable commit-intent/outcome marker or equivalent, process-death recovery to ambiguous, explicit newer-fenced reconciliation, and formal correspondence. Add subprocess commit-then-die and authority-fencing tests only after the contract is implemented. Keep mutation disabled and AR-0012 unpromoted. | codex-awc-ar0007-upgrade-engine-20260914 |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | Six isolated PR-tier TLC models pass; isolated full lifecycle diagnostic reached 44,062,908 generated/36,881,058 distinct states without a reported invariant violation, then hit the configured 3,600s TLC runtime limit (exit 1). Canonical TLC remains runner-owned. | Retain six-model isolated evidence and the full-run timeout as diagnostics only; obtain authorized canonical admission for publication/full attestation or schedule the full model under the owning runner. Keep correspondence not-proven and mutation disabled. | codex-awc-ar0008-refinement-20260914 |
