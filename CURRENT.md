...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #93 merged as 5759d94; Verify 34889449959, TLC 90,752/94 states, and attestation 10366119086 passed. Starting next correctness slice. | Create a fresh isolated worktree from origin/main 5759d94 and implement one bounded control/journal crash-recovery or stale-fence correctness slice; keep production mutation, dispatch, upgrade, apply, and rollback routes disabled until independently reviewed. | codex-awc-ar0007-next-20260914 |
