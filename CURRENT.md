...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | Reviewed PR #143 exact signed head 0df4b47 against 80747a40. Test-only change repeats stale-scope retry rejection twice after failed trusted-authority reread and asserts ownership is cleared after each attempt. Focused tests pass 10 tests and 4 subtests; AWQ/scope/smoke are green, Verify skipped. | Continue independent review of the next AR-0007 recovery seam; require durable reopen/WAL evidence and admitted TLC before stronger claims. Preserve implementation_refinement=not-proven, mutation disabled, and do not promote AR-0012. | codex-awc-ar0008-next-20260914 |
