...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #270 merged 301cc043 with green Verify 34954212599. PR #271 repaired onto current main at signed head d1d6cec: validated_scope() performs backend-free binding revalidation and canonical scope hold/release cleanup; focused 25 tests plus 2 subtests and local quality gates green. This is preparatory only; durable authority reread/process-abort semantics remain unclaimed. | Obtain independent exact-head review and merge repaired PR #271 through state-owned handoffctl; then implement separately reviewed process-abort/fresh-worker reread coverage around the held scope with zero CAS/backend calls and mutation/dispatch/apply/rollback disabled. | codex-awc-ar0007-next-20260915b |
