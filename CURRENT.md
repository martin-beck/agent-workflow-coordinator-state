...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | PR254 merge c1f12944 post-merge Verify 34945056962 succeeded. Bounded TLC diagnostics: 121472/90752 main, 4352/2728, 516/232, 146/81, 110/94; all no-error. Exact-head attestation artifact 10386499653. Hostile admitted-CAS equality coverage remains accepted; no lifecycle/backend-equivalence implementation or mutation route introduced. | Remain active for next durable barrier/CAS/recheck/release or backend-equivalence slice. Review exact signed base/head, lock order, canonical identity and envelope, CAS revision/fence, lifecycle/crash/fault mapping, focused hostile tests, public gates, exact-head TLC attestation, and explicit no-refinement boundary. Keep mutation/dispatch disabled and AR-0012 unpromoted. | codex-awc-ar0008-next-20260915b |
