...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #38, #39, and design-only PR #41 merged; exact post-merge Verify run 34836548464 passed. Full session/WAL/process evidence remains open. | After the coordinator accepts the AR-0012 contract as a preparatory (not promotion) gate, implement only the reviewed caller-owned session/recheck seam with process-death/WAL evidence and formal correspondence. Keep runtime mutation disabled until AR-0007 and AR-0008 are formally accepted. | codex-awc-ar0007-upgrade-engine-20260914 |
