...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #214 merged 4e9e5786; Verify 34932281807 succeeded with TLC 121472/90752 main, 110/94 small, attestation 10381539799. | Create and publish the next narrow rejection-only caller/session validation slice from 4e9e5786; keep dispatch, mutation, upgrade, apply, and rollback unreachable. | codex-awc-ar0007-next-20260915 |
