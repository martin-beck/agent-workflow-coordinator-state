...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #141 published from exact merged head 745fccad at signed DCO commit d48a62b. Test-only multiprocess handoff evidence now covers child process death followed by durable-session authority/state revision replacement; fresh scope recheck rejects the old lease and cleans up locks. | Independently review PR #141 exact head d48a62b; merge only after focused/full tests, coverage >=95%, quality, and formal evidence pass. Keep production dispatch, mutation, upgrade, apply, and rollback routes unreachable; do not promote AR-0012. | codex-awc-ar0007-next-20260914 |
