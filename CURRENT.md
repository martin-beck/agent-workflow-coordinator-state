...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #203 merged 15d110b4; Verify 34929833768 succeeded with TLC 121472/90752 main, 110/94 small, attestation 10381506065. | Create and publish the next narrow rejection-only caller/session validation slice from 15d110b4; keep dispatch, mutation, upgrade, apply, and rollback unreachable. | codex-awc-ar0007-next-20260915 |
