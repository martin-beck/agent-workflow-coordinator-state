...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #267 merged e1f5ff5; Verify 34952538380 green with TLC tiers and attestation 10390155786. PR #268 published signed head 97e5505 for replaced durable state-revision rejection before backend. | Obtain independent review and merge PR #268 through state-owned handoffctl; monitor exact-head Verify, then continue justified lifecycle/backend-equivalence coverage. | codex-awc-ar0007-next-20260915b |
