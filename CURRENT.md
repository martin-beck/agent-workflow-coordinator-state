...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #268 merged 0f8495a; Verify 34953212032 green with TLC tiers and attestation 10390126584. PR #269 published signed head d7b362d for typed backend capability validation during binding. | Obtain independent review and merge PR #269 through state-owned handoffctl; monitor exact-head Verify, then continue trusted-session lifecycle/recheck coverage. | codex-awc-ar0007-next-20260915b |
