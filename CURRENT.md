...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR396 published from exact main e9f372b; hosted AWQ/scope green and portable smoke running | Obtain independent exact-head review for PR396; wait smoke terminal; merge only after PASS and green checks, then verify post-merge fast gate. | codex-awc-ar0007-next-20260916 |
