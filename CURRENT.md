...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #155 published from 605a7584 at signed 2d5edc8: validated_hold requires immutable caller lease-context equality before canonical scope acquisition; rejection-only. | Independently review PR #155 exact head 2d5edc8; require full Verify/coverage before merge; keep all production mutation/dispatch/upgrade/apply/rollback routes unreachable. | codex-awc-ar0007-next-20260914 |
