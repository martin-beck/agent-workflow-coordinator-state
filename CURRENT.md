...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #204 merged eb75c315; Verify 34930123613 succeeded with TLC 121472/90752 main, 110/94 small, attestation 10380583393. | Create and publish the next narrow rejection-only caller/session validation slice from eb75c315; keep dispatch, mutation, upgrade, apply, and rollback unreachable. | codex-awc-ar0007-next-20260915 |
