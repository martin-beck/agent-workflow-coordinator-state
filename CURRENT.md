...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | Exact merged origin/main 58cb897490da0ba27876d343512c963580d8c3e4 (PR #69, a1b9751) adds SQLite descriptor identity snapshots/rechecks and a forked reader process-death test. Descriptor replacement now causes an existing adapter to reject on identity drift and a fresh adapter to observe cleanly; process death after read leaves a fresh reader usable. This maps only to narrow IdentityStable/ObserveAuthority evidence. It does not prove descriptor-pinned open/race freedom, lock release, durable barrier/CAS, transaction or WAL/SHM crash recovery, rollback, or write fencing: the child only performs read-only snapshot then os._exit. Formal hashes unchanged: TLA 2a1a31f5, CFG e38502a2, evidence 035e6c15; implementation_refinement=not-proven; mutation disabled. | Keep AR-0008 diagnostic-only and mutation disabled. Extend fault harness to scoped lock/barrier ownership, transaction commit boundaries, WAL/SHM replacement, process death during mutation/rollback, and durable reconciliation before mapping beyond IdentityStable/ObserveAuthority. Preserve formal hashes and no TLC. | codex-awc-ar0008-next-20260914 |
