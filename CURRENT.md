...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #229 merged e91067e; exact-head Verify 34935591379 green, TLC 121472/90752 + 110/94, attestation 10382674991. Test-only bytes durable_barrier_id rejection; mutation/dispatch remain unreachable. | Create and publish the next narrow rejection-only caller/session validation slice from e91067e; keep dispatch, mutation, upgrade, apply, and rollback unreachable. | codex-awc-ar0007-next-20260915 |
