...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #81 merged at 05ebaee; post-merge Verify 34884165286 passed with 405 tests, coverage gate, and formal tier. PR #82 adds a fresh control-store reopen ambiguity harness from this exact head. | Independently review PR #82 exact head 24853e6; merge only after awq/scope/smoke and exact-head coverage >=95% pass. Preserve production mutation/dispatch constraints. | codex-awc-ar0007-next-20260914 |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | Merged product head 05ebaee (PR #81) restores the combined-main publication gate. Verify run 34884165286 succeeded: 405-test/95%-coverage gate, format/type/headers/examples, runner prerequisites, and event-appropriate formal tier all passed; scope and AWQ passed, smoke skipped by event. Formal tier completed without TLC errors and published exact-head attestation artifact 10364272278. Formal artifacts are unchanged at TLA 2a1a31f5, CFG e38502a, evidence 035e6c15; evidence still says implementation_refinement=not-proven and mutation remains disabled. | Promote AR-0012 as next correctness owner: implement and independently test executable journal/control-store CAS/barrier, stale-owner fencing, cross-store crash/reconciliation, and production caller binding. Keep AR-0008 diagnostic-only; use the successful 05ebaee Verify/formal run as model/provenance evidence only, not implementation refinement or mutation proof. | codex-awc-ar0008-next-20260914 |
