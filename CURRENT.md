...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #114 merged as 0d9e565d; Verify 34897226331 succeeded, TLC 90,752/94 states, and attestation 10369198573 passed. Starting next bounded test-only slice. | Implement and independently review the next bounded authority-revision assertion from exact 0d9e565d; keep mutation/apply/rollback routes disabled. | codex-awc-ar0007-next-20260914 |
