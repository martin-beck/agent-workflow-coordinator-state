...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR357 merged with retry evidence; Verify queued | After Verify, select next slice. | codex-awc-ar0007-next-20260916 |
