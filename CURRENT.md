...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR428 published from exact 4ffa2c8; hostile foreign control-store WAL sidecar rejection; hosted awq/scope in progress | Independent exact-head review PR428 (base 4ffa2c8, head 3b557f9, tree 4c46842); await review and hosted checks before merge | codex-awc-ar0007-next-20260916 |
