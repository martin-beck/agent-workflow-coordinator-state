...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #180 merged 5e87427e; Verify 34923845916 succeeded (TLC 121472/90752 main, 110/94 small, artifact 10378983834). | Create the next narrow rejection-only caller/session validation slice from 5e87427e; keep dispatch, mutation, upgrade, apply, and rollback unreachable. | codex-awc-ar0007-next-20260914 |
