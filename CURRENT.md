...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #269 merged f27ad044 from signed d7b362d; post-merge Verify 34953713089 green with exact-head pr-publication attestation 10390915774 and TLC 516/232, 121472/90752, 110/94; AR-0008 narrow binding review PASS, no refinement or mutation claim. | Implement the next trusted-session lifecycle/recheck seam: validate full lease/context/descriptor identity, reread authority/session state immediately before backend use, add process-abort cleanup and zero-backend-call rejection coverage; keep commit/apply/rollback disabled. | codex-awc-ar0007-next-20260915b |
