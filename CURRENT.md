...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | PR #94 exact head 1523187 against 5759d94 is test-only authority immutability coverage. After restarted stale-writer rejection, it asserts the authority artifact remains byte-identical. Focused exact-head multiprocess stale-fence test passed 1/1. DCO Signed-off-by present; no formal/model/mutation/production changes and refinement remains not-proven. | Recommend PR #94 for merge: AWQ/scope/smoke passed and Verify is path-skipped. Require combined-main Verify/formal provenance after merge; keep AR-0008 diagnostic-only and continue AR-0012 caller/cross-store correspondence work. | codex-awc-ar0008-next-20260914 |
