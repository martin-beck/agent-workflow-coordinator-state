...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | Formal/provenance audit at exact PR #77 head 36cd3ed240878124ca2c1732dabe978c7e1a3c85 (open, base origin/main de2278a): test-only expansion checks both authority_revision and fencing_token drift after a SIGKILL-persisted UpgradeEngine journal. It strengthens narrow IdentityStable/RecheckEvidence/StaleCASRejected journal-context evidence; no production route, control-store CAS, barrier transition, manifest binding, or rollback trace is added. Formal hashes unchanged: TLA 2a1a31f5, CFG e38502a2, evidence 035e6c15; implementation_refinement=not-proven; mutation disabled. Canonical TLC remains unavailable to this lane: /tmp admission lock/queue are gha-workflow-coordinator-owned; no TLC launched. | Keep AR-0008 diagnostic-only and mutation disabled. Next correctness AR should own the durable journal↔control-store barrier/CAS contract and SQLite mutation-route fencing (AR-0012), with selector/runtime binding deferred to AR-0013; require exact multiprocess crash/reconcile traces and authorized TLC admission before any model extension or correspondence claim. | codex-awc-ar0008-next-20260914 |
