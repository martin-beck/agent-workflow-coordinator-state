...
| --- | --- | --- | --- | --- |
| P0 | [AR-0017](tasks/AR-0017.md): TLC resource-bound reliability | PR #318 head e3ad0ed passed pre-formal gates, but Verify 35019766718 was cancelled at the enforced 1200-second RuntimeMaxSec boundary during TLC; no model result or attestation. | Diagnose formal state-space/runtime needs and propose a justified timeout/profile adjustment with tests; do not rerun or merge until terminal exact-head evidence is obtained. | codex-awc-ar0017-tlc-capacity-20260915 |
