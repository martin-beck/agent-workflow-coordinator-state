...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #183 merged 607699c5; Verify 34924595376 succeeded (TLC 121472/90752 main, 110/94 small, artifact 10379436061). | Create the next narrow rejection-only caller/session validation slice from 607699c5; keep dispatch, mutation, upgrade, apply, and rollback unreachable. | codex-awc-ar0007-next-20260914 |
