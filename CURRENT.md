...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | Exact merged origin/main c37811473db19e6abac049f785faf9d578c070b9 (PR #68, b44fd0b tests) adds only SQLite read-only rejection coverage. New evidence: missing/unsafe descriptor rejection, corrupt SQLite observation rejection, mocked non-ok integrity rejection, execute rejection, and rollback_context_verified=false under ScopedBackendAdapter. These map narrowly to TypeOK/IdentityStable/ObserveAuthority/RecheckEvidence and preserve WriteFence/CasBounded/StaleCASRejected as unimplemented; mocks do not establish WAL/SHM, transaction crash, process death, CAS, backup/restore, or rollback correspondence. Formal files/hashes unchanged: TLA 2a1a31f5, CFG e38502a2, evidence 035e6c15; implementation_refinement=not-proven; mutation disabled. | Keep AR-0008 diagnostic-only and mutation disabled. Require real multiprocess/WAL fault harness, descriptor reread and authority identity binding, CAS/fence evidence, backup/restore and scoped production caller traces before any SQLite write or rollback model mapping. No formal hash update is justified. | codex-awc-ar0008-next-20260914 |
