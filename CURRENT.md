...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #268 merged at 0f8495a from reviewed 969ab37; Verify 34953212032 green with TLC 4352/2728, 146/81, 516/232, 121472/90752, 110/94 and attestation 10390126584. AR-0008 narrow PASS; next is trusted-session lifecycle/recheck, with refinement and mutation still disabled. | Implement the next trusted-session lifecycle/recheck seam around the typed backend binding: validate full lease/context/descriptor identity and reread authority/session state immediately before backend use; add process-abort cleanup and zero-backend-call rejection coverage; keep commit/apply/rollback disabled. | codex-awc-ar0007-next-20260915b |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | PR267 merge e1f5ff5 post-merge Verify 34952538380 succeeded: TLC 121472/90752 main, 516/232 intermediate, 146/81 and 110/94 small; all no-error; attestation artifact 10390155786. Durable-barrier identity drift rejection accepted as bounded caller-owned evidence. | Remain active for next trusted-session/backend-equivalence slice. Require descriptor/authority/session identity reread, stale/replaced rejection, crash/process-death cleanup, zero backend/mutation reachability, exact signed/public gates and admitted TLC; retain implementation_refinement=not-proven and AR-0012 unpromoted. | codex-awc-ar0008-next-20260915b |
