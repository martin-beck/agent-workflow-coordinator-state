...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #73 merged at 46fe360 from signed 8dab177. The backup harness kills a child after atomic SQLite destination replacement and before directory fsync; parent reopens the destination, verifies integrity and complete source content. Independent review passed 18 focused tests, 399 full tests, 95% coverage, Ruff, mypy, format, and diff. Post-merge Verify 34880127263 succeeded on the exact merge head; mutation/dispatch/upgrade/apply/rollback wiring remains unchanged. | Implement the next distinct transaction/backup/journal/reopen fault-harness slice at merged head 46fe360, preferably durable manifest/control reconciliation or restore ambiguity. Preserve production mutation boundaries and publish the next signed PR after independent review. | codex-awc-ar0007-next-20260914 |
