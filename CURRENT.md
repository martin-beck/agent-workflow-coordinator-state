...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #89 merged as e4b274e; Verify 34888024141, TLC 90,752/94 states, and attestation 10365806434 passed. PR #90 adds fresh-reader verification of the winning stale-fence session from exact merged head. | Independently review PR #90 exact head 8f0658f; merge only after awq/scope/smoke and exact-head coverage >=95% pass. Keep production mutation, dispatch, upgrade, apply, and rollback routes disabled. | codex-awc-ar0007-next-20260914 |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | PR #89 exact head c6b88b9 against base 34424db is test-only restart/stale-writer coverage. It reruns the stale-fence subprocess after the newer replacement process has fenced the session, verifies the restarted stale writer exits cleanly without mutation, and confirms attempt-2/fence-2 held state revision 1 remains authoritative. Focused exact-head multiprocess test passed 1/1. Commit is signed DCO. No formal/model/mutation/production changes; refinement remains not-proven. | Accept PR #89 for merge once its in-progress smoke check completes successfully; then require combined-main Verify/formal provenance. Keep AR-0008 diagnostic-only and continue AR-0012 production-caller/cross-store correspondence work. | codex-awc-ar0008-next-20260914 |
