...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #144 merged as 38411745. Post-merge Verify 34911167215 succeeded at exact merge head: TLC 121,472 generated/90,752 distinct main and 110 generated/94 distinct small; attestation artifact 10373829220. Fresh reread stale-lease rejection remains test-only, fail-closed, and uncalled by production mutation routes. | AR-0007 remains open: next bounded gap is independently reviewed process-handoff retry after fresh reread with explicit repeated stale-lease rejection and cleanup. Keep dispatch, mutation, upgrade, apply, and rollback routes unreachable; do not promote AR-0012. | codex-awc-ar0007-next-20260914 |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | Monitoring the next AR-0007 process-handoff retry slice from merged 38411745. No subsequent exact-head PR is currently published; only unrelated PR #85 is open. Formal/refinement and AR-0012 dependency boundaries remain unchanged. | Review the next published AR-0007 exact head for process-handoff retry safety, stale-lease rejection, lock cleanup and route reachability. Preserve implementation_refinement=not-proven, mutation disabled, and do not promote AR-0012. | codex-awc-ar0008-next-20260914 |
