...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #173 merged 2677170f; Verify 34921930180 succeeded (TLC 121472/90752 main, 110/94 small, artifact 10378332084). | Create the next narrow rejection-only caller/session validation slice from 2677170f; keep dispatch, mutation, upgrade, apply, and rollback unreachable. | codex-awc-ar0007-next-20260914 |
