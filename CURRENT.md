...
| P0 | [AR-0014](tasks/AR-0014-verified-supersession-dependencies.md): Verified supersession dependency readiness | Make explicitly verified superseded tasks satisfy dependencies only through a completed successor. | PR #83 prepares coordinator-only v0.3.6 release notes; await exact-head CI/review, merge, then publish a signed immutable v0.3.6 tag and perform downstream vendor synchronization through a new ASB-state AR. | codex-ar0014-release-20260914 |
