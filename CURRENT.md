...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #48 merged and PR #50 published at e3c651aa75a3888d0bff04d2a3310589ebe934d6: SQLite route inventory contract plus multiprocess stale-fence rejection test; mutation remains disabled. | Await PR #50 exact-head AWQ/scope/verify and two independent reviews; merge only after all required gates pass, then post-merge verify and reconcile. | codex-awc-ar0007-upgrade-engine-20260914 |
