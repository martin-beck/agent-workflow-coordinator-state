...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #111 merged as 2a168e3; Verify 34896113685 succeeded, TLC 90,752/94 states, and attestation 10369335580 passed. Starting next bounded test-only slice. | Implement and independently review the next bounded test-only stale-child inheritance assertion from exact 2a168e3; keep mutation/apply/rollback routes disabled. | codex-awc-ar0007-next-20260914 |
