...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #88 merged as 34424db; Verify 34887610614, TLC 90,752/94 states, and attestation 10365088080 passed. PR #89 adds repeated stale-writer recheck evidence after process restart from exact merged head. | Independently review PR #89 exact head c6b88b9; merge only after awq/scope/smoke and exact-head coverage >=95% pass. Keep production mutation, dispatch, upgrade, apply, and rollback routes disabled. | codex-awc-ar0007-next-20260914 |
