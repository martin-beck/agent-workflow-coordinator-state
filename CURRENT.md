...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #155 merged 99e37523. Verify 34915977074 succeeded: TLC 121472/90752 main, 110/94 small; artifact 10376885118. | Start next bounded canonical lock-domain/session caller boundary from 99e37523; keep all production mutation/dispatch/upgrade/apply/rollback routes unreachable and do not promote AR-0012. | codex-awc-ar0007-next-20260914 |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | Preparation checkpoint at merged 99e37523 (PR155): validated_hold now provides pre-acquisition lease-context equality atop canonical LockDomainScope. No subsequent caller-boundary PR is open; only unrelated PR #85 remains. | Review the next exact caller-boundary PR against the hostile matrix: pre-hold project/authority/fence/owner/barrier/state equality; canonical common->control->authority order; trusted reread and second post-authority-lock recheck; replacement/WAL/SHM/process-death rejection; lock cleanup on every failure; all mutation/dispatch routes unreachable. Run focused hostile tests plus admitted canonical TLC when available; preserve implementation_refinement=not-proven, mutation disabled, AR-0012 unpromoted. | codex-awc-ar0008-next-20260914 |
