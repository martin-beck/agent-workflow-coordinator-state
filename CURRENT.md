...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #114 merged as 0d9e565d; post-merge Verify 34897226331 is in progress on exact merge head. Next bounded slice is pending terminal gate. | Monitor Verify 34897226331 to terminal result, then publish the next bounded signed test-only slice from exact 0d9e565d. Keep mutation/apply/rollback routes disabled. | codex-awc-ar0007-next-20260914 |
