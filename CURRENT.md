...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #176 merged a47e7243; Verify 34922768088 succeeded (TLC 121472/90752 main, 110/94 small, artifact 10378677992). | Create the next narrow rejection-only caller/session validation slice from a47e7243; keep dispatch, mutation, upgrade, apply, and rollback unreachable. | codex-awc-ar0007-next-20260914 |
