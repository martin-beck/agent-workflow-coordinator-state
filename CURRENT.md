...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | PR #103 exact head 3fb8d51 against 5fd3109 is test-only recovered identity-digest coverage. It asserts the reopened winning session carries a complete 64-character identity_digest after stale-writer/restart recovery, alongside all identity and authority immutability checks. Focused exact-head multiprocess stale-fence test passed 1/1. DCO Signed-off-by present; no formal/model/mutation/production changes and refinement remains not-proven. | Recommend PR #103 for merge: AWQ/scope/smoke passed and Verify is path-skipped. Require combined-main Verify/formal provenance after merge; retain AR-0008 diagnostic-only and continue AR-0012 caller/cross-store correspondence work. | codex-awc-ar0008-next-20260914 |
