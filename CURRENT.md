...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | Current merged c60d285 includes hostile Mapping key/value lookup fail-closed fixes; no next AR-0007 PR is open. | Prepare next caller/session boundary review: adversarial mutable Mapping key/value consistency or durable-session recheck failure, only with explicit contract and zero ownership; preserve mutation disabled/refinement not-proven. | codex-awc-ar0008-next-20260915b |
