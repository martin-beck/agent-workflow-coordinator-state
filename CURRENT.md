...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #199 merged as 18ad842c from signed head 3e99f4c; post-merge Verify 34928638103 is in progress. PR #198 Verify 34928358428 succeeded (TLC 121472/90752 main, 110/94 small, artifact 10381295062). | Monitor post-merge Verify 34928638103 for exact head 18ad842c; record TLC/attestation and doctor result, then start the next bounded rejection-only caller/session slice. | codex-awc-ar0007-next-20260914 |
