...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #91 merged as 9ce4202; Verify 34888712155, TLC 90,752/94 states, and attestation 10365567520 passed. PR #92 adds authority immutability evidence after repeated stale retries from exact merged head. | Independently review PR #92 exact head 6e33daf; merge only after awq/scope/smoke and exact-head coverage >=95% pass. Keep production mutation, dispatch, upgrade, apply, and rollback routes disabled. | codex-awc-ar0007-next-20260914 |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | PR #91 exact head b9169eb against 85bf3f0 is test-only repeated fresh-reader coverage. After stale-fence recovery, two additional independent SQLiteBarrierSessionStore readers are opened and each must reproduce the exact winning session state. Focused exact-head multiprocess test passed 1/1. DCO Signed-off-by is present; no formal/model/mutation/production changes and refinement remains not-proven. | Recommend PR #91 for merge: AWQ/scope/smoke passed and Verify is correctly path-skipped. Require combined-main Verify/formal provenance after merge; keep AR-0008 diagnostic-only and continue AR-0012 production caller/cross-store correspondence work. | codex-awc-ar0008-next-20260914 |
