...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #270 merged 301cc043 with green Verify 34954212599. Published PR #271 signed head 299c67b adding backend-free validated_scope: immediate binding recheck, canonical scope hold for durable reread boundary, and guaranteed release cleanup; focused 25 tests plus 2 subtests and local quality gates green. | Obtain independent exact-head review and merge PR #271 through state-owned handoffctl; then implement process-abort/fresh-worker reread coverage around the held scope with zero CAS/backend calls and mutation/dispatch/apply/rollback disabled. | codex-awc-ar0007-next-20260915b |
