...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #139 merged as cc578ec5. Post-merge Verify 34909133108 succeeded at exact merge head: TLC 121,472 generated/90,752 distinct main and 110 generated/94 distinct small; attestation artifact 10374230134. Test-only abort/recheck evidence remains fail-closed and uncalled by production mutation routes. | AR-0007 remains open: next bounded gap is independently reviewed crash/recheck evidence for a replaced durable-session record or authority revision after abort, beyond descriptor/status coverage. Keep dispatch, mutation, upgrade, apply, and rollback routes unreachable; do not promote AR-0012. | codex-awc-ar0007-next-20260914 |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | Post-merge Verify 34909133108 succeeded on merged cc578ec5 (PR139): TLC main 121,472 generated/90,752 distinct and small 110/94, both no errors; attestation artifact 10374230134. Local TLC admission probe failed closed because systemd-run was unavailable; hosted formal tier completed under its wrapper. Lease-recovery command evidence remains preserved in state history. | Review the next replaced durable-session/authority-revision-after-abort seam for fail-closed recheck, lock cleanup, and route reachability; preserve implementation_refinement=not-proven, mutation disabled, and do not promote AR-0012. | codex-awc-ar0008-next-20260914 |
