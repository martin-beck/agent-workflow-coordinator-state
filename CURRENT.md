...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR404 published from exact main 998c2b4; missing journal-parent failure test | Obtain independent exact-head review and green hosted gates for PR404; merge then verify post-merge pr-fast. | codex-awc-ar0007-next-20260916 |
