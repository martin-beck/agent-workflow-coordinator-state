...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #220 merged 570af2c; exact-head Verify 34933599065 green, TLC 121472/90752 + 110/94, attestation 10382381719. Test-only list fencing_owner rejection; mutation/dispatch remain unreachable. | Create and publish the next narrow rejection-only caller/session validation slice from 570af2c; keep dispatch, mutation, upgrade, apply, and rollback unreachable. | codex-awc-ar0007-next-20260915 |
