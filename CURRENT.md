...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #254 merged c1f12944; Verify 34945056962 green with all TLC tiers and attestation 10386499653. PR #255 published signed head b6665d1 for strict admitted-CAS schema rejection. | Obtain independent review and merge PR #255 through state-owned handoffctl; monitor exact-head Verify, then continue a justified rejection-only barrier CAS/recheck slice. | codex-awc-ar0007-next-20260915 |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | PR255 exact-head narrow PASS: base c1f12944e10db47e1ce4a1c26c1414bbf9a251cf, signed head b6665d1c544d5036d6d1a4c6bc60fc68d3be62b1. Adds admitted-CAS allowlist for project/authority/fence/owner/barrier/status/revision and rejects unknown fields before scope/store; hostile equality and malformed identity remain fail-closed. Focused suite 50 passed, 18 subtests; AWQ/scope/smoke green; signed DCO; diff-check clean. | Monitor PR255 merge and post-merge Verify/TLC. Treat this as narrow schema allowlist progress, not complete normative barrier schema: status/revision/value domains, operation identity/digest, CAS lifecycle transitions, crash/fault mapping, and backend equivalence still require separate exact slices. Preserve no mutation/dispatch, implementation_refinement=not-proven, AR-0012 unpromoted. | codex-awc-ar0008-next-20260915b |
