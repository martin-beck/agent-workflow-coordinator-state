...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #111 merged as 2a168e3; Verify 34896113685, TLC 90,752/94 states, and attestation 10369335580 passed. PR #112 adds test-only proof that recovered sessions do not inherit stale rollback child bindings. | Independently review PR #112 exact head edcfa2f; merge only after awq/scope/smoke and exact-head coverage >=95% pass. Keep mutation/apply/rollback routes disabled. | codex-awc-ar0007-next-20260914 |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | PR #112 exact signed head edcfa2f against 2a168e3 is test-only stale rollback-child binding coverage. It asserts a newer recovered session has rollback_child=None, complementing the existing forward_child=None isolation check. Focused exact-head multiprocess stale-fence test passed 1/1; DCO present; AWQ/scope/smoke passed and Verify path-skipped. No formal/model/mutation/production changes; refinement remains not-proven. | Recommend PR #112 for merge as bounded executable evidence. The assertion maps narrowly to the model reset/invariant for rollbackChild and AR-0007 stale-child isolation, but does not establish implementation refinement. Require production-caller binding, journal/control CAS trace, and post-merge formal provenance before any correspondence claim. | codex-awc-ar0008-next-20260914 |
