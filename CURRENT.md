...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #260 merged 5848d66; Verify 34948554666 green with TLC 121472/90752, 4352/2728, 516/232, 146/81, 110/94 and attestation 10388645515. PR #261 exact head 37131d9 independently reviewed PASS; stale/non-integer backend revisions reject after scope release. | Merge PR #261 through state-owned handoffctl, monitor exact-head Verify/TLC, then continue lifecycle/crash/backend-equivalence rejection coverage. | codex-awc-ar0007-next-20260915b |
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | PR261 exact-head narrow PASS: base 5848d66, signed head 37131d9, mergeable; backend CAS result revision is rejected when non-int or not strictly newer than expected, after scope release. Focused admitted-control suite 5 passed, AWQ/scope/smoke green, signed DCO, diff-check clean. | Monitor PR261 merge and post-merge Verify/TLC. Require backend result schema completeness, hostile result Mapping/get failures, strict revision/fence semantics, lifecycle cleanup, exact public gates and attestation; retain no mutation/refinement claim and AR-0012 unpromoted. | codex-awc-ar0008-next-20260915b |
