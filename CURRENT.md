...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #90 merged as 85bf3f0; Verify 34888346228, TLC 90,752/94 states, and attestation 10366092250 passed. PR #91 adds repeated fresh-reader equality evidence from exact merged head. | Independently review PR #91 exact head b9169eb; merge only after awq/scope/smoke and exact-head coverage >=95% pass. Keep production mutation, dispatch, upgrade, apply, and rollback routes disabled. | codex-awc-ar0007-next-20260914 |
