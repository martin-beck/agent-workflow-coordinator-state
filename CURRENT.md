...
| --- | --- | --- | --- | --- |
| P0 | [AR-0007](tasks/AR-0007.md): Upgrade engine and rollback | PR #44/#45/#46 merged; PR #47 caller-owned process-death/WAL/SHM evidence merged at 9c1b212. Post-merge Verify run 34852545351 passed all required jobs. Evidence remains bounded known-before-commit rollback/reopen only; ambiguity, mutation fencing, formal correspondence and AR-0012 promotion remain open. | Design and implement a separate unknown-outcome/ambiguous commit failure-fencing slice for AR-0007, with fail-closed durable ambiguous state and exact negative-path tests. Keep runtime mutation disabled; bind any model changes to formal correspondence before promotion. | codex-awc-ar0007-upgrade-engine-20260914 |
