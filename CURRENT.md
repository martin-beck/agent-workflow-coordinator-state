...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | PR253 exact-head PASS: test-only non-dict Mapping adapter with an unexpected key is rejected by exact-schema validation before common-lock; common lock calls remain empty and session ownership false. Base b52ba552, signed head e0c7476, signed DCO, diff-check clean, focused lock-domain/mutation-fence suite 46 passed with 18 subtests, AWQ/scope/smoke green, Verify skipped. | Remain active from b52ba552/e0c7476; monitor PR253 merge and exact post-merge Verify, then review next caller/session slice with hostile pre-lock rejection, ownership-false evidence, signed DCO, public gates, and admitted TLC attestation. Keep formal diagnostic-only, mutation/dispatch disabled, AR-0012 unpromoted. | codex-awc-ar0008-next-20260915b |
