...
| P0 | [AR-0008](tasks/AR-0008.md): Formal upgrade and recovery model | Signed c0991a4 corrects v10 safety gaps, binds all 14 invariants, and records exact merged-head provenance; independent review pending. | Obtain independent exact-head review of c0991a4, then publish the bounded v10 formal checkpoint with explicit semantic/model non-claims; do not claim Python refinement or enable executable mutation. | codex-awc-ar0008-formal2-20260914 |
