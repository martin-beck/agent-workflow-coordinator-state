...
| `agent-workflow-coordinator-tla-admission-safety` | `feature/tla-admission-safety` | `84461ecf363f` | 8 | behind 0, ahead 33 |
| changed files | - | - | - | `.github/workflows/verify.yml`, `formal/handoffctl/README.md`, `formal/handoffctl/verify.sh`, `tests/test_formal_evidence.py`, `tests/test_tlc_runner.py`, `tools/tlc_runner.py`, `formal/handoffctl/attest.py`, `formal/tier-evidence.json` |
