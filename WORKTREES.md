...
| --- | --- | --- | ---: | --- |
| `agent-workflow-coordinator` | `main` | `a094f5cd91e3` | 0 | behind 210, ahead 0 |
| `agent-workflow-coordinator-ar0023` | `ar0023-oracle-artifacts` | `c25bebcafe49` | 0 | behind 11, ahead 1 |
| `agent-workflow-coordinator-ar0024` | `ar0024-followup-legacy-gate` | `cc87a9d22d67` | 0 | behind 8, ahead 1 |
