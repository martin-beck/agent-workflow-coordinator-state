...
| `agent-workflow-coordinator-tla-admission-safety` | `feature/tla-admission-safety` | `3037580ffedd` | 4 | behind 0, ahead 24 |
| changed files | - | - | - | `.github/workflows/verify.yml`, `formal/evidence.json`, `tests/test_tlc_runner.py`, `tools/tlc_runner.py` |
