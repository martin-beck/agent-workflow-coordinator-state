...
| `agent-workflow-coordinator-tla-admission-safety` | `feature/tla-admission-safety` | `9995331a48bb` | 4 | behind 0, ahead 34 |
| changed files | - | - | - | `.github/workflows/verify.yml`, `formal/handoffctl/attest.py`, `tests/test_formal_evidence.py`, `.github/actionlint.yaml` |
