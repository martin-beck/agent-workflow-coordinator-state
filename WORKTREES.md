...
| `agent-workflow-coordinator-tla-admission-safety` | `feature/tla-admission-safety` | `84461ecf363f` | 5 | behind 0, ahead 33 |
| changed files | - | - | - | `.github/workflows/verify.yml`, `formal/handoffctl/verify.sh`, `tests/test_tlc_runner.py`, `tools/tlc_runner.py`, `formal/tier-evidence.json` |
