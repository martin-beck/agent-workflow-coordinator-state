...
| `agent-workflow-coordinator-tla-admission-safety` | `feature/tla-admission-safety` | `09b38dbd1a56` | 2 | behind 0, ahead 23 |
| changed files | - | - | - | `formal/evidence.json`, `tests/test_formal_evidence.py` |
