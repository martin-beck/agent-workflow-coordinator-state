...
| --- | --- | --- | ---: | --- |
| `agent-workflow-coordinator-license-20260908` | `main` | `590036fbf9a0` | 0 | behind 39, ahead 0 |
...
| `agent-workflow-coordinator-upgrade-sqlite-backup` | `feature/upgrade-sqlite-backup` | `1c3bd23c59ac` | 0 | behind 0, ahead 2 |
...
| `agent-workflow-coordinator-tla-admission-safety` | `feature/tla-admission-safety` | `59a49ef38230` | 9 | behind 0, ahead 38 |
| changed files | - | - | - | `.github/workflows/verify.yml`, `formal/evidence.json`, `formal/handoffctl/HandoffctlPR.cfg`, `formal/handoffctl/README.md`, `formal/handoffctl/attest.py`, `formal/handoffctl/verify.sh`, `formal/tier-evidence.json`, `tests/test_formal_evidence.py`, `tests/test_tlc_runner.py` |
